...
goog.exportSymbol('proto.fulmine.v1.CreateInvoiceRequest', null, global);
goog.exportSymbol('proto.fulmine.v1.CreateInvoiceResponse', null, global);
 ...
 * @constructor
 */
proto.fulmine.v1.CreateInvoiceRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.fulmine.v1.CreateInvoiceRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.fulmine.v1.CreateInvoiceRequest.displayName = 'proto.fulmine.v1.CreateInvoiceRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.fulmine.v1.CreateInvoiceResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.fulmine.v1.CreateInvoiceResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.fulmine.v1.CreateInvoiceResponse.displayName = 'proto.fulmine.v1.CreateInvoiceResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.fulmine.v1.CreateInvoiceRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.fulmine.v1.CreateInvoiceRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.fulmine.v1.CreateInvoiceRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.fulmine.v1.CreateInvoiceRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    amount: jspb.Message.getFieldWithDefault(msg, 1, 0),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.fulmine.v1.CreateInvoiceRequest}
 */
proto.fulmine.v1.CreateInvoiceRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.fulmine.v1.CreateInvoiceRequest;
  return proto.fulmine.v1.CreateInvoiceRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.fulmine.v1.CreateInvoiceRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.fulmine.v1.CreateInvoiceRequest}
 */
proto.fulmine.v1.CreateInvoiceRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.fulmine.v1.CreateInvoiceRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.fulmine.v1.CreateInvoiceRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.fulmine.v1.CreateInvoiceRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.fulmine.v1.CreateInvoiceRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getAmount();
  if (f !== 0) {
    writer.writeUint64(
 ...
 * @return {number}
 */
proto.fulmine.v1.CreateInvoiceRequest.prototype.getAmount = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.fulmine.v1.CreateInvoiceRequest} returns this
 */
proto.fulmine.v1.CreateInvoiceRequest.prototype.setAmount = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.fulmine.v1.CreateInvoiceRequest.prototype.getMemo = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.fulmine.v1.CreateInvoiceRequest} returns this
 */
proto.fulmine.v1.CreateInvoiceRequest.prototype.setMemo = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.fulmine.v1.CreateInvoiceRequest.prototype.getPreimage = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.fulmine.v1.CreateInvoiceRequest} returns this
 */
proto.fulmine.v1.CreateInvoiceRequest.prototype.setPreimage = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};
 ...
 * @return {!Object}
 */
proto.fulmine.v1.CreateInvoiceResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.fulmine.v1.CreateInvoiceResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.fulmine.v1.CreateInvoiceResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.fulmine.v1.CreateInvoiceResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    invoice: jspb.Message.getFieldWithDefault(msg, 1, ""),
    preimageHash: jspb.Message.getFieldWithDefault(msg, 2, "")
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.fulmine.v1.CreateInvoiceResponse}
 */
proto.fulmine.v1.CreateInvoiceResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.fulmine.v1.CreateInvoiceResponse;
  return proto.fulmine.v1.CreateInvoiceResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.fulmine.v1.CreateInvoiceResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.fulmine.v1.CreateInvoiceResponse}
 */
proto.fulmine.v1.CreateInvoiceResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.fulmine.v1.CreateInvoiceResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.fulmine.v1.CreateInvoiceResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.fulmine.v1.CreateInvoiceResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.fulmine.v1.CreateInvoiceResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {string}
 */
proto.fulmine.v1.CreateInvoiceResponse.prototype.getInvoice = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.fulmine.v1.CreateInvoiceResponse} returns this
 */
proto.fulmine.v1.CreateInvoiceResponse.prototype.setInvoice = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};


/**
 * optional string preimage_hash = 2;
 * @return {string}
 */
proto.fulmine.v1.CreateInvoiceResponse.prototype.getPreimageHash = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.fulmine.v1.CreateInvoiceResponse} returns this
 */
proto.fulmine.v1.CreateInvoiceResponse.prototype.setPreimageHash = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.fulmine.v1.PayInvoiceResponse.prototype.getPreimage = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
 ...
 */
proto.fulmine.v1.PayInvoiceResponse.prototype.setPreimage = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
