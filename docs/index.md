...
> Note: If you access from your browser, you will get 404.
> run `curl https://boltz.exchange/api/version`, (or `curl https://testnet.boltz.exchange/api/version` in testnet) to check that its running.
