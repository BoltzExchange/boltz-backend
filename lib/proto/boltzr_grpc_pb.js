...
function serialize_boltzr_BlockAddedResponse(arg) {
  if (!(arg instanceof boltzr_pb.BlockAddedResponse)) {
    throw new Error('Expected argument of type boltzr.BlockAddedResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_boltzr_BlockAddedResponse(buffer_arg) {
  return boltzr_pb.BlockAddedResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var BoltzRService = exports.BoltzRService = {
  ...
  blockAdded: {
    ...
    responseType: boltzr_pb.BlockAddedResponse,
    requestSerialize: serialize_boltzr_BlockAddedRequest,
    requestDeserialize: deserialize_boltzr_BlockAddedRequest,
    responseSerialize: serialize_boltzr_BlockAddedResponse,
    responseDeserialize: deserialize_boltzr_BlockAddedResponse,
  },
};
