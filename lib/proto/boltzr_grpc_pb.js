...
function serialize_boltzr_FeeBumpSuggestion(arg) {
  if (!(arg instanceof boltzr_pb.FeeBumpSuggestion)) {
    throw new Error('Expected argument of type boltzr.FeeBumpSuggestion');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_boltzr_FeeBumpSuggestion(buffer_arg) {
  return boltzr_pb.FeeBumpSuggestion.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_boltzr_FeeBumpsRequest(arg) {
  if (!(arg instanceof boltzr_pb.FeeBumpsRequest)) {
    throw new Error('Expected argument of type boltzr.FeeBumpsRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_boltzr_FeeBumpsRequest(buffer_arg) {
  return boltzr_pb.FeeBumpsRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var BoltzRService = exports.BoltzRService = {
  ...
  feeBumps: {
    ...
    requestStream: false,
    responseStream: true,
    requestType: boltzr_pb.FeeBumpsRequest,
    responseType: boltzr_pb.FeeBumpSuggestion,
    requestSerialize: serialize_boltzr_FeeBumpsRequest,
    requestDeserialize: deserialize_boltzr_FeeBumpsRequest,
    responseSerialize: serialize_boltzr_FeeBumpSuggestion,
    responseDeserialize: deserialize_boltzr_FeeBumpSuggestion,
  },
};
