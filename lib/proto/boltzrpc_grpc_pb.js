...
function serialize_boltzrpc_DevDisableCooperativeRequest(arg) {
  if (!(arg instanceof boltzrpc_pb.DevDisableCooperativeRequest)) {
    throw new Error('Expected argument of type boltzrpc.DevDisableCooperativeRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_boltzrpc_DevDisableCooperativeRequest(buffer_arg) {
  return boltzrpc_pb.DevDisableCooperativeRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_boltzrpc_DevDisableCooperativeResponse(arg) {
  if (!(arg instanceof boltzrpc_pb.DevDisableCooperativeResponse)) {
    throw new Error('Expected argument of type boltzrpc.DevDisableCooperativeResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_boltzrpc_DevDisableCooperativeResponse(buffer_arg) {
  return boltzrpc_pb.DevDisableCooperativeResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
getPendingSweeps: {
  ...
  devDisableCooperative: {
    path: '/boltzrpc.Boltz/DevDisableCooperative',
    requestStream: false,
    responseStream: false,
    requestType: boltzrpc_pb.DevDisableCooperativeRequest,
    responseType: boltzrpc_pb.DevDisableCooperativeResponse,
    requestSerialize: serialize_boltzrpc_DevDisableCooperativeRequest,
    requestDeserialize: deserialize_boltzrpc_DevDisableCooperativeRequest,
    responseSerialize: serialize_boltzrpc_DevDisableCooperativeResponse,
    responseDeserialize: deserialize_boltzrpc_DevDisableCooperativeResponse,
  },
};
