...
function serialize_fulmine_v1_CreateChainSwapRequest(arg) {
  if (!(arg instanceof ark_service_pb.CreateChainSwapRequest)) {
    throw new Error('Expected argument of type fulmine.v1.CreateChainSwapRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_fulmine_v1_CreateChainSwapRequest(buffer_arg) {
  return ark_service_pb.CreateChainSwapRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_fulmine_v1_CreateChainSwapResponse(arg) {
  if (!(arg instanceof ark_service_pb.CreateChainSwapResponse)) {
    throw new Error('Expected argument of type fulmine.v1.CreateChainSwapResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_fulmine_v1_CreateChainSwapResponse(buffer_arg) {
  return ark_service_pb.CreateChainSwapResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_fulmine_v1_GetVtxosRequest(arg) {
  if (!(arg instanceof ark_service_pb.GetVtxosRequest)) {
    throw new Error('Expected argument of type fulmine.v1.GetVtxosRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_fulmine_v1_GetVtxosRequest(buffer_arg) {
  return ark_service_pb.GetVtxosRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_fulmine_v1_GetVtxosResponse(arg) {
  if (!(arg instanceof ark_service_pb.GetVtxosResponse)) {
    throw new Error('Expected argument of type fulmine.v1.GetVtxosResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_fulmine_v1_GetVtxosResponse(buffer_arg) {
  return ark_service_pb.GetVtxosResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_fulmine_v1_ListChainSwapsRequest(arg) {
  if (!(arg instanceof ark_service_pb.ListChainSwapsRequest)) {
    throw new Error('Expected argument of type fulmine.v1.ListChainSwapsRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_fulmine_v1_ListChainSwapsRequest(buffer_arg) {
  return ark_service_pb.ListChainSwapsRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_fulmine_v1_ListChainSwapsResponse(arg) {
  if (!(arg instanceof ark_service_pb.ListChainSwapsResponse)) {
    throw new Error('Expected argument of type fulmine.v1.ListChainSwapsResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_fulmine_v1_ListChainSwapsResponse(buffer_arg) {
  return ark_service_pb.ListChainSwapsResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_fulmine_v1_ListDelegatesRequest(arg) {
  if (!(arg instanceof ark_service_pb.ListDelegatesRequest)) {
    throw new Error('Expected argument of type fulmine.v1.ListDelegatesRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_fulmine_v1_ListDelegatesRequest(buffer_arg) {
  return ark_service_pb.ListDelegatesRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_fulmine_v1_ListDelegatesResponse(arg) {
  if (!(arg instanceof ark_service_pb.ListDelegatesResponse)) {
    throw new Error('Expected argument of type fulmine.v1.ListDelegatesResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_fulmine_v1_ListDelegatesResponse(buffer_arg) {
  return ark_service_pb.ListDelegatesResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_fulmine_v1_NextSettlementRequest(arg) {
  if (!(arg instanceof ark_service_pb.NextSettlementRequest)) {
    throw new Error('Expected argument of type fulmine.v1.NextSettlementRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_fulmine_v1_NextSettlementRequest(buffer_arg) {
  return ark_service_pb.NextSettlementRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_fulmine_v1_NextSettlementResponse(arg) {
  if (!(arg instanceof ark_service_pb.NextSettlementResponse)) {
    throw new Error('Expected argument of type fulmine.v1.NextSettlementResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_fulmine_v1_NextSettlementResponse(buffer_arg) {
  return ark_service_pb.NextSettlementResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_fulmine_v1_RefundChainSwapRequest(arg) {
  if (!(arg instanceof ark_service_pb.RefundChainSwapRequest)) {
    throw new Error('Expected argument of type fulmine.v1.RefundChainSwapRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_fulmine_v1_RefundChainSwapRequest(buffer_arg) {
  return ark_service_pb.RefundChainSwapRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_fulmine_v1_RefundChainSwapResponse(arg) {
  if (!(arg instanceof ark_service_pb.RefundChainSwapResponse)) {
    throw new Error('Expected argument of type fulmine.v1.RefundChainSwapResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_fulmine_v1_RefundChainSwapResponse(buffer_arg) {
  return ark_service_pb.RefundChainSwapResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_fulmine_v1_SettleVHTLCRequest(arg) {
  if (!(arg instanceof ark_service_pb.SettleVHTLCRequest)) {
    throw new Error('Expected argument of type fulmine.v1.SettleVHTLCRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_fulmine_v1_SettleVHTLCRequest(buffer_arg) {
  return ark_service_pb.SettleVHTLCRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_fulmine_v1_SettleVHTLCResponse(arg) {
  if (!(arg instanceof ark_service_pb.SettleVHTLCResponse)) {
    throw new Error('Expected argument of type fulmine.v1.SettleVHTLCResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_fulmine_v1_SettleVHTLCResponse(buffer_arg) {
  return ark_service_pb.SettleVHTLCResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
claimVHTLC: {
  ...
  settleVHTLC: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: ark_service_pb.SettleVHTLCRequest,
    responseType: ark_service_pb.SettleVHTLCResponse,
    requestSerialize: serialize_fulmine_v1_SettleVHTLCRequest,
    requestDeserialize: deserialize_fulmine_v1_SettleVHTLCRequest,
    responseSerialize: serialize_fulmine_v1_SettleVHTLCResponse,
    responseDeserialize: deserialize_fulmine_v1_SettleVHTLCResponse,
  },
...
getVtxos: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: ark_service_pb.GetVtxosRequest,
    responseType: ark_service_pb.GetVtxosResponse,
    requestSerialize: serialize_fulmine_v1_GetVtxosRequest,
    requestDeserialize: deserialize_fulmine_v1_GetVtxosRequest,
    responseSerialize: serialize_fulmine_v1_GetVtxosResponse,
    responseDeserialize: deserialize_fulmine_v1_GetVtxosResponse,
  },
...
nextSettlement: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: ark_service_pb.NextSettlementRequest,
    responseType: ark_service_pb.NextSettlementResponse,
    requestSerialize: serialize_fulmine_v1_NextSettlementRequest,
    requestDeserialize: deserialize_fulmine_v1_NextSettlementRequest,
    responseSerialize: serialize_fulmine_v1_NextSettlementResponse,
    responseDeserialize: deserialize_fulmine_v1_NextSettlementResponse,
  },
...
createChainSwap: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: ark_service_pb.CreateChainSwapRequest,
    responseType: ark_service_pb.CreateChainSwapResponse,
    requestSerialize: serialize_fulmine_v1_CreateChainSwapRequest,
    requestDeserialize: deserialize_fulmine_v1_CreateChainSwapRequest,
    responseSerialize: serialize_fulmine_v1_CreateChainSwapResponse,
    responseDeserialize: deserialize_fulmine_v1_CreateChainSwapResponse,
  },
...
listChainSwaps: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: ark_service_pb.ListChainSwapsRequest,
    responseType: ark_service_pb.ListChainSwapsResponse,
    requestSerialize: serialize_fulmine_v1_ListChainSwapsRequest,
    requestDeserialize: deserialize_fulmine_v1_ListChainSwapsRequest,
    responseSerialize: serialize_fulmine_v1_ListChainSwapsResponse,
    responseDeserialize: deserialize_fulmine_v1_ListChainSwapsResponse,
  },
...
refundChainSwap: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: ark_service_pb.RefundChainSwapRequest,
    responseType: ark_service_pb.RefundChainSwapResponse,
    requestSerialize: serialize_fulmine_v1_RefundChainSwapRequest,
    requestDeserialize: deserialize_fulmine_v1_RefundChainSwapRequest,
    responseSerialize: serialize_fulmine_v1_RefundChainSwapResponse,
    responseDeserialize: deserialize_fulmine_v1_RefundChainSwapResponse,
  },
...
listDelegates: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: ark_service_pb.ListDelegatesRequest,
    responseType: ark_service_pb.ListDelegatesResponse,
    requestSerialize: serialize_fulmine_v1_ListDelegatesRequest,
    requestDeserialize: deserialize_fulmine_v1_ListDelegatesRequest,
    responseSerialize: serialize_fulmine_v1_ListDelegatesResponse,
    responseDeserialize: deserialize_fulmine_v1_ListDelegatesResponse,
  },
};
