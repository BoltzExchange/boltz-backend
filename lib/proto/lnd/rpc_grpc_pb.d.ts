...
interface ILightningService_IBatchOpenChannel extends grpc.MethodDefinition<lnd_rpc_pb.BatchOpenChannelRequest, lnd_rpc_pb.BatchOpenChannelResponse> {
...
interface ILightningService_IDeletePayment extends grpc.MethodDefinition<lnd_rpc_pb.DeletePaymentRequest, lnd_rpc_pb.DeletePaymentResponse> {
...
interface ILightningService_ICheckMacaroonPermissions extends grpc.MethodDefinition<lnd_rpc_pb.CheckMacPermRequest, lnd_rpc_pb.CheckMacPermResponse> {
...
interface ILightningService_IRegisterRPCMiddleware extends grpc.MethodDefinition<lnd_rpc_pb.RPCMiddlewareResponse, lnd_rpc_pb.RPCMiddlewareRequest> {
...
interface ILightningService_ISendCustomMessage extends grpc.MethodDefinition<lnd_rpc_pb.SendCustomMessageRequest, lnd_rpc_pb.SendCustomMessageResponse> {
...
interface ILightningService_ISubscribeCustomMessages extends grpc.MethodDefinition<lnd_rpc_pb.SubscribeCustomMessagesRequest, lnd_rpc_pb.CustomMessage> {
...
interface ILightningService_IListAliases extends grpc.MethodDefinition<lnd_rpc_pb.ListAliasesRequest, lnd_rpc_pb.ListAliasesResponse> {
...
interface ILightningService_ILookupHtlcResolution extends grpc.MethodDefinition<lnd_rpc_pb.LookupHtlcResolutionRequest, lnd_rpc_pb.LookupHtlcResolutionResponse> {
...
export interface ILightningServer extends grpc.UntypedServiceImplementation {
    ...
    batchOpenChannel: grpc.handleUnaryCall<lnd_rpc_pb.BatchOpenChannelRequest, lnd_rpc_pb.BatchOpenChannelResponse>;
    ...
    checkMacaroonPermissions: grpc.handleUnaryCall<lnd_rpc_pb.CheckMacPermRequest, lnd_rpc_pb.CheckMacPermResponse>;
    registerRPCMiddleware: grpc.handleBidiStreamingCall<lnd_rpc_pb.RPCMiddlewareResponse, lnd_rpc_pb.RPCMiddlewareRequest>;
    sendCustomMessage: grpc.handleUnaryCall<lnd_rpc_pb.SendCustomMessageRequest, lnd_rpc_pb.SendCustomMessageResponse>;
    subscribeCustomMessages: grpc.handleServerStreamingCall<lnd_rpc_pb.SubscribeCustomMessagesRequest, lnd_rpc_pb.CustomMessage>;
    listAliases: grpc.handleUnaryCall<lnd_rpc_pb.ListAliasesRequest, lnd_rpc_pb.ListAliasesResponse>;
    lookupHtlcResolution: grpc.handleUnaryCall<lnd_rpc_pb.LookupHtlcResolutionRequest, lnd_rpc_pb.LookupHtlcResolutionResponse>;
}
...
export interface ILightningClient {
    ...
    batchOpenChannel(request: lnd_rpc_pb.BatchOpenChannelRequest, callback: (error: grpc.ServiceError | null, response: lnd_rpc_pb.BatchOpenChannelResponse) => void): grpc.ClientUnaryCall;
    batchOpenChannel(request: lnd_rpc_pb.BatchOpenChannelRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: lnd_rpc_pb.BatchOpenChannelResponse) => void): grpc.ClientUnaryCall;
    batchOpenChannel(request: lnd_rpc_pb.BatchOpenChannelRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: lnd_rpc_pb.BatchOpenChannelResponse) => void): grpc.ClientUnaryCall;
    ...
    deletePayment(request: lnd_rpc_pb.DeletePaymentRequest, callback: (error: grpc.ServiceError | null, response: lnd_rpc_pb.DeletePaymentResponse) => void): grpc.ClientUnaryCall;
    deletePayment(request: lnd_rpc_pb.DeletePaymentRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: lnd_rpc_pb.DeletePaymentResponse) => void): grpc.ClientUnaryCall;
    deletePayment(request: lnd_rpc_pb.DeletePaymentRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: lnd_rpc_pb.DeletePaymentResponse) => void): grpc.ClientUnaryCall;
    ...
    checkMacaroonPermissions(request: lnd_rpc_pb.CheckMacPermRequest, callback: (error: grpc.ServiceError | null, response: lnd_rpc_pb.CheckMacPermResponse) => void): grpc.ClientUnaryCall;
    checkMacaroonPermissions(request: lnd_rpc_pb.CheckMacPermRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: lnd_rpc_pb.CheckMacPermResponse) => void): grpc.ClientUnaryCall;
    checkMacaroonPermissions(request: lnd_rpc_pb.CheckMacPermRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: lnd_rpc_pb.CheckMacPermResponse) => void): grpc.ClientUnaryCall;
    registerRPCMiddleware(): grpc.ClientDuplexStream<lnd_rpc_pb.RPCMiddlewareResponse, lnd_rpc_pb.RPCMiddlewareRequest>;
    registerRPCMiddleware(options: Partial<grpc.CallOptions>): grpc.ClientDuplexStream<lnd_rpc_pb.RPCMiddlewareResponse, lnd_rpc_pb.RPCMiddlewareRequest>;
    registerRPCMiddleware(metadata: grpc.Metadata, options?: Partial<grpc.CallOptions>): grpc.ClientDuplexStream<lnd_rpc_pb.RPCMiddlewareResponse, lnd_rpc_pb.RPCMiddlewareRequest>;
    sendCustomMessage(request: lnd_rpc_pb.SendCustomMessageRequest, callback: (error: grpc.ServiceError | null, response: lnd_rpc_pb.SendCustomMessageResponse) => void): grpc.ClientUnaryCall;
    sendCustomMessage(request: lnd_rpc_pb.SendCustomMessageRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: lnd_rpc_pb.SendCustomMessageResponse) => void): grpc.ClientUnaryCall;
    sendCustomMessage(request: lnd_rpc_pb.SendCustomMessageRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: lnd_rpc_pb.SendCustomMessageResponse) => void): grpc.ClientUnaryCall;
    subscribeCustomMessages(request: lnd_rpc_pb.SubscribeCustomMessagesRequest, options?: Partial<grpc.CallOptions>): grpc.ClientReadableStream<lnd_rpc_pb.CustomMessage>;
    subscribeCustomMessages(request: lnd_rpc_pb.SubscribeCustomMessagesRequest, metadata?: grpc.Metadata, options?: Partial<grpc.CallOptions>): grpc.ClientReadableStream<lnd_rpc_pb.CustomMessage>;
    listAliases(request: lnd_rpc_pb.ListAliasesRequest, callback: (error: grpc.ServiceError | null, response: lnd_rpc_pb.ListAliasesResponse) => void): grpc.ClientUnaryCall;
    listAliases(request: lnd_rpc_pb.ListAliasesRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: lnd_rpc_pb.ListAliasesResponse) => void): grpc.ClientUnaryCall;
    listAliases(request: lnd_rpc_pb.ListAliasesRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: lnd_rpc_pb.ListAliasesResponse) => void): grpc.ClientUnaryCall;
    lookupHtlcResolution(request: lnd_rpc_pb.LookupHtlcResolutionRequest, callback: (error: grpc.ServiceError | null, response: lnd_rpc_pb.LookupHtlcResolutionResponse) => void): grpc.ClientUnaryCall;
    lookupHtlcResolution(request: lnd_rpc_pb.LookupHtlcResolutionRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: lnd_rpc_pb.LookupHtlcResolutionResponse) => void): grpc.ClientUnaryCall;
    lookupHtlcResolution(request: lnd_rpc_pb.LookupHtlcResolutionRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: lnd_rpc_pb.LookupHtlcResolutionResponse) => void): grpc.ClientUnaryCall;
}
...
export class LightningClient extends grpc.Client implements ILightningClient {
    ...
    public batchOpenChannel(request: lnd_rpc_pb.BatchOpenChannelRequest, callback: (error: grpc.ServiceError | null, response: lnd_rpc_pb.BatchOpenChannelResponse) => void): grpc.ClientUnaryCall;
    public batchOpenChannel(request: lnd_rpc_pb.BatchOpenChannelRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: lnd_rpc_pb.BatchOpenChannelResponse) => void): grpc.ClientUnaryCall;
    public batchOpenChannel(request: lnd_rpc_pb.BatchOpenChannelRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: lnd_rpc_pb.BatchOpenChannelResponse) => void): grpc.ClientUnaryCall;
    ...
    public deletePayment(request: lnd_rpc_pb.DeletePaymentRequest, callback: (error: grpc.ServiceError | null, response: lnd_rpc_pb.DeletePaymentResponse) => void): grpc.ClientUnaryCall;
    public deletePayment(request: lnd_rpc_pb.DeletePaymentRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: lnd_rpc_pb.DeletePaymentResponse) => void): grpc.ClientUnaryCall;
    public deletePayment(request: lnd_rpc_pb.DeletePaymentRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: lnd_rpc_pb.DeletePaymentResponse) => void): grpc.ClientUnaryCall;
    ...
    public checkMacaroonPermissions(request: lnd_rpc_pb.CheckMacPermRequest, callback: (error: grpc.ServiceError | null, response: lnd_rpc_pb.CheckMacPermResponse) => void): grpc.ClientUnaryCall;
    public checkMacaroonPermissions(request: lnd_rpc_pb.CheckMacPermRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: lnd_rpc_pb.CheckMacPermResponse) => void): grpc.ClientUnaryCall;
    public checkMacaroonPermissions(request: lnd_rpc_pb.CheckMacPermRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: lnd_rpc_pb.CheckMacPermResponse) => void): grpc.ClientUnaryCall;
    public registerRPCMiddleware(options?: Partial<grpc.CallOptions>): grpc.ClientDuplexStream<lnd_rpc_pb.RPCMiddlewareResponse, lnd_rpc_pb.RPCMiddlewareRequest>;
    public registerRPCMiddleware(metadata?: grpc.Metadata, options?: Partial<grpc.CallOptions>): grpc.ClientDuplexStream<lnd_rpc_pb.RPCMiddlewareResponse, lnd_rpc_pb.RPCMiddlewareRequest>;
    public sendCustomMessage(request: lnd_rpc_pb.SendCustomMessageRequest, callback: (error: grpc.ServiceError | null, response: lnd_rpc_pb.SendCustomMessageResponse) => void): grpc.ClientUnaryCall;
    public sendCustomMessage(request: lnd_rpc_pb.SendCustomMessageRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: lnd_rpc_pb.SendCustomMessageResponse) => void): grpc.ClientUnaryCall;
    public sendCustomMessage(request: lnd_rpc_pb.SendCustomMessageRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: lnd_rpc_pb.SendCustomMessageResponse) => void): grpc.ClientUnaryCall;
    public subscribeCustomMessages(request: lnd_rpc_pb.SubscribeCustomMessagesRequest, options?: Partial<grpc.CallOptions>): grpc.ClientReadableStream<lnd_rpc_pb.CustomMessage>;
    public subscribeCustomMessages(request: lnd_rpc_pb.SubscribeCustomMessagesRequest, metadata?: grpc.Metadata, options?: Partial<grpc.CallOptions>): grpc.ClientReadableStream<lnd_rpc_pb.CustomMessage>;
    public listAliases(request: lnd_rpc_pb.ListAliasesRequest, callback: (error: grpc.ServiceError | null, response: lnd_rpc_pb.ListAliasesResponse) => void): grpc.ClientUnaryCall;
    public listAliases(request: lnd_rpc_pb.ListAliasesRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: lnd_rpc_pb.ListAliasesResponse) => void): grpc.ClientUnaryCall;
    public listAliases(request: lnd_rpc_pb.ListAliasesRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: lnd_rpc_pb.ListAliasesResponse) => void): grpc.ClientUnaryCall;
    public lookupHtlcResolution(request: lnd_rpc_pb.LookupHtlcResolutionRequest, callback: (error: grpc.ServiceError | null, response: lnd_rpc_pb.LookupHtlcResolutionResponse) => void): grpc.ClientUnaryCall;
    public lookupHtlcResolution(request: lnd_rpc_pb.LookupHtlcResolutionRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: lnd_rpc_pb.LookupHtlcResolutionResponse) => void): grpc.ClientUnaryCall;
    public lookupHtlcResolution(request: lnd_rpc_pb.LookupHtlcResolutionRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: lnd_rpc_pb.LookupHtlcResolutionResponse) => void): grpc.ClientUnaryCall;
}
