...
impl Musig {
    ...
    pub fn new_from_key(key: Keypair, their_public_key: PublicKey, msg: [u8; 32]) -> Result<Self> {
        let pub_keys = vec![key.public_key(), their_public_key];
        Self::new(key, pub_keys, msg)
    }
