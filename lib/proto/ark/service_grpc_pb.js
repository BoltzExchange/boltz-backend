...
function serialize_fulmine_v1_CreateInvoiceRequest(arg) {
  if (!(arg instanceof ark_service_pb.CreateInvoiceRequest)) {
    throw new Error('Expected argument of type fulmine.v1.CreateInvoiceRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_fulmine_v1_CreateInvoiceRequest(buffer_arg) {
  return ark_service_pb.CreateInvoiceRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_fulmine_v1_CreateInvoiceResponse(arg) {
  if (!(arg instanceof ark_service_pb.CreateInvoiceResponse)) {
    throw new Error('Expected argument of type fulmine.v1.CreateInvoiceResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_fulmine_v1_CreateInvoiceResponse(buffer_arg) {
  return ark_service_pb.CreateInvoiceResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
listVHTLC: {
  ...
  createInvoice: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: ark_service_pb.CreateInvoiceRequest,
    responseType: ark_service_pb.CreateInvoiceResponse,
    requestSerialize: serialize_fulmine_v1_CreateInvoiceRequest,
    requestDeserialize: deserialize_fulmine_v1_CreateInvoiceRequest,
    responseSerialize: serialize_fulmine_v1_CreateInvoiceResponse,
    responseDeserialize: deserialize_fulmine_v1_CreateInvoiceResponse,
  },
  payInvoice: {
