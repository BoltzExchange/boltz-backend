...
function serialize_boltzrpc_SetDisableCooperativeRequest(arg) {
  if (!(arg instanceof boltzrpc_pb.SetDisableCooperativeRequest)) {
    throw new Error('Expected argument of type boltzrpc.SetDisableCooperativeRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_boltzrpc_SetDisableCooperativeRequest(buffer_arg) {
  return boltzrpc_pb.SetDisableCooperativeRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_boltzrpc_SetDisableCooperativeResponse(arg) {
  if (!(arg instanceof boltzrpc_pb.SetDisableCooperativeResponse)) {
    throw new Error('Expected argument of type boltzrpc.SetDisableCooperativeResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_boltzrpc_SetDisableCooperativeResponse(buffer_arg) {
  return boltzrpc_pb.SetDisableCooperativeResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
getPendingSweeps: {
  ...
  // Disables cooperative signatures for swaps 
setDisableCooperative: {
    path: '/boltzrpc.Boltz/SetDisableCooperative',
    requestStream: false,
    responseStream: false,
    requestType: boltzrpc_pb.SetDisableCooperativeRequest,
    responseType: boltzrpc_pb.SetDisableCooperativeResponse,
    requestSerialize: serialize_boltzrpc_SetDisableCooperativeRequest,
    requestDeserialize: deserialize_boltzrpc_SetDisableCooperativeRequest,
    responseSerialize: serialize_boltzrpc_SetDisableCooperativeResponse,
    responseDeserialize: deserialize_boltzrpc_SetDisableCooperativeResponse,
  },
};
