...
goog.exportSymbol('proto.boltzrpc.Node', null, global);
...
proto.boltzrpc.InvoicePaymentHookResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = /** @type {!proto.boltzrpc.Node} */ (reader.readEnum());
      msg.setAction(value);
      break;
    case 3:
      var value = /** @type {number} */ (reader.readDouble());
 ...
 * @return {!proto.boltzrpc.Node}
 */
proto.boltzrpc.InvoicePaymentHookResponse.prototype.getAction = function() {
  return /** @type {!proto.boltzrpc.Node} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};


/**
 * @param {!proto.boltzrpc.Node} value
 * @return {!proto.boltzrpc.InvoicePaymentHookResponse} returns this
 */
