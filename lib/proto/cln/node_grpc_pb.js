...
function serialize_cln_SendonionmessageRequest(arg) {
  if (!(arg instanceof cln_node_pb.SendonionmessageRequest)) {
    throw new Error('Expected argument of type cln.SendonionmessageRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_cln_SendonionmessageRequest(buffer_arg) {
  return cln_node_pb.SendonionmessageRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_cln_SendonionmessageResponse(arg) {
  if (!(arg instanceof cln_node_pb.SendonionmessageResponse)) {
    throw new Error('Expected argument of type cln.SendonionmessageResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_cln_SendonionmessageResponse(buffer_arg) {
  return cln_node_pb.SendonionmessageResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var NodeService = exports.NodeService = {
  ...
  sendOnionMessage: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: cln_node_pb.SendonionmessageRequest,
    responseType: cln_node_pb.SendonionmessageResponse,
    requestSerialize: serialize_cln_SendonionmessageRequest,
    requestDeserialize: deserialize_cln_SendonionmessageRequest,
    responseSerialize: serialize_cln_SendonionmessageResponse,
    responseDeserialize: deserialize_cln_SendonionmessageResponse,
  },
  setChannel: {
