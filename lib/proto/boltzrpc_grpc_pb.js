...
function serialize_boltzrpc_DisableSignerRequest(arg) {
  if (!(arg instanceof boltzrpc_pb.DisableSignerRequest)) {
    throw new Error('Expected argument of type boltzrpc.DisableSignerRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_boltzrpc_DisableSignerRequest(buffer_arg) {
  return boltzrpc_pb.DisableSignerRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_boltzrpc_DisableSignerResponse(arg) {
  if (!(arg instanceof boltzrpc_pb.DisableSignerResponse)) {
    throw new Error('Expected argument of type boltzrpc.DisableSignerResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_boltzrpc_DisableSignerResponse(buffer_arg) {
  return boltzrpc_pb.DisableSignerResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_boltzrpc_EnableSignerRequest(arg) {
  if (!(arg instanceof boltzrpc_pb.EnableSignerRequest)) {
    throw new Error('Expected argument of type boltzrpc.EnableSignerRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_boltzrpc_EnableSignerRequest(buffer_arg) {
  return boltzrpc_pb.EnableSignerRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_boltzrpc_EnableSignerResponse(arg) {
  if (!(arg instanceof boltzrpc_pb.EnableSignerResponse)) {
    throw new Error('Expected argument of type boltzrpc.EnableSignerResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_boltzrpc_EnableSignerResponse(buffer_arg) {
  return boltzrpc_pb.EnableSignerResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
allowRefund: {
  ...
  disableSigner: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: boltzrpc_pb.DisableSignerRequest,
    responseType: boltzrpc_pb.DisableSignerResponse,
    requestSerialize: serialize_boltzrpc_DisableSignerRequest,
    requestDeserialize: deserialize_boltzrpc_DisableSignerRequest,
    responseSerialize: serialize_boltzrpc_DisableSignerResponse,
    responseDeserialize: deserialize_boltzrpc_DisableSignerResponse,
  },
  enableSigner: {
    path: '/boltzrpc.Boltz/EnableSigner',
    requestStream: false,
    responseStream: false,
    requestType: boltzrpc_pb.EnableSignerRequest,
    responseType: boltzrpc_pb.EnableSignerResponse,
    requestSerialize: serialize_boltzrpc_EnableSignerRequest,
    requestDeserialize: deserialize_boltzrpc_EnableSignerRequest,
    responseSerialize: serialize_boltzrpc_EnableSignerResponse,
    responseDeserialize: deserialize_boltzrpc_EnableSignerResponse,
  },
  getDisabledSigners: {
