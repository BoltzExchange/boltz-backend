...
class ChannelCreationRepository {
  ...
  ): Promise<ChannelCreation | null> => {
    return ChannelCreation.findOne({
      where: options,
    });
  };

  public static getChannelCreations = (
    options?: WhereOptions,
  ...
  public static addChannelCreation = (
    channelCreation: ChannelCreationType,
  ): Promise<ChannelCreation> => {
    return ChannelCreation.create(channelCreation);
  };

  public static setAttempted = (
  ...
  public static setNodePublicKey = (
    channelCreation: ChannelCreation,
