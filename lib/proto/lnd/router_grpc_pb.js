...
function serialize_routerrpc_AddAliasesRequest(arg) {
  if (!(arg instanceof lnd_router_pb.AddAliasesRequest)) {
    throw new Error('Expected argument of type routerrpc.AddAliasesRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_routerrpc_AddAliasesRequest(buffer_arg) {
  return lnd_router_pb.AddAliasesRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_routerrpc_AddAliasesResponse(arg) {
  if (!(arg instanceof lnd_router_pb.AddAliasesResponse)) {
    throw new Error('Expected argument of type routerrpc.AddAliasesResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_routerrpc_AddAliasesResponse(buffer_arg) {
  return lnd_router_pb.AddAliasesResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_routerrpc_DeleteAliasesRequest(arg) {
  if (!(arg instanceof lnd_router_pb.DeleteAliasesRequest)) {
    throw new Error('Expected argument of type routerrpc.DeleteAliasesRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_routerrpc_DeleteAliasesRequest(buffer_arg) {
  return lnd_router_pb.DeleteAliasesRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_routerrpc_DeleteAliasesResponse(arg) {
  if (!(arg instanceof lnd_router_pb.DeleteAliasesResponse)) {
    throw new Error('Expected argument of type routerrpc.DeleteAliasesResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_routerrpc_DeleteAliasesResponse(buffer_arg) {
  return lnd_router_pb.DeleteAliasesResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_routerrpc_FindBaseAliasRequest(arg) {
  if (!(arg instanceof lnd_router_pb.FindBaseAliasRequest)) {
    throw new Error('Expected argument of type routerrpc.FindBaseAliasRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_routerrpc_FindBaseAliasRequest(buffer_arg) {
  return lnd_router_pb.FindBaseAliasRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_routerrpc_FindBaseAliasResponse(arg) {
  if (!(arg instanceof lnd_router_pb.FindBaseAliasResponse)) {
    throw new Error('Expected argument of type routerrpc.FindBaseAliasResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_routerrpc_FindBaseAliasResponse(buffer_arg) {
  return lnd_router_pb.FindBaseAliasResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_routerrpc_TrackPaymentsRequest(arg) {
  if (!(arg instanceof lnd_router_pb.TrackPaymentsRequest)) {
    throw new Error('Expected argument of type routerrpc.TrackPaymentsRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_routerrpc_TrackPaymentsRequest(buffer_arg) {
  return lnd_router_pb.TrackPaymentsRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
trackPayments: {
    ...
    requestStream: false,
    responseStream: true,
    requestType: lnd_router_pb.TrackPaymentsRequest,
    responseType: lnd_rpc_pb.Payment,
    requestSerialize: serialize_routerrpc_TrackPaymentsRequest,
    requestDeserialize: deserialize_routerrpc_TrackPaymentsRequest,
    responseSerialize: serialize_lnrpc_Payment,
    responseDeserialize: deserialize_lnrpc_Payment,
  },
  //
...
xAddLocalChanAliases: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: lnd_router_pb.AddAliasesRequest,
    responseType: lnd_router_pb.AddAliasesResponse,
    requestSerialize: serialize_routerrpc_AddAliasesRequest,
    requestDeserialize: deserialize_routerrpc_AddAliasesRequest,
    responseSerialize: serialize_routerrpc_AddAliasesResponse,
    responseDeserialize: deserialize_routerrpc_AddAliasesResponse,
  },
  //
...
xDeleteLocalChanAliases: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: lnd_router_pb.DeleteAliasesRequest,
    responseType: lnd_router_pb.DeleteAliasesResponse,
    requestSerialize: serialize_routerrpc_DeleteAliasesRequest,
    requestDeserialize: deserialize_routerrpc_DeleteAliasesRequest,
    responseSerialize: serialize_routerrpc_DeleteAliasesResponse,
    responseDeserialize: deserialize_routerrpc_DeleteAliasesResponse,
  },
  //
...
xFindBaseLocalChanAlias: {
    path: '/routerrpc.Router/XFindBaseLocalChanAlias',
    requestStream: false,
    responseStream: false,
    requestType: lnd_router_pb.FindBaseAliasRequest,
    responseType: lnd_router_pb.FindBaseAliasResponse,
    requestSerialize: serialize_routerrpc_FindBaseAliasRequest,
    requestDeserialize: deserialize_routerrpc_FindBaseAliasRequest,
    responseSerialize: serialize_routerrpc_FindBaseAliasResponse,
    responseDeserialize: deserialize_routerrpc_FindBaseAliasResponse,
  },
};

exports.RouterClient = grpc.makeGenericClientConstructor(RouterService, 'Router');
