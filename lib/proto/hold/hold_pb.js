...
goog.exportSymbol('proto.hold.OnionMessagesRequest', null, global);
 ...
 * @constructor
 */
proto.hold.OnionMessagesRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.hold.OnionMessagesRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.hold.OnionMessagesRequest.displayName = 'proto.hold.OnionMessagesRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.hold.OnionMessagesRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.hold.OnionMessagesRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.hold.OnionMessagesRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.hold.OnionMessagesRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.hold.OnionMessagesRequest}
 */
proto.hold.OnionMessagesRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.hold.OnionMessagesRequest;
  return proto.hold.OnionMessagesRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.hold.OnionMessagesRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.hold.OnionMessagesRequest}
 */
proto.hold.OnionMessagesRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.hold.OnionMessagesRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.hold.OnionMessagesRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.hold.OnionMessagesRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.hold.OnionMessagesRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
 ...
 * @const
 */
proto.hold.OnionMessage.repeatedFields_ = [6];
...
proto.hold.OnionMessage.prototype.getReplyBlindedpath = function() {
  return /** @type{?proto.hold.OnionMessage.ReplyBlindedPath} */ (
    jspb.Message.getWrapperField(this, proto.hold.OnionMessage.ReplyBlindedPath, 2));
};
...
proto.hold.OnionMessage.prototype.getUnknownFieldsList = function() {
  return /** @type{!Array<!proto.hold.OnionMessage.UnknownField>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.hold.OnionMessage.UnknownField, 6));
};
...
proto.hold.OnionMessage.prototype.addUnknownFields = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 6, opt_value, proto.hold.OnionMessage.UnknownField, opt_index);
};
