 ...
 * @return {number}
 */
proto.hold.Htlc.prototype.getCreationTime = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};
 ...
 * @return {!proto.hold.Htlc} returns this
 */
proto.hold.Htlc.prototype.setCreationTime = function(value) {
  return jspb.Message.setProto3IntField(this, 3, value);
};
 ...
 * @const
 */
proto.hold.Invoice.repeatedFields_ = [5];
...
proto.hold.Invoice.prototype.addHtlcs = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 5, opt_value, proto.hold.Htlc, opt_index);
};
