...
function serialize_mpay_PayStatusRequest(arg) {
  if (!(arg instanceof mpay_pb.PayStatusRequest)) {
    throw new Error('Expected argument of type mpay.PayStatusRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_mpay_PayStatusRequest(buffer_arg) {
  return mpay_pb.PayStatusRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_mpay_PayStatusResponse(arg) {
  if (!(arg instanceof mpay_pb.PayStatusResponse)) {
    throw new Error('Expected argument of type mpay.PayStatusResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_mpay_PayStatusResponse(buffer_arg) {
  return mpay_pb.PayStatusResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
payStatus: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: mpay_pb.PayStatusRequest,
    responseType: mpay_pb.PayStatusResponse,
    requestSerialize: serialize_mpay_PayStatusRequest,
    requestDeserialize: deserialize_mpay_PayStatusRequest,
    responseSerialize: serialize_mpay_PayStatusResponse,
    responseDeserialize: deserialize_mpay_PayStatusResponse,
  },
};
