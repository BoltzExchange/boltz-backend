...
function serialize_boltzr_FetchInvoiceRequest(arg) {
  if (!(arg instanceof boltzr_pb.FetchInvoiceRequest)) {
    throw new Error('Expected argument of type boltzr.FetchInvoiceRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_boltzr_FetchInvoiceRequest(buffer_arg) {
  return boltzr_pb.FetchInvoiceRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_boltzr_FetchInvoiceResponse(arg) {
  if (!(arg instanceof boltzr_pb.FetchInvoiceResponse)) {
    throw new Error('Expected argument of type boltzr.FetchInvoiceResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_boltzr_FetchInvoiceResponse(buffer_arg) {
  return boltzr_pb.FetchInvoiceResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var BoltzRService = exports.BoltzRService = {
  ...
  fetchInvoice: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: boltzr_pb.FetchInvoiceRequest,
    responseType: boltzr_pb.FetchInvoiceResponse,
    requestSerialize: serialize_boltzr_FetchInvoiceRequest,
    requestDeserialize: deserialize_boltzr_FetchInvoiceRequest,
    responseSerialize: serialize_boltzr_FetchInvoiceResponse,
    responseDeserialize: deserialize_boltzr_FetchInvoiceResponse,
  },
  scanMempool: {
