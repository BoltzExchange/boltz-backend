...
---
## [3.13.0](https://github.com/BoltzExchange/boltz-backend/compare/v3.12.1..v3.13.0) - 2026-05-08

### Bug Fixes

- **(evm)** validate commitment claim address (#1319) - ([91abbe4](https://github.com/BoltzExchange/boltz-backend/commit/91abbe4fe0af33359e471cafe011be388c915a7d))
- EIP refund signer cannot convert BigInt (#1195) - ([66846a2](https://github.com/BoltzExchange/boltz-backend/commit/66846a2a75ab5e6d4a481c147171a520e8dba375))
- network name for contracts - ([21c2cd0](https://github.com/BoltzExchange/boltz-backend/commit/21c2cd0fa1a2f7b524a40e5071c4e578801706f3))
- round Elements balance (#1200) - ([d8b8ab5](https://github.com/BoltzExchange/boltz-backend/commit/d8b8ab5b496f3072fc564f7caa4d40829bc4758d))
- token block times in sidecar - ([c5203e8](https://github.com/BoltzExchange/boltz-backend/commit/c5203e845602d6cf663ce01bf5d99ab97ec4cdb4))
- boltzr-cli Docker build (#1207) - ([e355fdb](https://github.com/BoltzExchange/boltz-backend/commit/e355fdbda1d00382071ac33551fbeeb278e3a122))
- encoding of calldata for token inputs (#1222) - ([bd42986](https://github.com/BoltzExchange/boltz-backend/commit/bd4298686ed6bdd37cbab7082b14a8d769cddcbb))
- replace hard-coded fee with feeFloor variable (#1221) - ([94e1b2b](https://github.com/BoltzExchange/boltz-backend/commit/94e1b2b602c350c8a61db3072c335cb1eee4dfb6))
- missing server public key for ark chain swaps (#1225) - ([a31ebdc](https://github.com/BoltzExchange/boltz-backend/commit/a31ebdc02d5482366d9bc8ae09596735afe38d69))
- swagger return type for chain swap claims (#1227) - ([a1bdac0](https://github.com/BoltzExchange/boltz-backend/commit/a1bdac0aab8ac9224622291fac920607d98c23b5))
- routing fee config (#1229) - ([95356e8](https://github.com/BoltzExchange/boltz-backend/commit/95356e89db7e2d88d0dcfc994fbcae010b4ef25e))
- prevent submarine from going back in time (#1235) - ([b36852d](https://github.com/BoltzExchange/boltz-backend/commit/b36852da1c8197155a7c62327e5cca902e554a38))
- quoter tests (#1245) - ([a60be30](https://github.com/BoltzExchange/boltz-backend/commit/a60be30e6f9c0623465635ec7f739124d374e8ee))
- settle after invoice is set for confirmed swap - ([fbb875f](https://github.com/BoltzExchange/boltz-backend/commit/fbb875f6d887e5d35db70048637d8f66216210e5))
- mempool.space startup race - ([c98d7d8](https://github.com/BoltzExchange/boltz-backend/commit/c98d7d8d52eaf01a4c8a4b20283bf997c62bb303))
- Docker build on branches with / (#1274) - ([459c684](https://github.com/BoltzExchange/boltz-backend/commit/459c684a2779204677b874721f7ab67cd3d9885c))
- EVM chain swap double lockups - ([4a58a5e](https://github.com/BoltzExchange/boltz-backend/commit/4a58a5e31c90e825d694ee022cada6dd9ed79488))
- wait for confirmations for commitment swaps (#1281) - ([619de84](https://github.com/BoltzExchange/boltz-backend/commit/619de8495a8af46ab49092550e1f871a30fc2533))
- skip commitments migration if the table does not exist (#1292) - ([9a7ebc1](https://github.com/BoltzExchange/boltz-backend/commit/9a7ebc109a7850d6799cc6bbf60dd426947114f4))
- do not crash when no tokens are configured - ([2375d47](https://github.com/BoltzExchange/boltz-backend/commit/2375d476f56ec67a24639fe343f73108787d1fc6))
- only expiry swaps of own manager in nursery - ([d71920a](https://github.com/BoltzExchange/boltz-backend/commit/d71920ab9a09416ab5e57ad9c0b7316b3fd16dee))
- ignore undefined min wallet balance (#1299) - ([47c537c](https://github.com/BoltzExchange/boltz-backend/commit/47c537cef15388f659b31940b185832bdae68292))
- ignore undefined min token balance (#1304) - ([615a22e](https://github.com/BoltzExchange/boltz-backend/commit/615a22e27ff44b616b35a8f432c69a3d832974d2))
- ARK chain swap restore (#1307) - ([9254db7](https://github.com/BoltzExchange/boltz-backend/commit/9254db72661b50e733e4bbc6d7f7c0911e6e8d00))
- use same EVM derivation path in sidecar (#1310) - ([c811525](https://github.com/BoltzExchange/boltz-backend/commit/c8115255d5c77116609fed72ebd0c008865994a0))
- ARK submarine swap expiration (#1321) - ([0eddd03](https://github.com/BoltzExchange/boltz-backend/commit/0eddd03536df3c0298c5c04e6c99aa49c62eabcb))
- Arbitrum rescan storms (#1328) - ([dd6dbe4](https://github.com/BoltzExchange/boltz-backend/commit/dd6dbe48eb8dc6bc5431596737c5f9f583e3493a))
- chain swaps between EVM chains (#1333) - ([1a2b41f](https://github.com/BoltzExchange/boltz-backend/commit/1a2b41f4655580996227c50c47fc1b625dab88c9))
- tolerate unavailable nodes for reverse swaps (#1335) - ([0defcc6](https://github.com/BoltzExchange/boltz-backend/commit/0defcc6920a79f8066e99b8361166af59acfd9d1))
- bump EVM tx gas limits by 25% (#1340) - ([43ffd92](https://github.com/BoltzExchange/boltz-backend/commit/43ffd9266f4d1e4011f60a4cdb15935c263aeb23))
- Docker builds - ([b68451c](https://github.com/BoltzExchange/boltz-backend/commit/b68451cb6990877287438e16a2452fc09b8cf929))
- macaroon support in boltzr-cli - ([43b40a6](https://github.com/BoltzExchange/boltz-backend/commit/43b40a6b410419b812d93b307f45f95b48a7035f))
- cap swap restore pagination - ([d1f25dc](https://github.com/BoltzExchange/boltz-backend/commit/d1f25dc5df0c745efc7ff0ced1befac0c260f005))
- exclude paid swaps from invoice expiry - ([a72b208](https://github.com/BoltzExchange/boltz-backend/commit/a72b208d785981dfcc2c2729296bddc88d0785dc))
- recompute zero-conf on chain swap renegotiation - ([9a113da](https://github.com/BoltzExchange/boltz-backend/commit/9a113da557854ec79b0e0026064d13c862b08037))
- prevent expiry from overwriting paid swaps - ([4bd233b](https://github.com/BoltzExchange/boltz-backend/commit/4bd233b53916f6f58d6f7f2f8df25902682492bb))
- round Bitcoin fee estimations to one decimal - ([b5aeb83](https://github.com/BoltzExchange/boltz-backend/commit/b5aeb83513448b81f1d741342d388f65c0797dee))
- deduplicate mempool.space instances - ([78a6629](https://github.com/BoltzExchange/boltz-backend/commit/78a66294a00513bd35fd60f66958bdc2bd39ab26))
- tolerate positive slippage (#1372) - ([94c260b](https://github.com/BoltzExchange/boltz-backend/commit/94c260bd71580d40fba20c239ccb0bddd010c301))
- normalize address case when matching tx.to (#1382) - ([ce18517](https://github.com/BoltzExchange/boltz-backend/commit/ce18517fa3037096b5eec5865c38b9b9c92a6d80))
- racy renegotiation (#1383) - ([4a9c282](https://github.com/BoltzExchange/boltz-backend/commit/4a9c282b168dae5194efd7407e4f8b55288adff8))
- sync linked swap and commitment on cooperative refund (#1385) - ([980b589](https://github.com/BoltzExchange/boltz-backend/commit/980b589346ddc6c94ce72ed45cb7b04711e76a17))
- skip commitment lookup for server lockups (#1394) - ([4c7d601](https://github.com/BoltzExchange/boltz-backend/commit/4c7d6010fc6cf39889396b0cd4843ea3929a66cb))

### Documentation

- add transaction.claim.pending status to Chain Swap (#1212) - ([0e5f690](https://github.com/BoltzExchange/boltz-backend/commit/0e5f690792d53237c2a3dc0647253b4896dd7d48))
- update regtest config (#1213) - ([35c3271](https://github.com/BoltzExchange/boltz-backend/commit/35c3271d2e1ea1c3f9b3b3a6dda7c38dde64cf70))
- add unit for reverse swap expiration limits (#1230) - ([4007740](https://github.com/BoltzExchange/boltz-backend/commit/40077401aa91e415c9efdf8b8a540aee06f26b72))
- chain swap renegotiating - ([569b5c5](https://github.com/BoltzExchange/boltz-backend/commit/569b5c54455d7a089c89cb7b50ff396cd4df0250))
- fee and limit calculations - ([0ac2f63](https://github.com/BoltzExchange/boltz-backend/commit/0ac2f637fd2b0bbb1e2b8c79c72b5fd220d7c202))
- asset rescue (#1241) - ([443af29](https://github.com/BoltzExchange/boltz-backend/commit/443af29a474b3e1efac494a9a6be7ad640b7144e))
- rename referral program to partner program (#1247) - ([f937662](https://github.com/BoltzExchange/boltz-backend/commit/f93766228e3b1177574817cf130eb16b6968bf2e))
- add overview for enforcement (#1259) - ([cfb4ff2](https://github.com/BoltzExchange/boltz-backend/commit/cfb4ff2f5f9747d6ec78ae1dfb733dcfbee6efcb))
- fix broken regtest GitHub link (#1303) - ([dbb5c87](https://github.com/BoltzExchange/boltz-backend/commit/dbb5c87ae776c1a31115494e32ddbd66c841e335))
- switch to currency abbreviations (#1369) - ([6134e71](https://github.com/BoltzExchange/boltz-backend/commit/6134e7137ddfd7bbbf9c27c63772969622bd672e))
- expose Markdown in docs (#1373) - ([342ceca](https://github.com/BoltzExchange/boltz-backend/commit/342ceca4f0fcb8d4474a0bb79f828b07e72c2334))
- use vitepress-plugin-llms - ([00fc88c](https://github.com/BoltzExchange/boltz-backend/commit/00fc88c50b3ccd899ce51cf63c4c4e15dd817856))
- include index.md in llms.txt (#1378) - ([ef4e31e](https://github.com/BoltzExchange/boltz-backend/commit/ef4e31eb7faab426c1cd210d02bd7197cf543e4f))
- document cooperative claim/refund states (#1380) - ([6ba692a](https://github.com/BoltzExchange/boltz-backend/commit/6ba692acbf22664b30b8d328f3b9e1c45c6026ac))
- add Boltz Mini (#1390) - ([a95db55](https://github.com/BoltzExchange/boltz-backend/commit/a95db5522cafd501ee3316413e84cf93007d0fba))

### Features

- Ark swaps (#1181) - ([6412528](https://github.com/BoltzExchange/boltz-backend/commit/641252852cb47ff3474e200cba13e56f6a5e8a1f))
- save chain of pending EVM transaction - ([afcb34e](https://github.com/BoltzExchange/boltz-backend/commit/afcb34ed5aec43353c32c5c94be98e6d790399ec))
- trace EVM requests - ([12fd769](https://github.com/BoltzExchange/boltz-backend/commit/12fd7698513bf56b033f3c9c9fd20168885b4efa))
- ethers.js WebSocket reconnect - ([c924739](https://github.com/BoltzExchange/boltz-backend/commit/c924739089fd039512e9d4b457ba5da8d053446d))
- BTC-like token network fees - ([f5a6818](https://github.com/BoltzExchange/boltz-backend/commit/f5a68189b992047b728a6310c0caacdff3bea7f4))
- L1 block events for Arbitrum - ([32b525a](https://github.com/BoltzExchange/boltz-backend/commit/32b525aef4140e002b2a5b8024767f01d895a506))
- ERC20Swap CLI (#1205) - ([adf266c](https://github.com/BoltzExchange/boltz-backend/commit/adf266c6c254925cd163e9ff6bc791e033e99832))
- ARK lockup renegotiation - ([a76e888](https://github.com/BoltzExchange/boltz-backend/commit/a76e888441d077def4e456c3623111d7c406dc04))
- improve EVM quoter to route via one hop (#1214) - ([58892e3](https://github.com/BoltzExchange/boltz-backend/commit/58892e3cb6632cdfd6a0c5a1142f80ddcbcba068))
- sub-sat fee estimations (#1210) - ([792c9e5](https://github.com/BoltzExchange/boltz-backend/commit/792c9e59f5e5ee04e9d05f08bb95476e6c785bfa))
- EVM commitment swaps (#1226) - ([3579ccc](https://github.com/BoltzExchange/boltz-backend/commit/3579cccfb51bb7bb7db97ffe016619a12730561a))
- handle unbroadcastable sent transactions (#1242) - ([87e7d7f](https://github.com/BoltzExchange/boltz-backend/commit/87e7d7fc11237da958c48614ca452e8399bc9a56))
- CLI to sign EIP-712 refunds (#1250) - ([46f6ad9](https://github.com/BoltzExchange/boltz-backend/commit/46f6ad93b692ea468949938a9bb025bb2c403f07))
- webhookinfo command - ([8040f0d](https://github.com/BoltzExchange/boltz-backend/commit/8040f0d9b57a3d5b23422578582f143eda2f09c3))
- support contracts v6 - ([80e68c6](https://github.com/BoltzExchange/boltz-backend/commit/80e68c6f8d476647b471c01e2a204740e0b623eb))
- ERC20Swap support in locked-in-contract CLI - ([c746667](https://github.com/BoltzExchange/boltz-backend/commit/c74666772846fdd5f585a2e2ee081d242a1da8d3))
- support multiple lnds (#1277) - ([728510f](https://github.com/BoltzExchange/boltz-backend/commit/728510f3ca96894fe4e7859165745f7283ce0099))
- allow refunding commitments before linking (#1290) - ([77a7d39](https://github.com/BoltzExchange/boltz-backend/commit/77a7d39c05f617e9faff54229f297a4c43d4e608))
- add multi-lnd sidecar support (#1291) - ([4ea4477](https://github.com/BoltzExchange/boltz-backend/commit/4ea4477547928395e7702c071c0d4774f5581c63))
- include MRH address in swapinfo command (#1293) - ([a82a5e6](https://github.com/BoltzExchange/boltz-backend/commit/a82a5e6a93b207c2f9de85b0a5849c0354a425ad))
- custom EVM derivation paths (#1296) - ([6046cac](https://github.com/BoltzExchange/boltz-backend/commit/6046cacb3a74b32d5a83c420967a4ec12892d14f))
- hide pairs in list endpoints (#1300) - ([41254fe](https://github.com/BoltzExchange/boltz-backend/commit/41254fe3fa2515728a8c96f2cd62231894d64ad6))
- hide pair for a referral - ([1ab7aed](https://github.com/BoltzExchange/boltz-backend/commit/1ab7aedd79cb61800f554a982cb2012c190a17d4))
- return invoice in rescue endpoint (#1315) - ([dd840bc](https://github.com/BoltzExchange/boltz-backend/commit/dd840bcff2ad90f50602e38b8dbfcecc036390e1))
- use required confirmations for refunds (#1331) - ([d340924](https://github.com/BoltzExchange/boltz-backend/commit/d340924cffa49bc0cab616075cbd062c09596a0a))
- add InvoiceCreationHook (#1325) - ([b6e2e13](https://github.com/BoltzExchange/boltz-backend/commit/b6e2e13c734ac3d516b059d2280b16101c79d2de))
- add tx to transaction.refunded event (#1330) - ([1d8925e](https://github.com/BoltzExchange/boltz-backend/commit/1d8925e18362163b68d70cd55804e2226f6310c6))
- rate limit websocket messages (#1337) - ([b5bf456](https://github.com/BoltzExchange/boltz-backend/commit/b5bf456645d475e79cb2e2065bd41746766054b9))
- swap update WebSocket CLI tool - ([6cb942f](https://github.com/BoltzExchange/boltz-backend/commit/6cb942f4c9c996364d06006a5449ff63ce1c958a))
- limit swap.update subscribe ids (#1341) - ([41d8591](https://github.com/BoltzExchange/boltz-backend/commit/41d85910dd65a0e875ba3934a37da873015e590f))
- specify outpoint for fulmine vHTLC calls (#1345) - ([1c0e4cf](https://github.com/BoltzExchange/boltz-backend/commit/1c0e4cf69c5f14a67b74fab6da7ea48eee765327))
- improve HTTP status codes (#1351) - ([2dd5d31](https://github.com/BoltzExchange/boltz-backend/commit/2dd5d31d5509e49ba5e16a9bb793574193c62702))
- CLI tool to rotate referral API keys (#1358) - ([840a496](https://github.com/BoltzExchange/boltz-backend/commit/840a4966dab151663915c644c4d051342f6736f4))
- add fulmine macaroon support (#1360) - ([4eb225a](https://github.com/BoltzExchange/boltz-backend/commit/4eb225ab238f407ed2a45c28fafb6551f6c6693a))
- store found claim transactions ids (#1371) - ([c3045d3](https://github.com/BoltzExchange/boltz-backend/commit/c3045d37bf67eb51ee96b88a6116bde57ad20eee))
- EVM 0-amount commitments (#1389) - ([f028d1b](https://github.com/BoltzExchange/boltz-backend/commit/f028d1b9841552d53aec2f163cc53022b5a54740))

### Miscellaneous Chores

- bump to Bitcoin Core v30.2 - ([505d902](https://github.com/BoltzExchange/boltz-backend/commit/505d902fb45b631efa5014f94b54f1360676f477))
- bump dependencies - ([63859a1](https://github.com/BoltzExchange/boltz-backend/commit/63859a152fe8b1103db134aeca57186806cb520d))
- bump aws-sdk-kms from 1.43.0 to 1.97.0 (#1190) - ([68b4640](https://github.com/BoltzExchange/boltz-backend/commit/68b4640b766ec9823a8ccd90169613bc01b9e60f))
- minor logging improvements (#1194) - ([a1fb0f1](https://github.com/BoltzExchange/boltz-backend/commit/a1fb0f137d0d20d5e7187dea95004fb93190461d))
- configure alloy WebSocket reconnect - ([77d89d9](https://github.com/BoltzExchange/boltz-backend/commit/77d89d96a2e9ba61afb66f2c6d83b5058ff01968))
- bump urllib3 from 2.5.0 to 2.6.3 in /tools (#1198) - ([a4c7270](https://github.com/BoltzExchange/boltz-backend/commit/a4c7270c9ef20560d4570fea59382ca2857c4fbf))
- bump CLN to v25.12.1 - ([48efcbf](https://github.com/BoltzExchange/boltz-backend/commit/48efcbfef41de6736ed41fe3c43fc91c4b1e22b6))
- bump dependencies - ([2ed43d5](https://github.com/BoltzExchange/boltz-backend/commit/2ed43d5f4776917ce7f898180f7f48e9adcabc68))
- simplify sidecar metrics - ([89a0f4a](https://github.com/BoltzExchange/boltz-backend/commit/89a0f4a07f21d970091f2fc36cf34705083d85cf))
- relax invoice description regex (#1203) - ([f152f37](https://github.com/BoltzExchange/boltz-backend/commit/f152f37d7902d0fb74dd73646bd378a56eac3eac))
- warn when ARK node is missing on startup (#1206) - ([475b933](https://github.com/BoltzExchange/boltz-backend/commit/475b9337876c905c04fff37bf914f5850dd75f13))
- harden ARK spentBy handling - ([233e2f5](https://github.com/BoltzExchange/boltz-backend/commit/233e2f5cd66732a7ef5fe445711ddd30b715c1f4))
- make fee optional for SendCoins gRPC (#1215) - ([b7506f8](https://github.com/BoltzExchange/boltz-backend/commit/b7506f87b5dee1d4606bd9dfa256f7d4f3a2d270))
- bump lodash from 4.17.21 to 4.17.23 (#1216) - ([2241532](https://github.com/BoltzExchange/boltz-backend/commit/224153250cc4a2b6e3e38655a63d06fa86bc7c6b))
- bump lodash-es from 4.17.22 to 4.17.23 (#1217) - ([5112b04](https://github.com/BoltzExchange/boltz-backend/commit/5112b0435b916b139781885c8d9770d99e468eba))
- make Elements tx test less flaky in CI (#1218) - ([7fd4db8](https://github.com/BoltzExchange/boltz-backend/commit/7fd4db8cf70af7f806d5b130c2ac35516bd95d8d))
- add timeouts to CI jobs (#1219) - ([bc58809](https://github.com/BoltzExchange/boltz-backend/commit/bc58809a96901acd48a7c964bfec6977a287b021))
- fix swagger for chain swap pairs (#1223) - ([9d2e3e9](https://github.com/BoltzExchange/boltz-backend/commit/9d2e3e97c6529b62c59649a94c6bcfc2df17de57))
- add full config sample (#1224) - ([ad98bbc](https://github.com/BoltzExchange/boltz-backend/commit/ad98bbcb7aede6cba9787739e64f9c3b50a32b27))
- explicit S3 names in setup errors (#1232) - ([22a0f9d](https://github.com/BoltzExchange/boltz-backend/commit/22a0f9daa85e0a6215e554ee9e60cbd53c48a597))
- remove Discord link from docs (#1234) - ([2de6c83](https://github.com/BoltzExchange/boltz-backend/commit/2de6c835991c6a4a2077f2fdf91f43e83988a62b))
- update dependencies (#1237) - ([7248cb1](https://github.com/BoltzExchange/boltz-backend/commit/7248cb129f7dca263e3a3ac67237e841ca871089))
- bump bytes from 1.11.0 to 1.11.1 (#1240) - ([1019152](https://github.com/BoltzExchange/boltz-backend/commit/10191522755e0b96cacd9f8947a9a5baf38916ce))
- SQL formatting with prettier (#1243) - ([746da5d](https://github.com/BoltzExchange/boltz-backend/commit/746da5d1442cbf6e9d7e1fa49ef43f159a32f222))
- bump git2 from 0.20.0 to 0.20.4 (#1244) - ([91d8054](https://github.com/BoltzExchange/boltz-backend/commit/91d8054391d87b8df9fa4fb5b0bfba0987c31d0a))
- bump time from 0.3.36 to 0.3.47 (#1246) - ([6fbd6c5](https://github.com/BoltzExchange/boltz-backend/commit/6fbd6c5519cc787885f1b8e63638bfb0ff6d6b4d))
- bump axios from 1.13.4 to 1.13.5 (#1249) - ([2d80a61](https://github.com/BoltzExchange/boltz-backend/commit/2d80a616a2aee15c1c0e40f0f7d7b9a121769cb5))
- remove Telegram link from resources (#1248) - ([6014f1f](https://github.com/BoltzExchange/boltz-backend/commit/6014f1fca7a530e0bc4ac290cb4268c78995f79f))
- bump qs from 6.14.1 to 6.14.2 (#1255) - ([7f14803](https://github.com/BoltzExchange/boltz-backend/commit/7f14803623349ab8c2f4fdac16d7f9059bc574c8))
- bump LND to v0.20.1 (#1257) - ([80f58c3](https://github.com/BoltzExchange/boltz-backend/commit/80f58c35599e2f3c73b121ed22d898717f17406b))
- update dependencies - ([32b7cae](https://github.com/BoltzExchange/boltz-backend/commit/32b7cae9e9eb165e51d67bb053d6da9882af0449))
- bump Elements to v23.3.2 (#1264) - ([f1e7ebb](https://github.com/BoltzExchange/boltz-backend/commit/f1e7ebb5fed9967d79b5908e155eb00f9af9ab6e))
- get rid of openssl-sys in dependencies - ([9854bfc](https://github.com/BoltzExchange/boltz-backend/commit/9854bfcc1d44b0a1317b4a55a56ffb24fb26736b))
- update dependencies - ([07dc3d0](https://github.com/BoltzExchange/boltz-backend/commit/07dc3d0cc02ec2cb856bb43dbd86484d1acea37c))
- bump max sidecar connection retries - ([7a4d2d1](https://github.com/BoltzExchange/boltz-backend/commit/7a4d2d196ee572782a5ac0cf4fb941af0bf1dde6))
- check generated protos in CI - ([752f9d2](https://github.com/BoltzExchange/boltz-backend/commit/752f9d2d895b432a62aa4bdf9707741a443d6e0e))
- remove channel creation swaps (#1269) - ([0b95d64](https://github.com/BoltzExchange/boltz-backend/commit/0b95d64d3f46a4a60d3aa1d044b7f257bfb31dc4))
- minor fixes for running on Arbitrum (#1275) - ([4d33fbb](https://github.com/BoltzExchange/boltz-backend/commit/4d33fbb6c00149f4d53f0af6f317c0c41fe461f0))
- improve pending EVM transaction CLI output - ([448c787](https://github.com/BoltzExchange/boltz-backend/commit/448c78702f27aa5ba7ca71d16613df0bcb3e10c3))
- bump dottie from 2.0.6 to 2.0.7 (#1284) - ([11f44e9](https://github.com/BoltzExchange/boltz-backend/commit/11f44e92ab9363b59c8129b92b6fce185b5abaae))
- bump minimatch from 3.1.3 to 3.1.5 (#1286) - ([00f8972](https://github.com/BoltzExchange/boltz-backend/commit/00f89723506e875308c71bcf6d6a5b4a7f4e3b42))
- remove togglereverse command (#1289) - ([06685d5](https://github.com/BoltzExchange/boltz-backend/commit/06685d5bad1d55b7ba0ed4b75a066c2948d5a351))
- bump underscore from 1.13.7 to 1.13.8 (#1294) - ([cb69ed1](https://github.com/BoltzExchange/boltz-backend/commit/cb69ed103184837afaac57335135c89bf01a2256))
- update link to Boltz Client Pro docs (#1295) - ([ea54a09](https://github.com/BoltzExchange/boltz-backend/commit/ea54a093e3fe0acb2efeff62058526c3018acc76))
- add debug logging for regtest start (#1298) - ([038b273](https://github.com/BoltzExchange/boltz-backend/commit/038b2733332debf6852dc26dd6ebae7acb03a371))
- CLI to derive EVM addresses - ([0b709b2](https://github.com/BoltzExchange/boltz-backend/commit/0b709b2f9deaf1390c63e66bb52ff752ae5a18c5))
- update dependencies (#1301) - ([d312710](https://github.com/BoltzExchange/boltz-backend/commit/d31271043bdcf757f224dc86077370153b8e4924))
- bump sequelize from 6.37.7 to 6.37.8 (#1314) - ([55f2852](https://github.com/BoltzExchange/boltz-backend/commit/55f2852b1eb04873040bf608fc0c230a1bac74f5))
- bump quinn-proto from 0.11.13 to 0.11.14 (#1313) - ([86f599a](https://github.com/BoltzExchange/boltz-backend/commit/86f599aeb8125eb0b9bd9485dc1c2591524c686f))
- BOLTZ_REGTEST env var for overriding regtest (#1316) - ([04c25fb](https://github.com/BoltzExchange/boltz-backend/commit/04c25fb581bb23c1966e31066904a677dbf15673))
- remove stubbed routing hint (#1318) - ([73b908b](https://github.com/BoltzExchange/boltz-backend/commit/73b908bbc6a3aeb805976eb399b49709f29b5d69))
- update Arkade stack - ([46f7af6](https://github.com/BoltzExchange/boltz-backend/commit/46f7af656e593d2d4694e9e3114a0dc811d61d28))
- update dependencies - ([54a913b](https://github.com/BoltzExchange/boltz-backend/commit/54a913bdde1004a48275baacc932f454309cf248))
- harden exchange tests - ([b1194d6](https://github.com/BoltzExchange/boltz-backend/commit/b1194d631b4f97f13069939f1c826f4d282e96ec))
- bump yaml from 2.8.2 to 2.8.3 (#1338) - ([c2e49ff](https://github.com/BoltzExchange/boltz-backend/commit/c2e49ffd03fa1fae7cf44d200b1f13686650b77d))
- bump picomatch from 2.3.1 to 2.3.2 (#1339) - ([eaa3215](https://github.com/BoltzExchange/boltz-backend/commit/eaa321518f5e5f79c4425de319fe8151a7f23999))
- bump nodemailer from 8.0.3 to 8.0.4 (#1342) - ([6b76a7e](https://github.com/BoltzExchange/boltz-backend/commit/6b76a7ea400cb0c1a4f7a309527ca334939c2c29))
- bump node-forge from 1.3.3 to 1.4.0 (#1343) - ([4be863f](https://github.com/BoltzExchange/boltz-backend/commit/4be863f9474b4eb11228b675d21c5b10e7e25d6a))
- bump path-to-regexp from 8.3.0 to 8.4.0 (#1344) - ([196571b](https://github.com/BoltzExchange/boltz-backend/commit/196571b62e22287537932dd76543ce6eadc65693))
- update dependencies - ([78888ae](https://github.com/BoltzExchange/boltz-backend/commit/78888aead3d52575ce111cb00d5b1714ad592b23))
- update to TypeScript v6 - ([0297b06](https://github.com/BoltzExchange/boltz-backend/commit/0297b06f0e469c7b15af9cbf8fd9ea886354f243))
- fix vulnerable Cargo dependencies (#1349) - ([ba4bd7b](https://github.com/BoltzExchange/boltz-backend/commit/ba4bd7bc17b914492aeb4ec533712e8d1cfe4cb3))
- update vulnerable dependencies (#1352) - ([dbad7e0](https://github.com/BoltzExchange/boltz-backend/commit/dbad7e0c7d392f8ec94c9d9c592fa59fe7f48dff))
- bump nodemailer (#1355) - ([51f972c](https://github.com/BoltzExchange/boltz-backend/commit/51f972c1ab3f32a5569f9b38a2aa12dd3a25ce02))
- bump dependencies - ([3a4ccfb](https://github.com/BoltzExchange/boltz-backend/commit/3a4ccfb2dd26fd3a02f9acf199c5732bac20dd6d))
- bump Elements to v23.3.3 - ([463f965](https://github.com/BoltzExchange/boltz-backend/commit/463f965743d74e904625c452a0584089182a4366))
- bump follow-redirects from 1.15.11 to 1.16.0 (#1359) - ([6c1772b](https://github.com/BoltzExchange/boltz-backend/commit/6c1772b0b068a515ba464b3c7c5f41d9a7a8c7f5))
- fix docs publish action (#1361) - ([688494d](https://github.com/BoltzExchange/boltz-backend/commit/688494d5c4428bbbd0aa9cb9d8242e1a41947562))
- fix clippy on Rust 1.95.0 - ([9a6a813](https://github.com/BoltzExchange/boltz-backend/commit/9a6a8137c309a430ed5c97f905c5900761aa17dc))
- use stable RPC for Arbitrum tests - ([9eb7e62](https://github.com/BoltzExchange/boltz-backend/commit/9eb7e62f055e6f8705a849605ea14031ac1d434e))
- bump Bitcoin Core to v31.0 - ([b92f887](https://github.com/BoltzExchange/boltz-backend/commit/b92f887f9a290739819ea1e673a632b2397b27e9))
- bump CLN to v26.04 - ([ab04e2a](https://github.com/BoltzExchange/boltz-backend/commit/ab04e2a6cffed33c99bb01345afc0e2853533517))
- bump protobufjs to v7.5.5 - ([7376b34](https://github.com/BoltzExchange/boltz-backend/commit/7376b3430c7ea031308edf2070211277ae4d5a08))
- bump vulnerable Rust dependencies - ([4e2a890](https://github.com/BoltzExchange/boltz-backend/commit/4e2a890bcdb9d150dffef8e49de155de8e1e9c55))
- bump postcss from 8.5.6 to 8.5.10 (#1376) - ([3a232c8](https://github.com/BoltzExchange/boltz-backend/commit/3a232c8a129adcddb7ff0e06786a7a2efc4f6040))
- bump CLN to v26.04.1 (#1377) - ([49751eb](https://github.com/BoltzExchange/boltz-backend/commit/49751eb1ca90494e148e0360a7aeadd2c7352a07))
- add comments to boltz-core exports - ([815c9af](https://github.com/BoltzExchange/boltz-backend/commit/815c9afb030d751afb7b18a81ca6d8071675d11c))
- separate CI job for boltz-core features - ([725e691](https://github.com/BoltzExchange/boltz-backend/commit/725e691986ee3f5c168084ba471a59e4c4bf65f4))
- make LLM docs discoverable (#1386) - ([84646bf](https://github.com/BoltzExchange/boltz-backend/commit/84646bf9f8c43e1cccbad2377cd1aa7a47dd2fad))
- bump axios (#1388) - ([ff1e9fb](https://github.com/BoltzExchange/boltz-backend/commit/ff1e9fb0079c7f153a3bb811aaa08a5bda225d7d))
- bump regtest (#1391) - ([85fd54d](https://github.com/BoltzExchange/boltz-backend/commit/85fd54d4cec9444548be9080fdd969bd4ed572bd))
- .gitignore .boltz-local (#1392) - ([4bc60b4](https://github.com/BoltzExchange/boltz-backend/commit/4bc60b4dc9b46a67677778918fcba274ccb916e4))
- bump ip-address from 10.1.0 to 10.2.0 (#1393) - ([33669dd](https://github.com/BoltzExchange/boltz-backend/commit/33669dd735f3eeca213cadf0b311b2bad06901b9))
- fix metrics in sidecar (#1395) - ([40b0eba](https://github.com/BoltzExchange/boltz-backend/commit/40b0eba436140e9586380eb5b33bfaaa5399ef47))

### Performance

- optimize Musig2 construction in CLI tool (#1251) - ([ada9d4f](https://github.com/BoltzExchange/boltz-backend/commit/ada9d4f8263c6714c96d3175c143f4940d7d6f96))

### Refactoring

- remove diesel-tracing dependency - ([126ae10](https://github.com/BoltzExchange/boltz-backend/commit/126ae10bc1b847f2c90a1ba2ebb993a15f97815e))
- move transaction check to sidecar (#1192) - ([d6d54a9](https://github.com/BoltzExchange/boltz-backend/commit/d6d54a9b67c66ea8c8c6809a34ede9354ff6a005))
- EVM chain configuration - ([cba72c9](https://github.com/BoltzExchange/boltz-backend/commit/cba72c950fe0ebc6082ae9d8c051d775df66a575))
- remove contract refund subscriptions (#1202) - ([b849cc7](https://github.com/BoltzExchange/boltz-backend/commit/b849cc7eaa368b2eab6e234cc4b637acb7fa917b))
- remove fee estimations from Node.js (#1231) - ([6191291](https://github.com/BoltzExchange/boltz-backend/commit/6191291bb657c2691aaa23ee5311ee98edbf67d1))
- move cache into own crate (#1256) - ([aac0927](https://github.com/BoltzExchange/boltz-backend/commit/aac09275151a8d022dab894dadb48f4825dc39b5))
- relax amount checks for setting invoices - ([24f701e](https://github.com/BoltzExchange/boltz-backend/commit/24f701eef83613fc4ea98ff64a91660fdff83a4d))
- use actual amounts for commitment signatures (#1263) - ([2dd301e](https://github.com/BoltzExchange/boltz-backend/commit/2dd301eba55bf4fd571e872fe2ee5897acfd0019))
- move EVM into own crate - ([937d276](https://github.com/BoltzExchange/boltz-backend/commit/937d27613e72282630a1c48981ee975d9dfdcdcf))
- move backup into own crate (#1261) - ([6c972de](https://github.com/BoltzExchange/boltz-backend/commit/6c972dea9abc75acf7f6ccd8c388bbc6070cb083))
- EVM configurable confirmation requirement (#1266) - ([e9a07e5](https://github.com/BoltzExchange/boltz-backend/commit/e9a07e55e7319b1639c1080fe54dd3ba12a3f8df))
- check confirmation of EVM transactions by receipt - ([9a365bd](https://github.com/BoltzExchange/boltz-backend/commit/9a365bd4a0a1758d807f7544d3aa26239e3584cd))
- add timeout to S3 initialization - ([4e103f7](https://github.com/BoltzExchange/boltz-backend/commit/4e103f741e7ce46ea37dd2b1ea7a8cb9f592379c))
- clean shutdown of EVM block listener - ([f45a7cf](https://github.com/BoltzExchange/boltz-backend/commit/f45a7cf733f66b7fa7694b991f1539953bfd427c))
- avoid swaps going back in time - ([9a5b61d](https://github.com/BoltzExchange/boltz-backend/commit/9a5b61db3ecf1bc27f528fc41bd498500db73df7))
- deduplicate pending EVM lockups - ([7d1a2d0](https://github.com/BoltzExchange/boltz-backend/commit/7d1a2d04f58e14061b7d605659604dc592cf40f9))
- use multicall for EVM quotes - ([6bcfd8d](https://github.com/BoltzExchange/boltz-backend/commit/6bcfd8d5387510f395fe8c37089445ff3e59cb6f))
- get rid of ctrlc dependency - ([de43109](https://github.com/BoltzExchange/boltz-backend/commit/de43109d5b7a4c6f0a42e44d3d6eb87b716d081d))
- improve commitment lookup (#1309) - ([2c7fe75](https://github.com/BoltzExchange/boltz-backend/commit/2c7fe755234d37ed69f208214d642c842e982d62))
- handling of non JSON Core RPC responses (#1332) - ([3a664b8](https://github.com/BoltzExchange/boltz-backend/commit/3a664b80b1b48f86cdf4401788f819a31cfa46ec))
- modernize gRPC protos - ([0648b4a](https://github.com/BoltzExchange/boltz-backend/commit/0648b4a52000355f742e1843ae001dfcca03cbb7))
- use Fulmine ListVHTLCs (#1353) - ([deff90f](https://github.com/BoltzExchange/boltz-backend/commit/deff90f5ac8c86881be1e31075d1144b6ac9e0af))
- optimize fulmine calls on startup - ([c2289a3](https://github.com/BoltzExchange/boltz-backend/commit/c2289a3ba57b795d67eab6fd7a2588c692ebdb23))
- sanitze referral ids - ([ba97d32](https://github.com/BoltzExchange/boltz-backend/commit/ba97d320818905d78dc145cdec9d575953ff82bc))
- harden BOLT12 offer handling - ([ee7392c](https://github.com/BoltzExchange/boltz-backend/commit/ee7392c1fc348b23a03fb8f1c67702e87af36d46))
- harden mempool.space integration - ([c2c8521](https://github.com/BoltzExchange/boltz-backend/commit/c2c8521a49db84b6442736c23a136b37e4b08254))
- do not use anyhow in boltz-core - ([8d5dcd7](https://github.com/BoltzExchange/boltz-backend/commit/8d5dcd715bde5469527bd8ffcf1a87a5ee6bbbb9))
- cleanup exports of boltz-core - ([a236a47](https://github.com/BoltzExchange/boltz-backend/commit/a236a47517c0309e426d7163c70a4f780bd47849))
- set Ark lockup tx before checks (#1381) - ([a490fd8](https://github.com/BoltzExchange/boltz-backend/commit/a490fd8970ac3838b30f7f5581f4c1dcb524bb3f))

### Tests

- **(*)** fix ARK and CLN integration flakes (#1324) - ([d4f8a28](https://github.com/BoltzExchange/boltz-backend/commit/d4f8a286340472d9cc75a8fb33cc2769c0013839))
- unique directories for gRPC cert (#1334) - ([5c68073](https://github.com/BoltzExchange/boltz-backend/commit/5c68073ef215cb462be1a855051df539ee7aa471))
...
- bump version to v3.12.1 (#1191) - ([f533f6d](https://github.com/BoltzExchange/boltz-backend/commit/f533f6da62fea82026ec384d329ba3d6d3d8f9a3))
...
- **(config)** update certificate path to follow datadir (#1078) - ([d8fbd5d](https://github.com/BoltzExchange/boltz-backend/commit/d8fbd5d407a96c73a8fc8323314baa71e780f54b))
- expose invoice payment hook (#940) - ([1534001](https://github.com/BoltzExchange/boltz-backend/commit/1534001e052c91f4c2d804010cfa7beef91bdc1e))
- invoice payment hook with no preference (#952) - ([2740fc4](https://github.com/BoltzExchange/boltz-backend/commit/2740fc4cc6997ffc7aa93662701aa0f4871ff96b))
- sanitize ZMQ wildcards (#965) - ([b773b79](https://github.com/BoltzExchange/boltz-backend/commit/b773b79fbac7e750fc67a2b3bdb5b7f504d25285))
- check invoice of self payments - ([c27b9ed](https://github.com/BoltzExchange/boltz-backend/commit/c27b9edd1aab9b4e8c7f7583cf08d6d97c7d4d34))
- handle pending payments in self payment client - ([5e435c6](https://github.com/BoltzExchange/boltz-backend/commit/5e435c6e6f9d6a4ea539b7769b1dc164f2e49cfa))
- check for blindingKey being defined (#967) - ([0c003e6](https://github.com/BoltzExchange/boltz-backend/commit/0c003e6b43833d317ddb76991c4e80810cea66e7))
- ZMQ channel warnings in sidecar (#969) - ([5002ce9](https://github.com/BoltzExchange/boltz-backend/commit/5002ce92e8c17d3565baa74db928cce842d3dd00))
- only allow submarine and reverse swaps with same preimage (#966) - ([240e8d7](https://github.com/BoltzExchange/boltz-backend/commit/240e8d71c67bbd927c9c2d0827f9799ced167d50))
- use second routing hint in MRH (#975) - ([dd8fa94](https://github.com/BoltzExchange/boltz-backend/commit/dd8fa94d0f872a88d15d79688b9e53cc8e0a1ef9))
- exit handle for MRH watcher (#982) - ([9f57672](https://github.com/BoltzExchange/boltz-backend/commit/9f57672adbd7442cb32c3a9109e40413168546ca))
- swap failed on double lockup (#984) - ([31e3a92](https://github.com/BoltzExchange/boltz-backend/commit/31e3a921d5f028aede2613acd92f3d47b3ba7509))
- reset pending sweeps gauges to zero (#987) - ([e762674](https://github.com/BoltzExchange/boltz-backend/commit/e762674f7836d711b3063b28f685509428da821b))
- encoding of MRH in swapinfo responses (#988) - ([95b5c97](https://github.com/BoltzExchange/boltz-backend/commit/95b5c9734d94cae570ea902e4edf6fc05b4d68ed))
- API docs URL (#990) - ([ab9d541](https://github.com/BoltzExchange/boltz-backend/commit/ab9d541a72ff34a899623837a00018c4143a698a))
- cancel of reverse swap invoices for self payments (#995) - ([7bab357](https://github.com/BoltzExchange/boltz-backend/commit/7bab357bed72f322bbb17e3df638ac6206b574dd))
- honor cancellation in mempool reconnection loop - ([ecb07b7](https://github.com/BoltzExchange/boltz-backend/commit/ecb07b78e13d289b2f92ef0f86a27f23ca79a859))
- handling of two lockups in same transaction (#1002) - ([6f030a9](https://github.com/BoltzExchange/boltz-backend/commit/6f030a9a98c0f2acd9fa8253599669d4200a6a4f))
- abandon webhook when no status in database (#1003) - ([24003ae](https://github.com/BoltzExchange/boltz-backend/commit/24003ae5fbcf9616f35627fee238c6fdf377e492))
- fail self payments when reverse swap is refunded (#1006) - ([501355b](https://github.com/BoltzExchange/boltz-backend/commit/501355be27b125c70cd516e77ee8a92e80a30a51))
- add database triggers for preimage hash checks (#1011) - ([7d5a4de](https://github.com/BoltzExchange/boltz-backend/commit/7d5a4de91d072e7f1070b4f19e23a691c64f5cfb))
- parsing of referral id for chain swaps (#1024) - ([b315f12](https://github.com/BoltzExchange/boltz-backend/commit/b315f1272b96ee80f0864325ae4ba3b38534bf5e))
- swap rescue key drift - ([1defe13](https://github.com/BoltzExchange/boltz-backend/commit/1defe1339afe82f76759299db1b6882afd43fe26))
- exclude RSK swaps from rescue endpoints - ([5e53c98](https://github.com/BoltzExchange/boltz-backend/commit/5e53c9830e872a3971caa2d1dcdfd8efe4bb063e))
- bump ZMQ inactivity timeout (#1038) - ([f22546f](https://github.com/BoltzExchange/boltz-backend/commit/f22546f5c0f59fb44fb5a257ba5241ab275e6256))
- flaky Elements transaction tests - ([ff5ecf7](https://github.com/BoltzExchange/boltz-backend/commit/ff5ecf7ae0b9302a006606778eedfd41ffe4a040))
- harden Mattermost WebSocket - ([8d5b502](https://github.com/BoltzExchange/boltz-backend/commit/8d5b5025091edaa8633fc25a6c504ee99256e748))
- run Bitcoin transaction tests in serial - ([c19f1b6](https://github.com/BoltzExchange/boltz-backend/commit/c19f1b6f3fca41aca868b3408f8689c4ba00b1af))
- make node selection optional in invoice payment hook (#1069) - ([1f62409](https://github.com/BoltzExchange/boltz-backend/commit/1f62409d7d39a241b55f2394c6b336a385a8d511))
- Docker version build args (#1074) - ([e9dcd80](https://github.com/BoltzExchange/boltz-backend/commit/e9dcd802039b673de6cab3d12e96e9212c7efad0))
- lower quote output amount in EVM quote test (#1098) - ([67a8456](https://github.com/BoltzExchange/boltz-backend/commit/67a845679c8f3258ec68520fbe1b1c1aaf34264d))
- sidecar span exporter - ([082fb93](https://github.com/BoltzExchange/boltz-backend/commit/082fb931f9b4d98734c1ddae677bcf1e12f134f5))
- use Node v22 for docker images - ([3e7398a](https://github.com/BoltzExchange/boltz-backend/commit/3e7398a61f79150a67f0663ccc63414e308eb604))
- do not fail self payment when invoice cannot be cancelled (#1111) - ([19f63f6](https://github.com/BoltzExchange/boltz-backend/commit/19f63f624ac951c26b2b500c452f64d72b14808b))
- setInvoice race condition (#1117) - ([f47ab4f](https://github.com/BoltzExchange/boltz-backend/commit/f47ab4f6cb1b5a89bbd1224503468e0fe0da1ca2))
- include swaps to RSK in restore endpoint (#1124) - ([b340d15](https://github.com/BoltzExchange/boltz-backend/commit/b340d1536e045e0f33d25f8148830aaed27b3928))
- only settle confirmed lockups when invoice is set (#1125) - ([0106e8b](https://github.com/BoltzExchange/boltz-backend/commit/0106e8b918c3f69a5c56b6991fd6529428bf2f6d))
- parent propagation of OTEL spans (#1126) - ([55806a2](https://github.com/BoltzExchange/boltz-backend/commit/55806a20a819e97a6674e4700e4c3ae8a671fd45))
- gap limit for public key iterators - ([584240b](https://github.com/BoltzExchange/boltz-backend/commit/584240bbbd4d68d4d05f6c63b4381f108c5dae8f))

### Documentation

- add support center to resources (#954) - ([b29608c](https://github.com/BoltzExchange/boltz-backend/commit/b29608cee0086320435e86db7b44b3749db07769))
- add referral payout terms (#964) - ([f57947f](https://github.com/BoltzExchange/boltz-backend/commit/f57947f990adcccea207f3839bce8209846b6ffb))
- clarify transactions and code samples (#955) - ([790b1d1](https://github.com/BoltzExchange/boltz-backend/commit/790b1d14c3b9056b2b2917248fb09b8e24035e87))
- remove testnet (#971) - ([c196c5c](https://github.com/BoltzExchange/boltz-backend/commit/c196c5c10a1cc168a3636ec46623a3620f6e411d))
- fix MRH example (#980) - ([e159bc2](https://github.com/BoltzExchange/boltz-backend/commit/e159bc27afd0c4479ee2ff7f40edb6ff7d2e5ac3))
- rephrase MRH doc (#981) - ([7c3508d](https://github.com/BoltzExchange/boltz-backend/commit/7c3508dec238d455cae4a823876f1e37bb763f06))
- fix typos - ([d6a4c5f](https://github.com/BoltzExchange/boltz-backend/commit/d6a4c5fd1976a92f86421d651fd7c25be2de8727))
- fix hint formatting - ([5143e77](https://github.com/BoltzExchange/boltz-backend/commit/5143e778d5cce874dfe0ae0ba0ebdff7c8ab01e0))
- transaction.direct WebSocket event - ([89eee5a](https://github.com/BoltzExchange/boltz-backend/commit/89eee5a6de82a478a231aa2fcd76c63fa7f9a768))
- BOLT12 reverse swaps - ([a01edb5](https://github.com/BoltzExchange/boltz-backend/commit/a01edb59d629a5a2a94e9ef727088a2d79c060aa))
- fix misc issues (#997) - ([099c874](https://github.com/BoltzExchange/boltz-backend/commit/099c87433d5a340b064b03736c78d665ef781b4b))
- extra fees endpoint (#1000) - ([13b5e47](https://github.com/BoltzExchange/boltz-backend/commit/13b5e4712de7a5f6cba4dbe9a8f3c7f94a31ff24))
- enable search detailed view (#1017) - ([1024283](https://github.com/BoltzExchange/boltz-backend/commit/102428333db99fe2639eda837c4af9f6f722f27c))
- swagger for token swaps quotes - ([7d2b32c](https://github.com/BoltzExchange/boltz-backend/commit/7d2b32c160b268c1dbae5525daf069c40e3be3f5))
- swagger for /v2/swap/restore endpoint - ([5806a8b](https://github.com/BoltzExchange/boltz-backend/commit/5806a8b0bfbe4a470969f8e3baf1cb01841ccbcf))
- add boltz-rust Python bindings (#1042) - ([b5916b7](https://github.com/BoltzExchange/boltz-backend/commit/b5916b7d0a6081e68bc3597ff6e6fc20db07e8c6))
- change warning boxes severity (#1046) - ([4721270](https://github.com/BoltzExchange/boltz-backend/commit/4721270c79ce94de4d0f74707d8d3d8d9727451a))
- fetch latest Go examples on docs build, move websocket section lower (#1047) - ([8c3802e](https://github.com/BoltzExchange/boltz-backend/commit/8c3802e991036fcfc26a6996bc3e1562e1abeef8))
- add pro stats endpoint to swagger (#1064) - ([fe2c12c](https://github.com/BoltzExchange/boltz-backend/commit/fe2c12cc39bff176444704ed96865bc9725502ce))
- fix typo in rescue key docs (#1070) - ([e43222d](https://github.com/BoltzExchange/boltz-backend/commit/e43222d809ee879cb2de95385363fcfd54b0e955))
- swap restore and deprecate rescue endpoint - ([0bd5540](https://github.com/BoltzExchange/boltz-backend/commit/0bd5540ef424289e7c8dd493a77007851fedff51))
- remove deprecated refund files - ([f2b436b](https://github.com/BoltzExchange/boltz-backend/commit/f2b436b0bb9e8f3de5d7e08213565ca838278b93))
- API authentication - ([52fc07b](https://github.com/BoltzExchange/boltz-backend/commit/52fc07b9986b6bce6dc4fb894f1be3ba9e39c3fa))
- reword swap restore docs based on feedback - ([d812069](https://github.com/BoltzExchange/boltz-backend/commit/d812069e90c1c6b915145c419d3b6a8d4f0b26f3))
- add boltz-cli to the backend development page (#1113) - ([059cd93](https://github.com/BoltzExchange/boltz-backend/commit/059cd93541e00464f63899fa70fd4699130a95ee))
- Chain Swap renegotiation - ([fdc0829](https://github.com/BoltzExchange/boltz-backend/commit/fdc0829731e2daffc2a2e3445a55ee9bf68b4dcc))
- BIP85 child seed derivation - ([7dea7fe](https://github.com/BoltzExchange/boltz-backend/commit/7dea7fe840c1086e279105a38a0f7bd64d7fd9bd))
- BIP85 rewording (#1122) - ([59008e2](https://github.com/BoltzExchange/boltz-backend/commit/59008e2c3d9ac68b3d354b66053d868102ff23ba))
- claim covenant use cases (#1118) - ([a8d42c9](https://github.com/BoltzExchange/boltz-backend/commit/a8d42c93c76ab1843e3f7775b96b7d5ce501e437))
- rewrite libraries section (#1121) - ([7dff883](https://github.com/BoltzExchange/boltz-backend/commit/7dff8833cf7488a1a69b12ee8aa6cd269239c340))

### Features

- add invoice to submarine swap creation hook (#941) - ([269d8da](https://github.com/BoltzExchange/boltz-backend/commit/269d8dafce324f4ba2ed75d6a3ce12f7a743363b))
- amount based batch sweep trigger (#944) - ([3b0df0d](https://github.com/BoltzExchange/boltz-backend/commit/3b0df0d8ce12c496aeec4ae80fe39f38527e13bd))
- make node preference in invoice payment hook optional (#949) - ([567d47d](https://github.com/BoltzExchange/boltz-backend/commit/567d47d7c520f905bd5ae200e94258dcdd77cf20))
- fallback to Webhook BOLT12 invoice fetching after Websocket timeout (#953) - ([1f3ef8c](https://github.com/BoltzExchange/boltz-backend/commit/1f3ef8c28678e1acb37eab62194de25ae7b18231))
- time preference in invoice payment hook (#958) - ([b6d6e51](https://github.com/BoltzExchange/boltz-backend/commit/b6d6e51258f1aa76c7416ea5819db2cd754ab089))
- add ZMQ client in sidecar (#960) - ([4204678](https://github.com/BoltzExchange/boltz-backend/commit/4204678b02a6f65d80360462b17a2b1566911a5e))
- allow self payments in swaps - ([7a25d92](https://github.com/BoltzExchange/boltz-backend/commit/7a25d92b0f1462028ab424fe24a825d76281bd90))
- pending sweep metrics (#977) - ([301c417](https://github.com/BoltzExchange/boltz-backend/commit/301c417402c41a8ff26f3140247569928779ccd4))
- magic routing hint watcher (#974) - ([d5bf7f7](https://github.com/BoltzExchange/boltz-backend/commit/d5bf7f7407c15a1b525fb1dbb85d7dd1a75cfec7))
- offerinfo command - ([bccb294](https://github.com/BoltzExchange/boltz-backend/commit/bccb294b61f9c845fd0d8d313d1aa978d21155ac))
- refund watcher (#983) - ([842e4da](https://github.com/BoltzExchange/boltz-backend/commit/842e4da47be3af408b3036335d32aa52722370a2))
- run MRH watcher through 0-conf API (#993) - ([d22f149](https://github.com/BoltzExchange/boltz-backend/commit/d22f14986bacfe3289d519844352fe5c567be317))
- mempool.space WebSocket client - ([151e127](https://github.com/BoltzExchange/boltz-backend/commit/151e127526ed7fb4146d41ed5c084a0474f55e4d))
- naive RBF bumping engine - ([320de84](https://github.com/BoltzExchange/boltz-backend/commit/320de840a2e86caf76fd3ea204cfc67ae20bdcb7))
- cache getrawtransaction - ([eef9787](https://github.com/BoltzExchange/boltz-backend/commit/eef97874b7f0507902a4be0e3dfdad15b6da6c46))
- CLI command to scan funds locked in contract - ([23e641d](https://github.com/BoltzExchange/boltz-backend/commit/23e641d86ff02144d121dfb82c9881b9b5e0b834))
- prevent allowing refunds when swap has pending HTLCs (#1007) - ([51a2e53](https://github.com/BoltzExchange/boltz-backend/commit/51a2e53313efc8d35e9962fd35669f29ed3a831f))
- blocked domains for webhooks (#1008) - ([e575d60](https://github.com/BoltzExchange/boltz-backend/commit/e575d60a9bf33753d7aae30d21ce6645264fbd53))
- Uniswap V3 EVM quoter - ([3aed747](https://github.com/BoltzExchange/boltz-backend/commit/3aed747ba958a6ba640d205cc0ef1a604332b058))
- Uniswap V3 calldata encoder - ([a2790eb](https://github.com/BoltzExchange/boltz-backend/commit/a2790ebf73b939ebecc8dbead825bedf0b365327))
- support multiple S3 backup providers (#1018) - ([06363da](https://github.com/BoltzExchange/boltz-backend/commit/06363da0fda2c700a1b51d3d895122ee8b9196d0))
- `/swap/restore` endpoint (#1010) - ([9328783](https://github.com/BoltzExchange/boltz-backend/commit/93287832ddaef5e441202378f25f5848bab65f76))
- swap update trigger (#1026) - ([04ca367](https://github.com/BoltzExchange/boltz-backend/commit/04ca36763e8dbb69189db7441bf4c9a0577d4076))
- harden chain swaps lockup handling (#1028) - ([54e2a26](https://github.com/BoltzExchange/boltz-backend/commit/54e2a2625892037f0098c03fb773421d7030dcaa))
- Taproot swaps in Rust - ([12b30f8](https://github.com/BoltzExchange/boltz-backend/commit/12b30f83e58e7c1e51631b5d9f0716e7df07c8c8))
- legacy swaps in Rust - ([7242b34](https://github.com/BoltzExchange/boltz-backend/commit/7242b34d93a745e9f8e0048f7e05bd4e8f9cb782))
- Liquid swaps in Rust - ([9908de7](https://github.com/BoltzExchange/boltz-backend/commit/9908de77c2893a26a11df71ff0b62f28cb257eea))
- allow sweeping to multiple destinations - ([2b522ce](https://github.com/BoltzExchange/boltz-backend/commit/2b522ce897a3315b24d48e6d18fba075a65b45cf))
- add createdRefundSignature to swaps (#1030) - ([cf46eab](https://github.com/BoltzExchange/boltz-backend/commit/cf46eabd5fd7ab5a898811921ecf066cdbf2456b))
- rescan after ZMQ reconnection - ([79745d1](https://github.com/BoltzExchange/boltz-backend/commit/79745d1a43ae2ecf4b986273487973164d3e7079))
- API endpoint to fetch status of multiple swaps (#1043) - ([130724d](https://github.com/BoltzExchange/boltz-backend/commit/130724d9fd434110a1c8436dec0453714ae4f131))
- ability to disable cooperative signatures (#1044) - ([dcf471c](https://github.com/BoltzExchange/boltz-backend/commit/dcf471cf6743b5eab85a4e9bab3f5785098867ad))
- EVM quote on output (#1055) - ([45a8a71](https://github.com/BoltzExchange/boltz-backend/commit/45a8a71857b5d9b8ae52973abf54854fffd7c90e))
- nested referral stats - ([569a945](https://github.com/BoltzExchange/boltz-backend/commit/569a945196ccee1049958f15b27d9fe0a3d28e9a))
- rescan last block when received (#1062) - ([41fbb6f](https://github.com/BoltzExchange/boltz-backend/commit/41fbb6fec7b9608e9663d58d260d43da90814a14))
- `cltvDelta` config option (#1076) - ([69ada5d](https://github.com/BoltzExchange/boltz-backend/commit/69ada5dd3a5f9614e2468ba05783b4cdb1d15bd4))
- timeouts for async startup in sidecar - ([8e60d4c](https://github.com/BoltzExchange/boltz-backend/commit/8e60d4c11bbeaa771d9f0b9b12a9de28fab257af))
- include valid invoice expiration range in error - ([7c84705](https://github.com/BoltzExchange/boltz-backend/commit/7c84705f36e3f3ea0872f30b4d4c8ca5fe760e9d))
- API endpoint to fetch invoice expiry ranges - ([c25f3bd](https://github.com/BoltzExchange/boltz-backend/commit/c25f3bd77adaa2aef60ed6a8c1dd475b603839b3))
- explicit error when wrong asset is sent - ([d3e7dce](https://github.com/BoltzExchange/boltz-backend/commit/d3e7dce027e2664cce0ae6beceff3a0c810e654f))
- no coop claims for refunded chain swaps (#1104) - ([4131f0e](https://github.com/BoltzExchange/boltz-backend/commit/4131f0ee5bf1dcd156149b694eab2f6368cd437b))
- add alerts for batch claim failures (#1112) - ([bf6976b](https://github.com/BoltzExchange/boltz-backend/commit/bf6976b67b62db4099cdd3b3f7cd05772a30c6d8))
- swap restore with single public key - ([f8275cb](https://github.com/BoltzExchange/boltz-backend/commit/f8275cb761f44eed116e593dab414a92f3f8eb70))
- swap restore with batch of public keys - ([77b7e82](https://github.com/BoltzExchange/boltz-backend/commit/77b7e82a311a47ce8bef0204377254a2f8a62c93))
- custom gap limit for swap restore - ([1b1cfd4](https://github.com/BoltzExchange/boltz-backend/commit/1b1cfd42cac9eab5647996fa242050010a576d7d))
- endpoint to get last used swap restore index - ([80a62d5](https://github.com/BoltzExchange/boltz-backend/commit/80a62d5d15573ff422c05b8ea29054997e0e27bd))
- interval and amount batch sweep trigger - ([12713b7](https://github.com/BoltzExchange/boltz-backend/commit/12713b7bb26e3aa5380d79960b1283ad39bd2b0b))

### Miscellaneous Chores

- bump LND v0.19.0-beta (#942) - ([bc2d15d](https://github.com/BoltzExchange/boltz-backend/commit/bc2d15d4f2c5ad3f22d7103f2628507f2b12252d))
- switch Bitcoin and Elements Core to rpcauth (#943) - ([729a77a](https://github.com/BoltzExchange/boltz-backend/commit/729a77a470c3c0cb4ca2cc9f46c54a0def0d05d8))
- bump version to v23.3.0 (#945) - ([bdc919f](https://github.com/BoltzExchange/boltz-backend/commit/bdc919fd907e32b6c69a3866446e5d37f9672091))
- remove cookie authentication from docker-scripts.sh (#947) - ([3442af6](https://github.com/BoltzExchange/boltz-backend/commit/3442af69883d1cb83d0d68f8e7ecdb52a9d79706))
- bump hold to v0.3.1 (#948) - ([f4ffc28](https://github.com/BoltzExchange/boltz-backend/commit/f4ffc284246536a70a798afd591a63db5972f5a6))
- update dependencies (#956) - ([7e2c0cd](https://github.com/BoltzExchange/boltz-backend/commit/7e2c0cd769a90660e8bef6844a0da13355304d3e))
- bump tar-fs from 2.1.2 to 2.1.3 (#957) - ([e837df0](https://github.com/BoltzExchange/boltz-backend/commit/e837df0dbd389028e5a3eb6ed60d7064e5d7bdc2))
- add extraFees to swagger doc (#962) - ([75c79fc](https://github.com/BoltzExchange/boltz-backend/commit/75c79fc8855b6a6748046c1a1c946c5c38f1c169))
- update LND to v0.19.1 (#968) - ([3072281](https://github.com/BoltzExchange/boltz-backend/commit/3072281bd2602c6f1852c8d4285551c5e18cccb4))
- bump CLTV limit delta (#970) - ([f54e5b6](https://github.com/BoltzExchange/boltz-backend/commit/f54e5b6162a77ac3f52d0b4c6d046fbd79eab04a))
- bump dependencies - ([d2d2cf0](https://github.com/BoltzExchange/boltz-backend/commit/d2d2cf0ac81d10f7111390f8f7b9f2360a03cff3))
- bump CLN version to v25.05 - ([3e0052d](https://github.com/BoltzExchange/boltz-backend/commit/3e0052d527a83dd575b9bd7266ef1929f15e235c))
- default boltz-cli API endpoint to mainnet (#978) - ([55e8abd](https://github.com/BoltzExchange/boltz-backend/commit/55e8abdd3c530d6c4beed3058bb89613505db69f))
- update regtest config file - ([3422f7e](https://github.com/BoltzExchange/boltz-backend/commit/3422f7e75c4d720a85d09e4c590e9ade669cea28))
- add HTLCs to self payment client - ([3701398](https://github.com/BoltzExchange/boltz-backend/commit/37013984f66134f2ccd59d3d1ce984dcd49fb06d))
- parse whole coin amounts in boltz-cli - ([f2e8cb1](https://github.com/BoltzExchange/boltz-backend/commit/f2e8cb1207a292d97993be8d3d166e962923708d))
- run prettier on docs - ([e259350](https://github.com/BoltzExchange/boltz-backend/commit/e2593504e39000228eb5969145cdb0e53fed272a))
- bump hold invoice plugin to v0.3.2 (#994) - ([cd892b7](https://github.com/BoltzExchange/boltz-backend/commit/cd892b759c8085255d803d7bfcfae39a52f48551))
- update dependencies (#996) - ([6fe0e5a](https://github.com/BoltzExchange/boltz-backend/commit/6fe0e5aa242065ce278eff5f2bcd79ef73dc2dc7))
- run MRH watcher only on Liquid (#1001) - ([daadf9f](https://github.com/BoltzExchange/boltz-backend/commit/daadf9f262e293c27952278a67cf97bc149a85cf))
- cleanup Transaction struct - ([6aefbce](https://github.com/BoltzExchange/boltz-backend/commit/6aefbce77cdca488e58c9e44766cc99dfdaba9ec))
- fix CI build cache for hold invoice plugin (#1005) - ([15475dd](https://github.com/BoltzExchange/boltz-backend/commit/15475dddaf9dc08cbbb373cb254b3cb67aeb3287))
- bump LND to v0.19.2 (#1012) - ([6411311](https://github.com/BoltzExchange/boltz-backend/commit/64113119c7342303d954c67f1e85323677187aa2))
- update dependencies (#1016) - ([b8cf450](https://github.com/BoltzExchange/boltz-backend/commit/b8cf450c553bcb1e22fe657eb7882875385b3de2))
- bump max supported contract version - ([7f15c57](https://github.com/BoltzExchange/boltz-backend/commit/7f15c57b7831f7382e37e0f212e487c026a1ace9))
- bump form-data from 4.0.0 to 4.0.4 (#1019) - ([aa7d326](https://github.com/BoltzExchange/boltz-backend/commit/aa7d3261d712229109bad7b5ae752d278eb6ab57))
- bump axios from 1.10.0 to 1.11.0 (#1021) - ([96343d5](https://github.com/BoltzExchange/boltz-backend/commit/96343d5eced7baf447be2ae3538a2c2d37e22067))
- apply suggestions from rabbit - ([30221da](https://github.com/BoltzExchange/boltz-backend/commit/30221da7f5e87734e03bed0cffd18e132025cb42))
- cleanup key extractor - ([54caa71](https://github.com/BoltzExchange/boltz-backend/commit/54caa715005753c7d60d9f1b20fd7c1005a83f04))
- validate OpenAPI spec in CI (#1029) - ([349f88f](https://github.com/BoltzExchange/boltz-backend/commit/349f88f377bd6e31bedaf695b042bf9603c784c4))
- update dependencies - ([8e377b7](https://github.com/BoltzExchange/boltz-backend/commit/8e377b7a3e9fd3e5e9326a1df03648ebe0fc726c))
- ignore tools for eslint and prettier - ([b266c2a](https://github.com/BoltzExchange/boltz-backend/commit/b266c2ab30bc8e18aa1f09129bb40bf4084f3a5c))
- fix Rust 1.89.0 compiler warnings - ([798b565](https://github.com/BoltzExchange/boltz-backend/commit/798b565e62adaab4caf8ee749065d12738da12c9))
- bump dependencies - ([7769616](https://github.com/BoltzExchange/boltz-backend/commit/7769616e9063932573ece30864edeebe708a8894))
- minor ZMQ cleanup (#1039) - ([b3bebb2](https://github.com/BoltzExchange/boltz-backend/commit/b3bebb2cc4f428b6ca3da9e049d38ae937b398a0))
- improve logging for offers - ([4c674e2](https://github.com/BoltzExchange/boltz-backend/commit/4c674e25f5762b7e88030fceb240664025cff2f7))
- fix typos - ([2d99b5c](https://github.com/BoltzExchange/boltz-backend/commit/2d99b5c162d783fed9cf6d61485b35806577b3f6))
- bump cipher-base from 1.0.4 to 1.0.6 (#1048) - ([0064483](https://github.com/BoltzExchange/boltz-backend/commit/0064483a92286d25472fb96404bfe46e5b085f1d))
- bump sha.js from 2.4.11 to 2.4.12 (#1049) - ([be745f5](https://github.com/BoltzExchange/boltz-backend/commit/be745f5abf31bb9d6c1764c481e7314f14b30d40))
- bump LND to v0.19.3 (#1050) - ([f77368c](https://github.com/BoltzExchange/boltz-backend/commit/f77368cf0ce5e6bb07e06a307cae3448333c9b20))
- update dependencies (#1051) - ([4b9ff63](https://github.com/BoltzExchange/boltz-backend/commit/4b9ff637037a3be133ee4a7aa40753cf2fb1c88a))
- update readme nostr link to Primal (#1053) - ([08a65dc](https://github.com/BoltzExchange/boltz-backend/commit/08a65dcfda76e590961e2496a4671cd17e661aac))
- bump tracing-subscriber from 0.3.19 to 0.3.20 (#1054) - ([fdd3860](https://github.com/BoltzExchange/boltz-backend/commit/fdd386049b483d0525b09aa6bf89e5b820eb0c0e))
- bump CLN to v25.09 (#1057) - ([8397c2d](https://github.com/BoltzExchange/boltz-backend/commit/8397c2dce08fed9283784ddaa48fa1f9f0fdc0e3))
- bump dependencies - ([4d90292](https://github.com/BoltzExchange/boltz-backend/commit/4d902923fe4d710f8b30429eca53e3a1b09ec81a))
- bump Bitcoin Core v29.1 (#1061) - ([5ef5a3b](https://github.com/BoltzExchange/boltz-backend/commit/5ef5a3b20d9ef84f9ccbbc63d025a2e326093e51))
- update NPM dependencies - ([ac0613c](https://github.com/BoltzExchange/boltz-backend/commit/ac0613ceddf0d7081d38717a180035429b426b4c))
- bump Rust dependencies - ([f7f7023](https://github.com/BoltzExchange/boltz-backend/commit/f7f70234ff8d2d9a65a9a27552ab84c122740e18))
- bump eclair image - ([9d37d88](https://github.com/BoltzExchange/boltz-backend/commit/9d37d888a561437275e68a4cda5d36342b3fc84c))
- optimize Docker images - ([4bc103c](https://github.com/BoltzExchange/boltz-backend/commit/4bc103cbd4b6d37f83bd87a92044d52bd0a792c7))
- bump vite from 5.4.19 to 5.4.20 (#1066) - ([0c26ce3](https://github.com/BoltzExchange/boltz-backend/commit/0c26ce30efa34603f0b50a9d8fed34d952b09637))
- address feedback RBF bumper review feedback - ([d97743d](https://github.com/BoltzExchange/boltz-backend/commit/d97743d54973a89e5fd8d2f0b5e29e7dbca14780))
- use str references in RPC client - ([bfaf106](https://github.com/BoltzExchange/boltz-backend/commit/bfaf1063aa0ac5f9eb1db641394740264e8d2cb2))
- bump dependencies - ([5267fc7](https://github.com/BoltzExchange/boltz-backend/commit/5267fc7a025e020b444360ca0a0e48e22bb4b2f7))
- update dependencies - ([0e26ccc](https://github.com/BoltzExchange/boltz-backend/commit/0e26cccf4d8a0845b23af98929ea8e109966acf5))
- throw for unsupported db version (#1075) - ([fd9deb0](https://github.com/BoltzExchange/boltz-backend/commit/fd9deb0a2a16ec9fc83fca54a6e540bdbb3dde67))
- switch unit tests to USDT0 (#1080) - ([f7936e2](https://github.com/BoltzExchange/boltz-backend/commit/f7936e2a0b65fdf311875743ebe6690aabdc5afe))
- bump tar-fs from 2.1.3 to 2.1.4 (#1079) - ([ebefc49](https://github.com/BoltzExchange/boltz-backend/commit/ebefc498068f11fa8de62a07a4c4858acd4f8c5c))
- add missing nginx config file (#1081) - ([80c4f27](https://github.com/BoltzExchange/boltz-backend/commit/80c4f27ad98c586bd20fc59535adaaf6a38f5b35))
- bump dependencies - ([1742004](https://github.com/BoltzExchange/boltz-backend/commit/17420044477243fae2801c1f2d3cdeed1b6ffbfd))
- bump Bitcoin Core to v30.0 (#1089) - ([a923b6c](https://github.com/BoltzExchange/boltz-backend/commit/a923b6c2bf39a14f59aa037aafd9d783d558d99c))
- bump dependencies - ([544f777](https://github.com/BoltzExchange/boltz-backend/commit/544f7772d58d806a00023bc5e74898b283776b5e))
- bump CLN to v25.09.1 (#1094) - ([6b757c0](https://github.com/BoltzExchange/boltz-backend/commit/6b757c0f55d35ccc9431b1a382c4e4fc6f70633e))
- skip logging bad-txns-inputs-missingorspent errors (#1095) - ([06f03d8](https://github.com/BoltzExchange/boltz-backend/commit/06f03d8790dfa2428a2b2a758705de3f77958cef))
- bump vite from 5.4.20 to 5.4.21 (#1097) - ([9fe5d57](https://github.com/BoltzExchange/boltz-backend/commit/9fe5d57972b8a00532f9562ace55cd725b7aa913))
- bump Eclair docker image version (#1100) - ([21cb99b](https://github.com/BoltzExchange/boltz-backend/commit/21cb99ba56bd82c71eb4a70c293857bb4c9ae618))
- bump validator from 13.9.0 to 13.15.20 (#1103) - ([ff26c2f](https://github.com/BoltzExchange/boltz-backend/commit/ff26c2f00af312dc46bd74cec8c6d507a6c5322b))
- add timeouts to sidecar node connections - ([6795e9d](https://github.com/BoltzExchange/boltz-backend/commit/6795e9d808d95505efa7c5a6f2d181cfbf2108df))
- update dependencies - ([4aa29ed](https://github.com/BoltzExchange/boltz-backend/commit/4aa29ed9f5c0e6df86749b40729cac2accf50ceb))
- bump CLN to v25.09.3 (#1114) - ([6b3b944](https://github.com/BoltzExchange/boltz-backend/commit/6b3b944e155c2826370a184078f6ec0dc5709359))
- update dependencies - ([071e297](https://github.com/BoltzExchange/boltz-backend/commit/071e2974e2ff5befe19636063f9f7b3c6107177e))
- bump js-yaml from 3.14.1 to 3.14.2 (#1119) - ([5582ea3](https://github.com/BoltzExchange/boltz-backend/commit/5582ea3a067b9e19befcde53f82e1769b33326a9))
- ignore errror when setting span parent (#1129) - ([c55b45b](https://github.com/BoltzExchange/boltz-backend/commit/c55b45bae203b63ac9767d26cb04de22aecb0356))
...
- extra percentage fee calculation (#959) - ([26f4706](https://github.com/BoltzExchange/boltz-backend/commit/26f4706ca5e524bac5d6a0fe71a870a7a8f87293))
- wait with timeout for nursery to settle self payment - ([91c80c8](https://github.com/BoltzExchange/boltz-backend/commit/91c80c863f0d200e07935cdc858319512ed50f77))
- cancel invoice when we accept self payment - ([9115b3a](https://github.com/BoltzExchange/boltz-backend/commit/9115b3a09196473a3f5663a7b6e10e992933f066))
- reverse hint schema (#963) - ([991f2b5](https://github.com/BoltzExchange/boltz-backend/commit/991f2b5cf76b2e318753d4d228c48d2adecea5ce))
- improve MRH watcher performance (#986) - ([e5b1246](https://github.com/BoltzExchange/boltz-backend/commit/e5b12466781c99774749b9f2778b489895c4a807))
- switch to vitepress - ([e45ba3f](https://github.com/BoltzExchange/boltz-backend/commit/e45ba3fd7ddcb57861cc61890c0a75ac2ac15908))
- swap restore endpoint (#1023) - ([8b153f9](https://github.com/BoltzExchange/boltz-backend/commit/8b153f92f8e81e23f6eb486b866c10b1e2703d50))
- use Docker regtest for bitcoin tx tests - ([36e1aba](https://github.com/BoltzExchange/boltz-backend/commit/36e1aba2c33e4c3497edba80040df0aff2340867))
- transaction input to enums - ([02af386](https://github.com/BoltzExchange/boltz-backend/commit/02af386be1a4ccea5fbdb912c7483776b7bc3998))
- harden ZMQ disconnection logic - ([bf5792d](https://github.com/BoltzExchange/boltz-backend/commit/bf5792d62ca9a87b0cf3aaa84868d3d2c3fca6e5))
- harden Rust ZMQ disconnection logic - ([8bd1efc](https://github.com/BoltzExchange/boltz-backend/commit/8bd1efc67c185d67ec866c447582a7c37255f186))
- check against max configured contract version (#1041) - ([859e5f6](https://github.com/BoltzExchange/boltz-backend/commit/859e5f6ee13c9cbdb2a09c9971d4b593bb42ee02))
- cleanup BOLT12 delete endpoint - ([85980fc](https://github.com/BoltzExchange/boltz-backend/commit/85980fc58970f74b7d7a23352fc1abdc95fddc97))
- backup provider names - ([c667dc6](https://github.com/BoltzExchange/boltz-backend/commit/c667dc60948a693f16a06eabd040c76d8844f109))
- async Mattermost command handler - ([4b12dd1](https://github.com/BoltzExchange/boltz-backend/commit/4b12dd1c172ad26bd102d963522212bbe57f6856))
- RBF bump refund transactions in Rust - ([c4b503c](https://github.com/BoltzExchange/boltz-backend/commit/c4b503ccbd0f12d9d100175a8f8cd821f5c06253))
- remove LND onchain wallet provider - ([3cb1eb1](https://github.com/BoltzExchange/boltz-backend/commit/3cb1eb11406b12910fa88e2ffb92078f3114f554))
- reuse output address for replaced refunds - ([55bf26e](https://github.com/BoltzExchange/boltz-backend/commit/55bf26e7699dd94fc38d60f3d03d74655b134d48))
- switch to docker compose regtest setup - ([0221960](https://github.com/BoltzExchange/boltz-backend/commit/0221960098c858f6bb8deaf355d67412e6994a9d))
- more verbose webhook error logging - ([eaf8298](https://github.com/BoltzExchange/boltz-backend/commit/eaf8298149d3f80a4d4cc1f456981b6fe4b5dac2))
- remove HTTP body from webhook error - ([3a93c25](https://github.com/BoltzExchange/boltz-backend/commit/3a93c25ca7ea9ffcd4bd23522c784c6b662c1549))
- deferred claimer interval trigger - ([57177ff](https://github.com/BoltzExchange/boltz-backend/commit/57177ffb8620c4122476a736f81c98f2ebf0af21))

### Tests

- RpcClient error tests - ([5f63db5](https://github.com/BoltzExchange/boltz-backend/commit/5f63db5f510c97b0bd67386b6a9e428cae6da6bc))
- Content-Type for webhook calls (#1101) - ([07dd22b](https://github.com/BoltzExchange/boltz-backend/commit/07dd22bab2c99980182f5f7b38be2147486ecebd))

---
## [3.11.0](https://github.com/BoltzExchange/boltz-backend/compare/v3.10.0..v3.11.0) - 2025-05-20

### Bug Fixes

- drop B-Tree indexes on invoices column of swaps (#872) - ([c86144f](https://github.com/BoltzExchange/boltz-backend/commit/c86144ff6ecd64f6313dfb7603c623d8aade8b61))
- tests broken by BOLT12 reverse swaps - ([6b741f4](https://github.com/BoltzExchange/boltz-backend/commit/6b741f4c5ae8afecda4a36fcf0e2c9d6aa4a5cd8))
- Docker build with new hold invoice plugin - ([9293318](https://github.com/BoltzExchange/boltz-backend/commit/929331888faf263e2861eff5533d46db2e73999d))
- missing status of chain swaps for mempool rescans (#873) - ([165df3f](https://github.com/BoltzExchange/boltz-backend/commit/165df3f06e02c627d5d871a8ce253bc3d6b61e2d))
- prevent webhook channel send when no subscribers exist (#889) - ([be45461](https://github.com/BoltzExchange/boltz-backend/commit/be454614e40fba9733f3551b1838c06bf67e30d3))
- magic routing hints for BOLT12 invoices (#904) - ([23b4c2c](https://github.com/BoltzExchange/boltz-backend/commit/23b4c2cfabe7c5947e6395ce06fe707a9fe225f7))
- GrpcServer test on MacOS (#914) - ([84a5674](https://github.com/BoltzExchange/boltz-backend/commit/84a5674ad1e16174d10369a58cd82a27d3704ef0))
- blinding key parsing in CLI (#923) - ([e4fa5b1](https://github.com/BoltzExchange/boltz-backend/commit/e4fa5b153090ec1340d5fb0af766f02b6de0ed6f))
- avoid blocking onion messages with webhook calls - ([ad72fb2](https://github.com/BoltzExchange/boltz-backend/commit/ad72fb289d927fe14d6e72febdd413d0a55d15d9))
- consistent data directory paths in EthereumUtils (#932) - ([23f05dd](https://github.com/BoltzExchange/boltz-backend/commit/23f05dddbb4e9ebe61b6c5b34cc3cf046841a2c6))
- events being sent twice for multiple WS connections (#930) - ([71f9306](https://github.com/BoltzExchange/boltz-backend/commit/71f9306f64f9acb357f2bd55c14546d39dff8b82))

### Documentation

- Swagger API spec for BOLT12 offer endpoints - ([fab56f4](https://github.com/BoltzExchange/boltz-backend/commit/fab56f4890932e728050750d6710050758627160))
- fix gitbook integration, make prettier ignore docs folder - ([0ed75d6](https://github.com/BoltzExchange/boltz-backend/commit/0ed75d68b7f51f496ead746df6bf92940f30f11f))
- #545 #685, minor rewording - ([a255e4c](https://github.com/BoltzExchange/boltz-backend/commit/a255e4c3b4a6ad33810221fa28a0b7ea3ed2d67d))
- BOLT12 invoice subscription WebSocket - ([3032015](https://github.com/BoltzExchange/boltz-backend/commit/30320151321c5440175710441ed18d7644f027bb))
- remove boltz-python from library section (#920) - ([debc497](https://github.com/BoltzExchange/boltz-backend/commit/debc4977a45536e5f7d86f2acf20775cb2d72b75))
- add Boltz Client to Pro docs (#936) - ([3a0e716](https://github.com/BoltzExchange/boltz-backend/commit/3a0e716a5f4ebe5e05c665e24221213ae931edb7))

### Features

- invoice timeout (#856) - ([dc0434c](https://github.com/BoltzExchange/boltz-backend/commit/dc0434c80f833e525b6d73ef2ea3df589bb00242))
- configurable LND gRPC SSL name override - ([0a22370](https://github.com/BoltzExchange/boltz-backend/commit/0a22370a195987aa8b10e385e96b63920fac732a))
- generic Webhook caller - ([a263a5a](https://github.com/BoltzExchange/boltz-backend/commit/a263a5aa2d82499f6b3294a1c82a93af306aa7d8))
- confirmation status in transaction endpoint (#869) - ([3710c9c](https://github.com/BoltzExchange/boltz-backend/commit/3710c9c04232e5511503f9c0cb85c74e813bff12))
- log failed HTTP requests in sidecar (#871) - ([2961f0c](https://github.com/BoltzExchange/boltz-backend/commit/2961f0c1ae23cd4eb470ac79c5b8a73d8e5b4d01))
- BOLT12 invoice request webhooks - ([954c739](https://github.com/BoltzExchange/boltz-backend/commit/954c73927ca55b7879a7e326a8dc3c89b3e48014))
- allow reverse swap creation with BOLT12 invoices - ([bc2f175](https://github.com/BoltzExchange/boltz-backend/commit/bc2f17585e59e828220fa7bc20591cf17f0d250a))
- magic routing hints support for bolt12 - ([25f1553](https://github.com/BoltzExchange/boltz-backend/commit/25f1553e7e1f788ac308e4d3c9d8cfc9ff4c8174))
- allow updating BOLT12 offer webhook URL - ([e59bc62](https://github.com/BoltzExchange/boltz-backend/commit/e59bc62781242cd3789e5a366787875bb144b205))
- check network of BOLT12 offers and invoices - ([a492ae4](https://github.com/BoltzExchange/boltz-backend/commit/a492ae412587ddf2947ebb3d2f7476f0a47c2415))
- BOLT12 fetch shortcut for registered offers - ([953776b](https://github.com/BoltzExchange/boltz-backend/commit/953776b89ad21805164da77fd1c84512bdfdb064))
- continue onion message hooks for unknown offers - ([018f870](https://github.com/BoltzExchange/boltz-backend/commit/018f8701ce44da65ff077cd7c26ae48ba1fa7dd8))
- allow empty reverse swap descriptions - ([59a825b](https://github.com/BoltzExchange/boltz-backend/commit/59a825bdbaee951e84e504317cf66df7e8b70b6b))
- batch only submarine swaps (#880) - ([0e3eb1f](https://github.com/BoltzExchange/boltz-backend/commit/0e3eb1ff3224a41f0427d83a1b1e8d23745430c2))
- add offer to invoice requests - ([2c8c856](https://github.com/BoltzExchange/boltz-backend/commit/2c8c85676b7c89b75e2181075ba8ab20c1a3eb61))
- endpoint to delete BOLT12 offers - ([0291937](https://github.com/BoltzExchange/boltz-backend/commit/0291937da8dadbcfa6cd9f4ad333761c6227722c))
- Email notifications for swaps (#893) - ([108f952](https://github.com/BoltzExchange/boltz-backend/commit/108f95235d4bd4302b0864ff6361b7a9126df344))
- Webhook IP safety checks (#902) - ([0924d72](https://github.com/BoltzExchange/boltz-backend/commit/0924d7291b1a2ec72033dbcaf555601132cdf6ec))
- transaction hook action hold - ([4a481f0](https://github.com/BoltzExchange/boltz-backend/commit/4a481f0a23074e28312ccf489497e1222fee088e))
- gRPC method to check transaction - ([b00600b](https://github.com/BoltzExchange/boltz-backend/commit/b00600bc7ec6c259626242df6f21145da7a8889f))
- BOLT12 invoice requests via WebSocket - ([89a9a16](https://github.com/BoltzExchange/boltz-backend/commit/89a9a16282b3aa2707ac2cc55918ca576850ef32))
- fuzzy search for lightning node alias (#908) - ([c82e4c9](https://github.com/BoltzExchange/boltz-backend/commit/c82e4c92d405272f20ce0e750ec891a0d60a57a0))
- allow removing url when updating offer (#909) - ([2f7fbc0](https://github.com/BoltzExchange/boltz-backend/commit/2f7fbc06562332d8706426fee714bd7cd9874496))
- add swap id to transaction hook (#913) - ([581e334](https://github.com/BoltzExchange/boltz-backend/commit/581e334930902135da3230c3ab6951297d50cef4))
- add swap type to transaction hook (#917) - ([b316f09](https://github.com/BoltzExchange/boltz-backend/commit/b316f092f4878ce88323cc77a49aff9104d24da0))
- submarine payment retry timeout (#918) - ([38facc3](https://github.com/BoltzExchange/boltz-backend/commit/38facc38759a08c4735701d42fba8cad080059b8))
- endpoint for lightning channel policies - ([eef814b](https://github.com/BoltzExchange/boltz-backend/commit/eef814b33adcee5b8f70dcab838b7e974378cd20))
- broadcast Elements transactions via all clients (#919) - ([c80e096](https://github.com/BoltzExchange/boltz-backend/commit/c80e096f5c493075320e8e1d5fb0288fe721d083))
- allow returning BOLT12 invoice errors (#921) - ([2c34a12](https://github.com/BoltzExchange/boltz-backend/commit/2c34a12169442096942dd2e7b82a8eb117388305))
- return MRH in BOLT12 fetch response (#922) - ([fd8a287](https://github.com/BoltzExchange/boltz-backend/commit/fd8a287080fb4306a0daa1fc9e62b793090a1d76))
- dynamic CLN invoice thresholds - ([82a8119](https://github.com/BoltzExchange/boltz-backend/commit/82a8119d77da76f90cdde189f6d383f6acfe3f95))
- metrics for CLN invoice thresholds (#927) - ([6ba3ddf](https://github.com/BoltzExchange/boltz-backend/commit/6ba3ddf22a1b4fb485dc8d39522004ecda672b2f))
- invoice payment hook (#925) - ([1433ada](https://github.com/BoltzExchange/boltz-backend/commit/1433ada88d87d183ee6ccbe31dd5cdcbca2ec0aa))
- allow BOLT12 invoice request payer notes - ([d53bf3d](https://github.com/BoltzExchange/boltz-backend/commit/d53bf3d3f692381879c766c5113f159ad5ef62f4))

### Miscellaneous Chores

- Rust release builds in c-lightning image (#855) - ([0e52eac](https://github.com/BoltzExchange/boltz-backend/commit/0e52eacaee9a56400d494e392bbb4cded25843f2))
- fix open handles in unit tests - ([1b3e9b3](https://github.com/BoltzExchange/boltz-backend/commit/1b3e9b33c1eb1b283bcefa53c767bdea676bad58))
- bump dependencies - ([6267256](https://github.com/BoltzExchange/boltz-backend/commit/6267256dbade5b684fe8c2abbf91e57959463f21))
- include confirmation in transaction hook (#863) - ([7e32d06](https://github.com/BoltzExchange/boltz-backend/commit/7e32d0680f23fdbbcc5db4d78176ab3dfcbe87f6))
- bump tar-fs from 2.1.1 to 2.1.2 (#867) - ([be23915](https://github.com/BoltzExchange/boltz-backend/commit/be23915a895b5e10837636a08eb81838b8b5fb6f))
- bump Ubuntu version of Docker images (#866) - ([c01a2e0](https://github.com/BoltzExchange/boltz-backend/commit/c01a2e0a6d12f6dd78ebaaedac85a1cd16d99782))
- include ca-certificates in CLN image - ([792195d](https://github.com/BoltzExchange/boltz-backend/commit/792195d4fcd6a923bc7ff1d63ea790ababa4b8f9))
- update dependencies (#870) - ([af95b03](https://github.com/BoltzExchange/boltz-backend/commit/af95b034eee986c683d302bb4853b56d272d3aae))
- minor cleanup - ([41014fe](https://github.com/BoltzExchange/boltz-backend/commit/41014fe7cd1da065d6f86fd982fdf08513276f9b))
- update hold invoice plugin - ([28c6ea3](https://github.com/BoltzExchange/boltz-backend/commit/28c6ea3168abdbee9a62bc326256969e68e3d913))
- switch to upstream lightning dependency - ([fd5d553](https://github.com/BoltzExchange/boltz-backend/commit/fd5d55380ef626d8575d812d102c68abdf99c0e4))
- bump max invoice description length to 500 (#876) - ([06966c4](https://github.com/BoltzExchange/boltz-backend/commit/06966c4850fe8f1b34c01804d2f34d8f61d3850e))
- bump elements to v23.2.7 (#878) - ([ed58cb3](https://github.com/BoltzExchange/boltz-backend/commit/ed58cb3a3c5842348ad9ded5ba923b98540c0ff3))
- bump ecpair and boltz-core to v3 - ([f32d6bc](https://github.com/BoltzExchange/boltz-backend/commit/f32d6bc4aaa358821e8cc6235b456c76c478768f))
- eslint rule for type imports - ([d99ad49](https://github.com/BoltzExchange/boltz-backend/commit/d99ad49092d5187e4c4bb0b3efdd244ef4a06b80))
- add signet support (#874) - ([2f412ac](https://github.com/BoltzExchange/boltz-backend/commit/2f412ac7f1859c69cf6495d136eb8eeceff635ca))
- bump openssl from 0.10.70 to 0.10.72 in /boltzr (#881) - ([6b8d9a8](https://github.com/BoltzExchange/boltz-backend/commit/6b8d9a8e9d5459f6eafc0e19927f2ef543b47822))
- bump CLN to v25.02.1 (#883) - ([46c3768](https://github.com/BoltzExchange/boltz-backend/commit/46c3768a3a17e377492ce919647a69f621483312))
- add minimalBatched to swagger (#884) - ([fe06c67](https://github.com/BoltzExchange/boltz-backend/commit/fe06c67def7bf234ba24d21a21aadea4c736437a))
- bump tokio from 1.44.1 to 1.44.2 in /boltzr (#887) - ([dc0ef38](https://github.com/BoltzExchange/boltz-backend/commit/dc0ef387cf7adfe4c6765ced1ce63503f4addf9c))
- update Anvil Docker image (#896) - ([8fcada5](https://github.com/BoltzExchange/boltz-backend/commit/8fcada53238b63797098cc5cdad9922989a54a7b))
- bump crossbeam-channel from 0.5.14 to 0.5.15 in /boltzr (#894) - ([2d0191d](https://github.com/BoltzExchange/boltz-backend/commit/2d0191d27d3fd1e76cff0a2dfe7053af01052d39))
- bump Bitcoin Core to v29.0 (#903) - ([fff8e34](https://github.com/BoltzExchange/boltz-backend/commit/fff8e34c416fe387a065858584b89153379fb294))
- update Rust dependencies - ([7030292](https://github.com/BoltzExchange/boltz-backend/commit/703029227c9378245074ef70c095b7bd6521ce3e))
- bump alloy dependency - ([66c5c89](https://github.com/BoltzExchange/boltz-backend/commit/66c5c898d1fdc513015c841fa1767bba5cd2ea22))
- improve sidecar HTTP error logging - ([9621a05](https://github.com/BoltzExchange/boltz-backend/commit/9621a0582188d62e0382793d9b1b536cafc5fd00))
- bump dependencies - ([eb77ad7](https://github.com/BoltzExchange/boltz-backend/commit/eb77ad73dfe945b2bf84e2365b919ab53df492ba))
- resolve hooks with accept when not connected - ([33aed50](https://github.com/BoltzExchange/boltz-backend/commit/33aed50d9c690dc68242845b06580df3987775c8))
- correct condition for hook rejection log - ([2722d1f](https://github.com/BoltzExchange/boltz-backend/commit/2722d1f5d784fcfe6ddfcf2370cf60b6830fcd8f))
- inline format args - ([21e0975](https://github.com/BoltzExchange/boltz-backend/commit/21e0975b4d2fb2db25917e1fff543f49d657b6ee))
- bump BOLT12 hook timeout (#911) - ([fe90f14](https://github.com/BoltzExchange/boltz-backend/commit/fe90f14e08bf0965b2aa51558baba7562faa051a))
- build hold in a container for non-Linux hosts (#916) - ([f1f5810](https://github.com/BoltzExchange/boltz-backend/commit/f1f5810561844a7b4de7bfa353a61e608bf3e627))
- bump dependencies - ([25aef77](https://github.com/BoltzExchange/boltz-backend/commit/25aef7714edf37ed42b44e17b36cbb28b683b417))
- bump base-x dependency - ([45a08af](https://github.com/BoltzExchange/boltz-backend/commit/45a08afccd060938194dff13d5b50751c46b6676))
- bump dependencies - ([ab8ce6d](https://github.com/BoltzExchange/boltz-backend/commit/ab8ce6db59bffc712ad0846e85854b690d1531ff))
- remove Rust Nightly from CI (#935) - ([216dd4c](https://github.com/BoltzExchange/boltz-backend/commit/216dd4c04c420b37fe826f59dcd72f57d217e3d0))
- bump dependencies - ([22ed16e](https://github.com/BoltzExchange/boltz-backend/commit/22ed16e6b669c8a3a7cc752adff4bdacf347e9ee))
- bump version to v3.11.0 (#939) - ([9dbb7bc](https://github.com/BoltzExchange/boltz-backend/commit/9dbb7bc9de6614757701b06970f5e8e47a8de201))

### Refactoring

- transaction hooks (#862) - ([811c197](https://github.com/BoltzExchange/boltz-backend/commit/811c1977450c4fc1d67e84ca9696d38774af4d04))
- cache entire lightning gossip (#868) - ([3eaa6a5](https://github.com/BoltzExchange/boltz-backend/commit/3eaa6a547a92d5344e58fde6b6711fa2a24420c9))
- allow HTTP webhooks on regtest - ([1a1402a](https://github.com/BoltzExchange/boltz-backend/commit/1a1402a05998ac59e4bb3d9e4dde95f7feabad80))
- allow reading IP ranges from files (#886) - ([a6652b6](https://github.com/BoltzExchange/boltz-backend/commit/a6652b6fb99621426b08c1fb2f634dd633f3e800))
- put lightning data in sets - ([c0a1f6c](https://github.com/BoltzExchange/boltz-backend/commit/c0a1f6c54f466a68abd2939250bd3e08405241c8))

### Tests

- added functionality for BOLT12 reverse swaps - ([4697df1](https://github.com/BoltzExchange/boltz-backend/commit/4697df11d8e91d601893ab8d6014b1f67c0778aa))
...
- bump version to v3.10.0 - ([5171f2e](https://github.com/BoltzExchange/boltz-backend/commit/5171f2e7ad0159471d08b2c222fbaaa9a15e6d44))
