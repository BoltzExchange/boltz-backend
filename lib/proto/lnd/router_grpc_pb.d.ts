...
interface IRouterService_ISendPaymentV2
  extends grpc.MethodDefinition<
    lnd_router_pb.SendPaymentRequest,
    lnd_rpc_pb.Payment
  > {
...
interface IRouterService_ITrackPaymentV2
  extends grpc.MethodDefinition<
...
interface IRouterService_IEstimateRouteFee
  extends grpc.MethodDefinition<
...
interface IRouterService_ISendToRoute
  extends grpc.MethodDefinition<
    lnd_router_pb.SendToRouteRequest,
    lnd_router_pb.SendToRouteResponse
  > {
...
interface IRouterService_ISendToRouteV2
  extends grpc.MethodDefinition<
    lnd_router_pb.SendToRouteRequest,
    lnd_rpc_pb.HTLCAttempt
  > {
...
interface IRouterService_IResetMissionControl
  extends grpc.MethodDefinition<
    lnd_router_pb.ResetMissionControlRequest,
    lnd_router_pb.ResetMissionControlResponse
  > {
...
interface IRouterService_IQueryMissionControl
  extends grpc.MethodDefinition<
    lnd_router_pb.QueryMissionControlRequest,
    lnd_router_pb.QueryMissionControlResponse
  > {
...
interface IRouterService_IXImportMissionControl
  extends grpc.MethodDefinition<
    lnd_router_pb.XImportMissionControlRequest,
    lnd_router_pb.XImportMissionControlResponse
  > {
...
interface IRouterService_IGetMissionControlConfig
  extends grpc.MethodDefinition<
    lnd_router_pb.GetMissionControlConfigRequest,
    lnd_router_pb.GetMissionControlConfigResponse
  > {
...
interface IRouterService_ISetMissionControlConfig
  extends grpc.MethodDefinition<
    lnd_router_pb.SetMissionControlConfigRequest,
    lnd_router_pb.SetMissionControlConfigResponse
  > {
...
interface IRouterService_IQueryProbability
  extends grpc.MethodDefinition<
    lnd_router_pb.QueryProbabilityRequest,
    lnd_router_pb.QueryProbabilityResponse
  > {
...
interface IRouterService_IBuildRoute
  extends grpc.MethodDefinition<
    lnd_router_pb.BuildRouteRequest,
    lnd_router_pb.BuildRouteResponse
  > {
...
interface IRouterService_ISubscribeHtlcEvents
  extends grpc.MethodDefinition<
    lnd_router_pb.SubscribeHtlcEventsRequest,
    lnd_router_pb.HtlcEvent
  > {
...
interface IRouterService_ISendPayment
  extends grpc.MethodDefinition<
    lnd_router_pb.SendPaymentRequest,
    lnd_router_pb.PaymentStatus
  > {
...
interface IRouterService_ITrackPayment
  extends grpc.MethodDefinition<
    lnd_router_pb.TrackPaymentRequest,
    lnd_router_pb.PaymentStatus
  > {
...
interface IRouterService_IHtlcInterceptor
  extends grpc.MethodDefinition<
...
interface IRouterService_IUpdateChanStatus
  extends grpc.MethodDefinition<
    lnd_router_pb.UpdateChanStatusRequest,
    lnd_router_pb.UpdateChanStatusResponse
  > {
...
export interface IRouterClient {
  sendPaymentV2(
    request: lnd_router_pb.SendPaymentRequest,
  ...
  estimateRouteFee(
    ...
    callback: (
      ...
      response: lnd_router_pb.RouteFeeResponse,
    ) => void,
  ...
  sendToRoute(
    request: lnd_router_pb.SendToRouteRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: lnd_router_pb.SendToRouteResponse,
    ) => void,
  ): grpc.ClientUnaryCall;
  sendToRoute(
    request: lnd_router_pb.SendToRouteRequest,
  ...
  sendToRouteV2(
    ...
    callback: (
      error: grpc.ServiceError | null,
      response: lnd_rpc_pb.HTLCAttempt,
    ) => void,
  ): grpc.ClientUnaryCall;
  sendToRouteV2(
    request: lnd_router_pb.SendToRouteRequest,
  ...
  resetMissionControl(
    request: lnd_router_pb.ResetMissionControlRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: lnd_router_pb.ResetMissionControlResponse,
    ) => void,
  ): grpc.ClientUnaryCall;
  resetMissionControl(
    request: lnd_router_pb.ResetMissionControlRequest,
  ...
  queryMissionControl(
    request: lnd_router_pb.QueryMissionControlRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: lnd_router_pb.QueryMissionControlResponse,
    ) => void,
  ): grpc.ClientUnaryCall;
  queryMissionControl(
    request: lnd_router_pb.QueryMissionControlRequest,
  ...
  xImportMissionControl(
    request: lnd_router_pb.XImportMissionControlRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: lnd_router_pb.XImportMissionControlResponse,
    ) => void,
  ): grpc.ClientUnaryCall;
  xImportMissionControl(
    request: lnd_router_pb.XImportMissionControlRequest,
  ...
  getMissionControlConfig(
    request: lnd_router_pb.GetMissionControlConfigRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: lnd_router_pb.GetMissionControlConfigResponse,
    ) => void,
  ): grpc.ClientUnaryCall;
  getMissionControlConfig(
    request: lnd_router_pb.GetMissionControlConfigRequest,
  ...
  setMissionControlConfig(
    request: lnd_router_pb.SetMissionControlConfigRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: lnd_router_pb.SetMissionControlConfigResponse,
    ) => void,
  ): grpc.ClientUnaryCall;
  setMissionControlConfig(
    request: lnd_router_pb.SetMissionControlConfigRequest,
  ...
  queryProbability(
    request: lnd_router_pb.QueryProbabilityRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: lnd_router_pb.QueryProbabilityResponse,
    ) => void,
  ): grpc.ClientUnaryCall;
  queryProbability(
    request: lnd_router_pb.QueryProbabilityRequest,
  ...
  buildRoute(
    request: lnd_router_pb.BuildRouteRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: lnd_router_pb.BuildRouteResponse,
    ) => void,
  ): grpc.ClientUnaryCall;
  buildRoute(
    request: lnd_router_pb.BuildRouteRequest,
  ...
  subscribeHtlcEvents(
    request: lnd_router_pb.SubscribeHtlcEventsRequest,
    options?: Partial<grpc.CallOptions>,
  ): grpc.ClientReadableStream<lnd_router_pb.HtlcEvent>;
  subscribeHtlcEvents(
    request: lnd_router_pb.SubscribeHtlcEventsRequest,
    metadata?: grpc.Metadata,
    options?: Partial<grpc.CallOptions>,
  ...
  sendPayment(
    request: lnd_router_pb.SendPaymentRequest,
    options?: Partial<grpc.CallOptions>,
  ): grpc.ClientReadableStream<lnd_router_pb.PaymentStatus>;
  sendPayment(
    request: lnd_router_pb.SendPaymentRequest,
    metadata?: grpc.Metadata,
    options?: Partial<grpc.CallOptions>,
  ...
  >;
  updateChanStatus(
    request: lnd_router_pb.UpdateChanStatusRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: lnd_router_pb.UpdateChanStatusResponse,
    ) => void,
  ): grpc.ClientUnaryCall;
  updateChanStatus(
    request: lnd_router_pb.UpdateChanStatusRequest,
