...
function serialize_boltzrpc_SubscribeSwapEventsRequest(arg) {
  if (!(arg instanceof boltzrpc_pb.SubscribeSwapEventsRequest)) {
    throw new Error('Expected argument of type boltzrpc.SubscribeSwapEventsRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_boltzrpc_SubscribeSwapEventsRequest(buffer_arg) {
  return boltzrpc_pb.SubscribeSwapEventsRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_boltzrpc_SubscribeSwapEventsResponse(arg) {
  if (!(arg instanceof boltzrpc_pb.SubscribeSwapEventsResponse)) {
    throw new Error('Expected argument of type boltzrpc.SubscribeSwapEventsResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_boltzrpc_SubscribeSwapEventsResponse(buffer_arg) {
  return boltzrpc_pb.SubscribeSwapEventsResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var BoltzService = exports.BoltzService = {
  ...
  subscribeSwapEvents: {
    path: '/boltzrpc.Boltz/SubscribeSwapEvents',
    requestStream: false,
    responseStream: true,
    requestType: boltzrpc_pb.SubscribeSwapEventsRequest,
    ...
    responseSerialize: serialize_boltzrpc_SubscribeSwapEventsResponse,
