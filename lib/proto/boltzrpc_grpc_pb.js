...
function serialize_boltzrpc_SubscribeClaimsRequest(arg) {
  if (!(arg instanceof boltzrpc_pb.SubscribeClaimsRequest)) {
    throw new Error('Expected argument of type boltzrpc.SubscribeClaimsRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_boltzrpc_SubscribeClaimsRequest(buffer_arg) {
  return boltzrpc_pb.SubscribeClaimsRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_boltzrpc_SubscribeClaimsResponse(arg) {
  if (!(arg instanceof boltzrpc_pb.SubscribeClaimsResponse)) {
    throw new Error('Expected argument of type boltzrpc.SubscribeClaimsResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_boltzrpc_SubscribeClaimsResponse(buffer_arg) {
  return boltzrpc_pb.SubscribeClaimsResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var BoltzService = exports.BoltzService = {
  ...
  subscribeClaims: {
    path: '/boltzrpc.Boltz/SubscribeClaims',
    requestStream: false,
    responseStream: true,
    requestType: boltzrpc_pb.SubscribeClaimsRequest,
    responseType: boltzrpc_pb.SubscribeClaimsResponse,
    requestSerialize: serialize_boltzrpc_SubscribeClaimsRequest,
    requestDeserialize: deserialize_boltzrpc_SubscribeClaimsRequest,
    responseSerialize: serialize_boltzrpc_SubscribeClaimsResponse,
    responseDeserialize: deserialize_boltzrpc_SubscribeClaimsResponse,
  },
