...
function serialize_boltzr_CheckTransactionRequest(arg) {
  if (!(arg instanceof boltzr_pb.CheckTransactionRequest)) {
    throw new Error('Expected argument of type boltzr.CheckTransactionRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_boltzr_CheckTransactionRequest(buffer_arg) {
  return boltzr_pb.CheckTransactionRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_boltzr_CheckTransactionResponse(arg) {
  if (!(arg instanceof boltzr_pb.CheckTransactionResponse)) {
    throw new Error('Expected argument of type boltzr.CheckTransactionResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_boltzr_CheckTransactionResponse(buffer_arg) {
  return boltzr_pb.CheckTransactionResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_boltzr_EstimateFeeRequest(arg) {
  if (!(arg instanceof boltzr_pb.EstimateFeeRequest)) {
    throw new Error('Expected argument of type boltzr.EstimateFeeRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_boltzr_EstimateFeeRequest(buffer_arg) {
  return boltzr_pb.EstimateFeeRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_boltzr_EstimateFeeResponse(arg) {
  if (!(arg instanceof boltzr_pb.EstimateFeeResponse)) {
    throw new Error('Expected argument of type boltzr.EstimateFeeResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_boltzr_EstimateFeeResponse(buffer_arg) {
  return boltzr_pb.EstimateFeeResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var BoltzRService = exports.BoltzRService = {
  ...
  checkTransaction: {
    path: '/boltzr.BoltzR/CheckTransaction',
    requestStream: false,
    responseStream: false,
    requestType: boltzr_pb.CheckTransactionRequest,
    responseType: boltzr_pb.CheckTransactionResponse,
    requestSerialize: serialize_boltzr_CheckTransactionRequest,
    requestDeserialize: deserialize_boltzr_CheckTransactionRequest,
    responseSerialize: serialize_boltzr_CheckTransactionResponse,
    responseDeserialize: deserialize_boltzr_CheckTransactionResponse,
  },
  estimateFee: {
    path: '/boltzr.BoltzR/EstimateFee',
    requestStream: false,
    responseStream: false,
    requestType: boltzr_pb.EstimateFeeRequest,
    responseType: boltzr_pb.EstimateFeeResponse,
    requestSerialize: serialize_boltzr_EstimateFeeRequest,
    requestDeserialize: deserialize_boltzr_EstimateFeeRequest,
    responseSerialize: serialize_boltzr_EstimateFeeResponse,
    responseDeserialize: deserialize_boltzr_EstimateFeeResponse,
  },
  blockAdded: {
