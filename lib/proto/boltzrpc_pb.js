...
goog.exportSymbol('proto.boltzrpc.ReverseSwap', null, global);
goog.exportSymbol('proto.boltzrpc.ReverseSwaps', null, global);
 ...
 * @constructor
 */
proto.boltzrpc.ReverseSwap = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.boltzrpc.ReverseSwap, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.boltzrpc.ReverseSwap.displayName = 'proto.boltzrpc.ReverseSwap';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.boltzrpc.ReverseSwaps = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.boltzrpc.ReverseSwaps.repeatedFields_, null);
};
goog.inherits(proto.boltzrpc.ReverseSwaps, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.boltzrpc.ReverseSwaps.displayName = 'proto.boltzrpc.ReverseSwaps';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.boltzrpc.ReverseSwap.prototype.toObject = function(opt_includeInstance) {
  return proto.boltzrpc.ReverseSwap.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.boltzrpc.ReverseSwap} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.ReverseSwap.toObject = function(includeInstance, msg) {
  var f, obj = {
    id: jspb.Message.getFieldWithDefault(msg, 1, ""),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.boltzrpc.ReverseSwap}
 */
proto.boltzrpc.ReverseSwap.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.boltzrpc.ReverseSwap;
  return proto.boltzrpc.ReverseSwap.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.boltzrpc.ReverseSwap} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.boltzrpc.ReverseSwap}
 */
proto.boltzrpc.ReverseSwap.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.boltzrpc.ReverseSwap.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.boltzrpc.ReverseSwap.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.boltzrpc.ReverseSwap} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.ReverseSwap.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getId();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.boltzrpc.ReverseSwap.prototype.getId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.boltzrpc.ReverseSwap} returns this
 */
proto.boltzrpc.ReverseSwap.prototype.setId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {number}
 */
proto.boltzrpc.ReverseSwap.prototype.getOnchainAmount = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.boltzrpc.ReverseSwap} returns this
 */
proto.boltzrpc.ReverseSwap.prototype.setOnchainAmount = function(value) {
  return jspb.Message.setProto3IntField(this, 2, value);
};
 ...
 * @const
 */
proto.boltzrpc.ReverseSwaps.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.boltzrpc.ReverseSwaps.prototype.toObject = function(opt_includeInstance) {
  return proto.boltzrpc.ReverseSwaps.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.boltzrpc.ReverseSwaps} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.ReverseSwaps.toObject = function(includeInstance, msg) {
  var f, obj = {
    reverseSwapsList: jspb.Message.toObjectList(msg.getReverseSwapsList(),
    proto.boltzrpc.ReverseSwap.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.boltzrpc.ReverseSwaps}
 */
proto.boltzrpc.ReverseSwaps.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.boltzrpc.ReverseSwaps;
  return proto.boltzrpc.ReverseSwaps.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.boltzrpc.ReverseSwaps} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.boltzrpc.ReverseSwaps}
 */
proto.boltzrpc.ReverseSwaps.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new proto.boltzrpc.ReverseSwap;
      reader.readMessage(value,proto.boltzrpc.ReverseSwap.deserializeBinaryFromReader);
 ...
 * @return {!Uint8Array}
 */
proto.boltzrpc.ReverseSwaps.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.boltzrpc.ReverseSwaps.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.boltzrpc.ReverseSwaps} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.ReverseSwaps.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.boltzrpc.ReverseSwap.serializeBinaryToWriter
    );
  }
};
...
/**
 * repeated ReverseSwap reverse_swaps = 1;
 * @return {!Array<!proto.boltzrpc.ReverseSwap>}
 */
proto.boltzrpc.ReverseSwaps.prototype.getReverseSwapsList = function() {
  return /** @type{!Array<!proto.boltzrpc.ReverseSwap>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.boltzrpc.ReverseSwap, 1));
};


/**
 * @param {!Array<!proto.boltzrpc.ReverseSwap>} value
 * @return {!proto.boltzrpc.ReverseSwaps} returns this
*/
proto.boltzrpc.ReverseSwaps.prototype.setReverseSwapsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};


/**
 * @param {!proto.boltzrpc.ReverseSwap=} opt_value
 * @param {number=} opt_index
 * @return {!proto.boltzrpc.ReverseSwap}
 */
proto.boltzrpc.ReverseSwaps.prototype.addReverseSwaps = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.boltzrpc.ReverseSwap, opt_index);
};
 ...
 * @return {!proto.boltzrpc.ReverseSwaps} returns this
 */
proto.boltzrpc.ReverseSwaps.prototype.clearReverseSwapsList = function() {
...
proto.boltzrpc.GetLockedFundsResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    lockedFundsMap: (f = msg.getLockedFundsMap()) ? f.toObject(includeInstance, proto.boltzrpc.ReverseSwaps.toObject) : []
  };
...
proto.boltzrpc.GetLockedFundsResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      reader.readMessage(value, function(message, reader) {
        jspb.Map.deserializeBinary(message, reader, jspb.BinaryReader.prototype.readString, jspb.BinaryReader.prototype.readMessage, proto.boltzrpc.ReverseSwaps.deserializeBinaryFromReader, "", new proto.boltzrpc.ReverseSwaps());
         });
      break;
    default:
      reader.skipField();
...
proto.boltzrpc.GetLockedFundsResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f && f.getLength() > 0) {
    f.serializeBinary(1, writer, jspb.BinaryWriter.prototype.writeString, jspb.BinaryWriter.prototype.writeMessage, proto.boltzrpc.ReverseSwaps.serializeBinaryToWriter);
  }
};


/**
 * map<string, ReverseSwaps> locked_funds = 1;
 * @param {boolean=} opt_noLazyCreate Do not create the map if
 * empty, instead returning `undefined`
 * @return {!jspb.Map<string,!proto.boltzrpc.ReverseSwaps>}
 */
proto.boltzrpc.GetLockedFundsResponse.prototype.getLockedFundsMap = function(opt_noLazyCreate) {
  return /** @type {!jspb.Map<string,!proto.boltzrpc.ReverseSwaps>} */ (
      jspb.Message.getMapField(this, 1, opt_noLazyCreate,
      proto.boltzrpc.ReverseSwaps));
};
