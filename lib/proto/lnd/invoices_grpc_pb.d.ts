...
interface IInvoicesService_ISubscribeSingleInvoice
  extends grpc.MethodDefinition<
    lnd_invoices_pb.SubscribeSingleInvoiceRequest,
    lnd_rpc_pb.Invoice
  > {
...
interface IInvoicesService_ICancelInvoice
  extends grpc.MethodDefinition<
    lnd_invoices_pb.CancelInvoiceMsg,
    lnd_invoices_pb.CancelInvoiceResp
  > {
...
interface IInvoicesService_IAddHoldInvoice
  extends grpc.MethodDefinition<
    lnd_invoices_pb.AddHoldInvoiceRequest,
    lnd_invoices_pb.AddHoldInvoiceResp
  > {
...
interface IInvoicesService_ISettleInvoice
  extends grpc.MethodDefinition<
...
export interface IInvoicesServer extends grpc.UntypedServiceImplementation {
  subscribeSingleInvoice: grpc.handleServerStreamingCall<
    lnd_invoices_pb.SubscribeSingleInvoiceRequest,
    lnd_rpc_pb.Invoice
  >;
  cancelInvoice: grpc.handleUnaryCall<
    lnd_invoices_pb.CancelInvoiceMsg,
    lnd_invoices_pb.CancelInvoiceResp
  >;
  addHoldInvoice: grpc.handleUnaryCall<
    lnd_invoices_pb.AddHoldInvoiceRequest,
    lnd_invoices_pb.AddHoldInvoiceResp
  >;
...
export interface IInvoicesClient {
  subscribeSingleInvoice(
    request: lnd_invoices_pb.SubscribeSingleInvoiceRequest,
  ...
  cancelInvoice(
    request: lnd_invoices_pb.CancelInvoiceMsg,
    callback: (
      error: grpc.ServiceError | null,
      response: lnd_invoices_pb.CancelInvoiceResp,
    ) => void,
  ...
  addHoldInvoice(
    request: lnd_invoices_pb.AddHoldInvoiceRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: lnd_invoices_pb.AddHoldInvoiceResp,
    ) => void,
  ): grpc.ClientUnaryCall;
  addHoldInvoice(
    request: lnd_invoices_pb.AddHoldInvoiceRequest,
  ...
  settleInvoice(
    request: lnd_invoices_pb.SettleInvoiceMsg,
    callback: (
      error: grpc.ServiceError | null,
