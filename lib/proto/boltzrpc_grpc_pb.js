...
function serialize_boltzrpc_CheckTransactionRequest(arg) {
  if (!(arg instanceof boltzrpc_pb.CheckTransactionRequest)) {
    throw new Error('Expected argument of type boltzrpc.CheckTransactionRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_boltzrpc_CheckTransactionRequest(buffer_arg) {
  return boltzrpc_pb.CheckTransactionRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_boltzrpc_CheckTransactionResponse(arg) {
  if (!(arg instanceof boltzrpc_pb.CheckTransactionResponse)) {
    throw new Error('Expected argument of type boltzrpc.CheckTransactionResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_boltzrpc_CheckTransactionResponse(buffer_arg) {
  return boltzrpc_pb.CheckTransactionResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_boltzrpc_DevClearSwapUpdateCacheRequest(arg) {
  if (!(arg instanceof boltzrpc_pb.DevClearSwapUpdateCacheRequest)) {
    throw new Error('Expected argument of type boltzrpc.DevClearSwapUpdateCacheRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_boltzrpc_DevClearSwapUpdateCacheRequest(buffer_arg) {
  return boltzrpc_pb.DevClearSwapUpdateCacheRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_boltzrpc_DevClearSwapUpdateCacheResponse(arg) {
  if (!(arg instanceof boltzrpc_pb.DevClearSwapUpdateCacheResponse)) {
    throw new Error('Expected argument of type boltzrpc.DevClearSwapUpdateCacheResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_boltzrpc_DevClearSwapUpdateCacheResponse(buffer_arg) {
  return boltzrpc_pb.DevClearSwapUpdateCacheResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_boltzrpc_DisableSignersRequest(arg) {
  if (!(arg instanceof boltzrpc_pb.DisableSignersRequest)) {
    throw new Error('Expected argument of type boltzrpc.DisableSignersRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_boltzrpc_DisableSignersRequest(buffer_arg) {
  return boltzrpc_pb.DisableSignersRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_boltzrpc_DisableSignersResponse(arg) {
  if (!(arg instanceof boltzrpc_pb.DisableSignersResponse)) {
    throw new Error('Expected argument of type boltzrpc.DisableSignersResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_boltzrpc_DisableSignersResponse(buffer_arg) {
  return boltzrpc_pb.DisableSignersResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_boltzrpc_EnableSignersRequest(arg) {
  if (!(arg instanceof boltzrpc_pb.EnableSignersRequest)) {
    throw new Error('Expected argument of type boltzrpc.EnableSignersRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_boltzrpc_EnableSignersRequest(buffer_arg) {
  return boltzrpc_pb.EnableSignersRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_boltzrpc_EnableSignersResponse(arg) {
  if (!(arg instanceof boltzrpc_pb.EnableSignersResponse)) {
    throw new Error('Expected argument of type boltzrpc.EnableSignersResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_boltzrpc_EnableSignersResponse(buffer_arg) {
  return boltzrpc_pb.EnableSignersResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_boltzrpc_GetDisabledSignersRequest(arg) {
  if (!(arg instanceof boltzrpc_pb.GetDisabledSignersRequest)) {
    throw new Error('Expected argument of type boltzrpc.GetDisabledSignersRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_boltzrpc_GetDisabledSignersRequest(buffer_arg) {
  return boltzrpc_pb.GetDisabledSignersRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_boltzrpc_GetDisabledSignersResponse(arg) {
  if (!(arg instanceof boltzrpc_pb.GetDisabledSignersResponse)) {
    throw new Error('Expected argument of type boltzrpc.GetDisabledSignersResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_boltzrpc_GetDisabledSignersResponse(buffer_arg) {
  return boltzrpc_pb.GetDisabledSignersResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_boltzrpc_GetPendingEvmTransactionsRequest(arg) {
  if (!(arg instanceof boltzrpc_pb.GetPendingEvmTransactionsRequest)) {
    throw new Error('Expected argument of type boltzrpc.GetPendingEvmTransactionsRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_boltzrpc_GetPendingEvmTransactionsRequest(buffer_arg) {
  return boltzrpc_pb.GetPendingEvmTransactionsRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_boltzrpc_GetPendingEvmTransactionsResponse(arg) {
  if (!(arg instanceof boltzrpc_pb.GetPendingEvmTransactionsResponse)) {
    throw new Error('Expected argument of type boltzrpc.GetPendingEvmTransactionsResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_boltzrpc_GetPendingEvmTransactionsResponse(buffer_arg) {
  return boltzrpc_pb.GetPendingEvmTransactionsResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_boltzrpc_InvoiceClnThresholdRequest(arg) {
  if (!(arg instanceof boltzrpc_pb.InvoiceClnThresholdRequest)) {
    throw new Error('Expected argument of type boltzrpc.InvoiceClnThresholdRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_boltzrpc_InvoiceClnThresholdRequest(buffer_arg) {
  return boltzrpc_pb.InvoiceClnThresholdRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_boltzrpc_InvoiceClnThresholdResponse(arg) {
  if (!(arg instanceof boltzrpc_pb.InvoiceClnThresholdResponse)) {
    throw new Error('Expected argument of type boltzrpc.InvoiceClnThresholdResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_boltzrpc_InvoiceClnThresholdResponse(buffer_arg) {
  return boltzrpc_pb.InvoiceClnThresholdResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_boltzrpc_InvoiceCreationHookRequest(arg) {
  if (!(arg instanceof boltzrpc_pb.InvoiceCreationHookRequest)) {
    throw new Error('Expected argument of type boltzrpc.InvoiceCreationHookRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_boltzrpc_InvoiceCreationHookRequest(buffer_arg) {
  return boltzrpc_pb.InvoiceCreationHookRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_boltzrpc_InvoiceCreationHookResponse(arg) {
  if (!(arg instanceof boltzrpc_pb.InvoiceCreationHookResponse)) {
    throw new Error('Expected argument of type boltzrpc.InvoiceCreationHookResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_boltzrpc_InvoiceCreationHookResponse(buffer_arg) {
  return boltzrpc_pb.InvoiceCreationHookResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_boltzrpc_InvoicePaymentHookRequest(arg) {
  if (!(arg instanceof boltzrpc_pb.InvoicePaymentHookRequest)) {
    throw new Error('Expected argument of type boltzrpc.InvoicePaymentHookRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_boltzrpc_InvoicePaymentHookRequest(buffer_arg) {
  return boltzrpc_pb.InvoicePaymentHookRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_boltzrpc_InvoicePaymentHookResponse(arg) {
  if (!(arg instanceof boltzrpc_pb.InvoicePaymentHookResponse)) {
    throw new Error('Expected argument of type boltzrpc.InvoicePaymentHookResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_boltzrpc_InvoicePaymentHookResponse(buffer_arg) {
  return boltzrpc_pb.InvoicePaymentHookResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_boltzrpc_SwapCreation(arg) {
  if (!(arg instanceof boltzrpc_pb.SwapCreation)) {
    throw new Error('Expected argument of type boltzrpc.SwapCreation');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_boltzrpc_SwapCreation(buffer_arg) {
  return boltzrpc_pb.SwapCreation.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_boltzrpc_SwapCreationResponse(arg) {
  if (!(arg instanceof boltzrpc_pb.SwapCreationResponse)) {
    throw new Error('Expected argument of type boltzrpc.SwapCreationResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_boltzrpc_SwapCreationResponse(buffer_arg) {
  return boltzrpc_pb.SwapCreationResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_boltzrpc_TransactionHookRequest(arg) {
  if (!(arg instanceof boltzrpc_pb.TransactionHookRequest)) {
    throw new Error('Expected argument of type boltzrpc.TransactionHookRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_boltzrpc_TransactionHookRequest(buffer_arg) {
  return boltzrpc_pb.TransactionHookRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_boltzrpc_TransactionHookResponse(arg) {
  if (!(arg instanceof boltzrpc_pb.TransactionHookResponse)) {
    throw new Error('Expected argument of type boltzrpc.TransactionHookResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_boltzrpc_TransactionHookResponse(buffer_arg) {
  return boltzrpc_pb.TransactionHookResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
allowRefund: {
  ...
  disableSigners: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: boltzrpc_pb.DisableSignersRequest,
    responseType: boltzrpc_pb.DisableSignersResponse,
    requestSerialize: serialize_boltzrpc_DisableSignersRequest,
    requestDeserialize: deserialize_boltzrpc_DisableSignersRequest,
    responseSerialize: serialize_boltzrpc_DisableSignersResponse,
    responseDeserialize: deserialize_boltzrpc_DisableSignersResponse,
  },
  enableSigners: {
    path: '/boltzrpc.Boltz/EnableSigners',
    requestStream: false,
    responseStream: false,
    requestType: boltzrpc_pb.EnableSignersRequest,
    responseType: boltzrpc_pb.EnableSignersResponse,
    requestSerialize: serialize_boltzrpc_EnableSignersRequest,
    requestDeserialize: deserialize_boltzrpc_EnableSignersRequest,
    responseSerialize: serialize_boltzrpc_EnableSignersResponse,
    responseDeserialize: deserialize_boltzrpc_EnableSignersResponse,
  },
  getDisabledSigners: {
    path: '/boltzrpc.Boltz/GetDisabledSigners',
    requestStream: false,
    responseStream: false,
    requestType: boltzrpc_pb.GetDisabledSignersRequest,
    responseType: boltzrpc_pb.GetDisabledSignersResponse,
    requestSerialize: serialize_boltzrpc_GetDisabledSignersRequest,
    requestDeserialize: deserialize_boltzrpc_GetDisabledSignersRequest,
    responseSerialize: serialize_boltzrpc_GetDisabledSignersResponse,
    responseDeserialize: deserialize_boltzrpc_GetDisabledSignersResponse,
  },
...
getPendingSweeps: {
  ...
  checkTransaction: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: boltzrpc_pb.CheckTransactionRequest,
    responseType: boltzrpc_pb.CheckTransactionResponse,
    requestSerialize: serialize_boltzrpc_CheckTransactionRequest,
    requestDeserialize: deserialize_boltzrpc_CheckTransactionRequest,
    responseSerialize: serialize_boltzrpc_CheckTransactionResponse,
    responseDeserialize: deserialize_boltzrpc_CheckTransactionResponse,
  },
  getLabel: {
  ...
  getPendingEvmTransactions: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: boltzrpc_pb.GetPendingEvmTransactionsRequest,
    responseType: boltzrpc_pb.GetPendingEvmTransactionsResponse,
    requestSerialize: serialize_boltzrpc_GetPendingEvmTransactionsRequest,
    requestDeserialize: deserialize_boltzrpc_GetPendingEvmTransactionsRequest,
    responseSerialize: serialize_boltzrpc_GetPendingEvmTransactionsResponse,
    responseDeserialize: deserialize_boltzrpc_GetPendingEvmTransactionsResponse,
  },
  getReferrals: {
  ...
  invoiceClnThreshold: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: boltzrpc_pb.InvoiceClnThresholdRequest,
    responseType: boltzrpc_pb.InvoiceClnThresholdResponse,
    requestSerialize: serialize_boltzrpc_InvoiceClnThresholdRequest,
    requestDeserialize: deserialize_boltzrpc_InvoiceClnThresholdRequest,
    responseSerialize: serialize_boltzrpc_InvoiceClnThresholdResponse,
    responseDeserialize: deserialize_boltzrpc_InvoiceClnThresholdResponse,
  },
  ...
  swapCreationHook: {
    ...
    requestStream: true,
    responseStream: true,
    requestType: boltzrpc_pb.SwapCreationResponse,
    responseType: boltzrpc_pb.SwapCreation,
    requestSerialize: serialize_boltzrpc_SwapCreationResponse,
    requestDeserialize: deserialize_boltzrpc_SwapCreationResponse,
    responseSerialize: serialize_boltzrpc_SwapCreation,
    responseDeserialize: deserialize_boltzrpc_SwapCreation,
  },
  invoiceCreationHook: {
    path: '/boltzrpc.Boltz/InvoiceCreationHook',
    requestStream: true,
    responseStream: true,
    requestType: boltzrpc_pb.InvoiceCreationHookResponse,
    responseType: boltzrpc_pb.InvoiceCreationHookRequest,
    requestSerialize: serialize_boltzrpc_InvoiceCreationHookResponse,
    requestDeserialize: deserialize_boltzrpc_InvoiceCreationHookResponse,
    responseSerialize: serialize_boltzrpc_InvoiceCreationHookRequest,
    responseDeserialize: deserialize_boltzrpc_InvoiceCreationHookRequest,
  },
  transactionHook: {
    path: '/boltzrpc.Boltz/TransactionHook',
    requestStream: true,
    responseStream: true,
    requestType: boltzrpc_pb.TransactionHookResponse,
    responseType: boltzrpc_pb.TransactionHookRequest,
    requestSerialize: serialize_boltzrpc_TransactionHookResponse,
    requestDeserialize: deserialize_boltzrpc_TransactionHookResponse,
    responseSerialize: serialize_boltzrpc_TransactionHookRequest,
    responseDeserialize: deserialize_boltzrpc_TransactionHookRequest,
  },
  invoicePaymentHook: {
    path: '/boltzrpc.Boltz/InvoicePaymentHook',
    requestStream: true,
    responseStream: true,
    requestType: boltzrpc_pb.InvoicePaymentHookResponse,
    responseType: boltzrpc_pb.InvoicePaymentHookRequest,
    requestSerialize: serialize_boltzrpc_InvoicePaymentHookResponse,
    requestDeserialize: deserialize_boltzrpc_InvoicePaymentHookResponse,
    responseSerialize: serialize_boltzrpc_InvoicePaymentHookRequest,
    responseDeserialize: deserialize_boltzrpc_InvoicePaymentHookRequest,
  },
  setLogLevel: {
  ...
  devClearSwapUpdateCache: {
    path: '/boltzrpc.Boltz/DevClearSwapUpdateCache',
    requestStream: false,
    responseStream: false,
    requestType: boltzrpc_pb.DevClearSwapUpdateCacheRequest,
    responseType: boltzrpc_pb.DevClearSwapUpdateCacheResponse,
    requestSerialize: serialize_boltzrpc_DevClearSwapUpdateCacheRequest,
    requestDeserialize: deserialize_boltzrpc_DevClearSwapUpdateCacheRequest,
    responseSerialize: serialize_boltzrpc_DevClearSwapUpdateCacheResponse,
    responseDeserialize: deserialize_boltzrpc_DevClearSwapUpdateCacheResponse,
  },
};

exports.BoltzClient = grpc.makeGenericClientConstructor(BoltzService, 'Boltz');
