...
function serialize_boltzr_GetHelloWorldRequest(arg) {
  if (!(arg instanceof boltzr_pb.GetHelloWorldRequest)) {
    throw new Error('Expected argument of type boltzr.GetHelloWorldRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_boltzr_GetHelloWorldRequest(buffer_arg) {
  return boltzr_pb.GetHelloWorldRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_boltzr_GetHelloWorldResponse(arg) {
  if (!(arg instanceof boltzr_pb.GetHelloWorldResponse)) {
    throw new Error('Expected argument of type boltzr.GetHelloWorldResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_boltzr_GetHelloWorldResponse(buffer_arg) {
  return boltzr_pb.GetHelloWorldResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var BoltzRService = exports.BoltzRService = {
  ...
  getHelloWorld: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: boltzr_pb.GetHelloWorldRequest,
    responseType: boltzr_pb.GetHelloWorldResponse,
    requestSerialize: serialize_boltzr_GetHelloWorldRequest,
    requestDeserialize: deserialize_boltzr_GetHelloWorldRequest,
    responseSerialize: serialize_boltzr_GetHelloWorldResponse,
    responseDeserialize: deserialize_boltzr_GetHelloWorldResponse,
  },
};
