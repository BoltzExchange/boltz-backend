...
goog.object.extend(proto, boltzr_pb);
goog.exportSymbol('proto.boltzrpc.Action', null, global);
...
goog.exportSymbol('proto.boltzrpc.CheckTransactionRequest', null, global);
goog.exportSymbol('proto.boltzrpc.CheckTransactionResponse', null, global);
...
goog.exportSymbol('proto.boltzrpc.DevClearSwapUpdateCacheRequest', null, global);
goog.exportSymbol('proto.boltzrpc.DevClearSwapUpdateCacheResponse', null, global);
...
goog.exportSymbol('proto.boltzrpc.DisableSignersRequest', null, global);
goog.exportSymbol('proto.boltzrpc.DisableSignersResponse', null, global);
goog.exportSymbol('proto.boltzrpc.EnableSignersRequest', null, global);
goog.exportSymbol('proto.boltzrpc.EnableSignersResponse', null, global);
...
goog.exportSymbol('proto.boltzrpc.GetDisabledSignersRequest', null, global);
goog.exportSymbol('proto.boltzrpc.GetDisabledSignersResponse', null, global);
...
goog.exportSymbol('proto.boltzrpc.GetPendingEvmTransactionsRequest', null, global);
goog.exportSymbol('proto.boltzrpc.GetPendingEvmTransactionsResponse', null, global);
goog.exportSymbol('proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction', null, global);
...
goog.exportSymbol('proto.boltzrpc.InvoiceClnThresholdRequest', null, global);
goog.exportSymbol('proto.boltzrpc.InvoiceClnThresholdRequest.Threshold', null, global);
goog.exportSymbol('proto.boltzrpc.InvoiceClnThresholdResponse', null, global);
goog.exportSymbol('proto.boltzrpc.InvoiceCreationHookRequest', null, global);
goog.exportSymbol('proto.boltzrpc.InvoiceCreationHookResponse', null, global);
goog.exportSymbol('proto.boltzrpc.InvoicePaymentHookRequest', null, global);
goog.exportSymbol('proto.boltzrpc.InvoicePaymentHookResponse', null, global);
...
goog.exportSymbol('proto.boltzrpc.Signer', null, global);
goog.exportSymbol('proto.boltzrpc.StopRequest', null, global);
goog.exportSymbol('proto.boltzrpc.StopResponse', null, global);
goog.exportSymbol('proto.boltzrpc.SwapCreation', null, global);
goog.exportSymbol('proto.boltzrpc.SwapCreation.Chain', null, global);
goog.exportSymbol('proto.boltzrpc.SwapCreation.Reverse', null, global);
goog.exportSymbol('proto.boltzrpc.SwapCreation.Submarine', null, global);
goog.exportSymbol('proto.boltzrpc.SwapCreation.SwapCase', null, global);
goog.exportSymbol('proto.boltzrpc.SwapCreationResponse', null, global);
goog.exportSymbol('proto.boltzrpc.SwapType', null, global);
...
goog.exportSymbol('proto.boltzrpc.TransactionHookRequest', null, global);
goog.exportSymbol('proto.boltzrpc.TransactionHookResponse', null, global);
 ...
 * @constructor
 */
proto.boltzrpc.CheckTransactionRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.boltzrpc.CheckTransactionRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.boltzrpc.CheckTransactionRequest.displayName = 'proto.boltzrpc.CheckTransactionRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.boltzrpc.CheckTransactionResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.boltzrpc.CheckTransactionResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.boltzrpc.CheckTransactionResponse.displayName = 'proto.boltzrpc.CheckTransactionResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.boltzrpc.DisableSignersRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.boltzrpc.DisableSignersRequest.repeatedFields_, null);
};
goog.inherits(proto.boltzrpc.DisableSignersRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.boltzrpc.DisableSignersRequest.displayName = 'proto.boltzrpc.DisableSignersRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.boltzrpc.DisableSignersResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.boltzrpc.DisableSignersResponse.repeatedFields_, null);
};
goog.inherits(proto.boltzrpc.DisableSignersResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.boltzrpc.DisableSignersResponse.displayName = 'proto.boltzrpc.DisableSignersResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.boltzrpc.EnableSignersRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.boltzrpc.EnableSignersRequest.repeatedFields_, null);
};
goog.inherits(proto.boltzrpc.EnableSignersRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.boltzrpc.EnableSignersRequest.displayName = 'proto.boltzrpc.EnableSignersRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.boltzrpc.EnableSignersResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.boltzrpc.EnableSignersResponse.repeatedFields_, null);
};
goog.inherits(proto.boltzrpc.EnableSignersResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.boltzrpc.EnableSignersResponse.displayName = 'proto.boltzrpc.EnableSignersResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.boltzrpc.GetDisabledSignersRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.boltzrpc.GetDisabledSignersRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.boltzrpc.GetDisabledSignersRequest.displayName = 'proto.boltzrpc.GetDisabledSignersRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.boltzrpc.GetDisabledSignersResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.boltzrpc.GetDisabledSignersResponse.repeatedFields_, null);
};
goog.inherits(proto.boltzrpc.GetDisabledSignersResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.boltzrpc.GetDisabledSignersResponse.displayName = 'proto.boltzrpc.GetDisabledSignersResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.boltzrpc.GetPendingEvmTransactionsRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.boltzrpc.GetPendingEvmTransactionsRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.boltzrpc.GetPendingEvmTransactionsRequest.displayName = 'proto.boltzrpc.GetPendingEvmTransactionsRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.boltzrpc.GetPendingEvmTransactionsResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.boltzrpc.GetPendingEvmTransactionsResponse.repeatedFields_, null);
};
goog.inherits(proto.boltzrpc.GetPendingEvmTransactionsResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.boltzrpc.GetPendingEvmTransactionsResponse.displayName = 'proto.boltzrpc.GetPendingEvmTransactionsResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction.displayName = 'proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.boltzrpc.InvoiceClnThresholdRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.boltzrpc.InvoiceClnThresholdRequest.repeatedFields_, null);
};
goog.inherits(proto.boltzrpc.InvoiceClnThresholdRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.boltzrpc.InvoiceClnThresholdRequest.displayName = 'proto.boltzrpc.InvoiceClnThresholdRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.boltzrpc.InvoiceClnThresholdRequest.Threshold = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.boltzrpc.InvoiceClnThresholdRequest.Threshold, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.boltzrpc.InvoiceClnThresholdRequest.Threshold.displayName = 'proto.boltzrpc.InvoiceClnThresholdRequest.Threshold';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.boltzrpc.InvoiceClnThresholdResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.boltzrpc.InvoiceClnThresholdResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.boltzrpc.InvoiceClnThresholdResponse.displayName = 'proto.boltzrpc.InvoiceClnThresholdResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.boltzrpc.SwapCreationResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.boltzrpc.SwapCreationResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.boltzrpc.SwapCreationResponse.displayName = 'proto.boltzrpc.SwapCreationResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.boltzrpc.SwapCreation = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, proto.boltzrpc.SwapCreation.oneofGroups_);
};
goog.inherits(proto.boltzrpc.SwapCreation, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.boltzrpc.SwapCreation.displayName = 'proto.boltzrpc.SwapCreation';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.boltzrpc.SwapCreation.Submarine = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.boltzrpc.SwapCreation.Submarine, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.boltzrpc.SwapCreation.Submarine.displayName = 'proto.boltzrpc.SwapCreation.Submarine';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.boltzrpc.SwapCreation.Reverse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.boltzrpc.SwapCreation.Reverse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.boltzrpc.SwapCreation.Reverse.displayName = 'proto.boltzrpc.SwapCreation.Reverse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.boltzrpc.SwapCreation.Chain = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.boltzrpc.SwapCreation.Chain, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.boltzrpc.SwapCreation.Chain.displayName = 'proto.boltzrpc.SwapCreation.Chain';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.boltzrpc.TransactionHookResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.boltzrpc.TransactionHookResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.boltzrpc.TransactionHookResponse.displayName = 'proto.boltzrpc.TransactionHookResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.boltzrpc.TransactionHookRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.boltzrpc.TransactionHookRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.boltzrpc.TransactionHookRequest.displayName = 'proto.boltzrpc.TransactionHookRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.boltzrpc.InvoiceCreationHookResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.boltzrpc.InvoiceCreationHookResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.boltzrpc.InvoiceCreationHookResponse.displayName = 'proto.boltzrpc.InvoiceCreationHookResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.boltzrpc.InvoiceCreationHookRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.boltzrpc.InvoiceCreationHookRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.boltzrpc.InvoiceCreationHookRequest.displayName = 'proto.boltzrpc.InvoiceCreationHookRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.boltzrpc.InvoicePaymentHookResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.boltzrpc.InvoicePaymentHookResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.boltzrpc.InvoicePaymentHookResponse.displayName = 'proto.boltzrpc.InvoicePaymentHookResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.boltzrpc.InvoicePaymentHookRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.boltzrpc.InvoicePaymentHookRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.boltzrpc.InvoicePaymentHookRequest.displayName = 'proto.boltzrpc.InvoicePaymentHookRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.boltzrpc.DevClearSwapUpdateCacheRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.boltzrpc.DevClearSwapUpdateCacheRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.boltzrpc.DevClearSwapUpdateCacheRequest.displayName = 'proto.boltzrpc.DevClearSwapUpdateCacheRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.boltzrpc.DevClearSwapUpdateCacheResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.boltzrpc.DevClearSwapUpdateCacheResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.boltzrpc.DevClearSwapUpdateCacheResponse.displayName = 'proto.boltzrpc.DevClearSwapUpdateCacheResponse';
}
 ...
 * @return {!proto.boltzrpc.SendCoinsRequest} returns this
 */
proto.boltzrpc.SendCoinsRequest.prototype.clearFee = function() {
 ...
 * @return {boolean}
 */
proto.boltzrpc.SendCoinsRequest.prototype.hasFee = function() {
 ...
 * @return {!proto.boltzrpc.AddReferralRequest} returns this
 */
proto.boltzrpc.AddReferralRequest.prototype.clearRoutingNode = function() {
 ...
 * @return {boolean}
 */
proto.boltzrpc.AddReferralRequest.prototype.hasRoutingNode = function() {
 ...
 * @return {!Object}
 */
proto.boltzrpc.CheckTransactionRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.boltzrpc.CheckTransactionRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.boltzrpc.CheckTransactionRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.CheckTransactionRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    symbol: jspb.Message.getFieldWithDefault(msg, 1, ""),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.boltzrpc.CheckTransactionRequest}
 */
proto.boltzrpc.CheckTransactionRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.boltzrpc.CheckTransactionRequest;
  return proto.boltzrpc.CheckTransactionRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.boltzrpc.CheckTransactionRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.boltzrpc.CheckTransactionRequest}
 */
proto.boltzrpc.CheckTransactionRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.boltzrpc.CheckTransactionRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.boltzrpc.CheckTransactionRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.boltzrpc.CheckTransactionRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.CheckTransactionRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getSymbol();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.boltzrpc.CheckTransactionRequest.prototype.getSymbol = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.boltzrpc.CheckTransactionRequest} returns this
 */
proto.boltzrpc.CheckTransactionRequest.prototype.setSymbol = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.boltzrpc.CheckTransactionRequest.prototype.getId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.boltzrpc.CheckTransactionRequest} returns this
 */
proto.boltzrpc.CheckTransactionRequest.prototype.setId = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {!Object}
 */
proto.boltzrpc.CheckTransactionResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.boltzrpc.CheckTransactionResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.boltzrpc.CheckTransactionResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.CheckTransactionResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.boltzrpc.CheckTransactionResponse}
 */
proto.boltzrpc.CheckTransactionResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.boltzrpc.CheckTransactionResponse;
  return proto.boltzrpc.CheckTransactionResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.boltzrpc.CheckTransactionResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.boltzrpc.CheckTransactionResponse}
 */
proto.boltzrpc.CheckTransactionResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.boltzrpc.CheckTransactionResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.boltzrpc.CheckTransactionResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.boltzrpc.CheckTransactionResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.CheckTransactionResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
 ...
 * @const
 */
proto.boltzrpc.DisableSignersRequest.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.boltzrpc.DisableSignersRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.boltzrpc.DisableSignersRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.boltzrpc.DisableSignersRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.DisableSignersRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.boltzrpc.DisableSignersRequest}
 */
proto.boltzrpc.DisableSignersRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.boltzrpc.DisableSignersRequest;
  return proto.boltzrpc.DisableSignersRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.boltzrpc.DisableSignersRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.boltzrpc.DisableSignersRequest}
 */
proto.boltzrpc.DisableSignersRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var values = /** @type {!Array<!proto.boltzrpc.Signer>} */ (reader.isDelimited() ? reader.readPackedEnum() : [reader.readEnum()]);
      for (var i = 0; i < values.length; i++) {
        msg.addSigners(values[i]);
      }
      break;
    default:
      reader.skipField();
 ...
 * @return {!Uint8Array}
 */
proto.boltzrpc.DisableSignersRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.boltzrpc.DisableSignersRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.boltzrpc.DisableSignersRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.DisableSignersRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {!Array<!proto.boltzrpc.Signer>}
 */
proto.boltzrpc.DisableSignersRequest.prototype.getSignersList = function() {
  return /** @type {!Array<!proto.boltzrpc.Signer>} */ (jspb.Message.getRepeatedField(this, 1));
};


/**
 * @param {!Array<!proto.boltzrpc.Signer>} value
 * @return {!proto.boltzrpc.DisableSignersRequest} returns this
 */
proto.boltzrpc.DisableSignersRequest.prototype.setSignersList = function(value) {
  return jspb.Message.setField(this, 1, value || []);
};


/**
 * @param {!proto.boltzrpc.Signer} value
 * @param {number=} opt_index
 * @return {!proto.boltzrpc.DisableSignersRequest} returns this
 */
proto.boltzrpc.DisableSignersRequest.prototype.addSigners = function(value, opt_index) {
  return jspb.Message.addToRepeatedField(this, 1, value, opt_index);
};
 ...
 * @return {!proto.boltzrpc.DisableSignersRequest} returns this
 */
proto.boltzrpc.DisableSignersRequest.prototype.clearSignersList = function() {
 ...
 * @const
 */
proto.boltzrpc.DisableSignersResponse.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.boltzrpc.DisableSignersResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.boltzrpc.DisableSignersResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.boltzrpc.DisableSignersResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.DisableSignersResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    disabledSignersList: (f = jspb.Message.getRepeatedField(msg, 1)) == null ? undefined : f
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.boltzrpc.DisableSignersResponse}
 */
proto.boltzrpc.DisableSignersResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.boltzrpc.DisableSignersResponse;
  return proto.boltzrpc.DisableSignersResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.boltzrpc.DisableSignersResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.boltzrpc.DisableSignersResponse}
 */
proto.boltzrpc.DisableSignersResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 1:
      var values = /** @type {!Array<!proto.boltzrpc.Signer>} */ (reader.isDelimited() ? reader.readPackedEnum() : [reader.readEnum()]);
      for (var i = 0; i < values.length; i++) {
        msg.addDisabledSigners(values[i]);
      }
      break;
    default:
      reader.skipField();
 ...
 * @return {!Uint8Array}
 */
proto.boltzrpc.DisableSignersResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.boltzrpc.DisableSignersResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.boltzrpc.DisableSignersResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.DisableSignersResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getDisabledSignersList();
  if (f.length > 0) {
    writer.writePackedEnum(
      1,
      f
 ...
 * @return {!Array<!proto.boltzrpc.Signer>}
 */
proto.boltzrpc.DisableSignersResponse.prototype.getDisabledSignersList = function() {
  return /** @type {!Array<!proto.boltzrpc.Signer>} */ (jspb.Message.getRepeatedField(this, 1));
};
...
/**
 * @param {!Array<!proto.boltzrpc.Signer>} value
 * @return {!proto.boltzrpc.DisableSignersResponse} returns this
 */
proto.boltzrpc.DisableSignersResponse.prototype.setDisabledSignersList = function(value) {
  return jspb.Message.setField(this, 1, value || []);
};
 ...
 * @return {!proto.boltzrpc.DisableSignersResponse} returns this
 */
proto.boltzrpc.DisableSignersResponse.prototype.addDisabledSigners = function(value, opt_index) {
  return jspb.Message.addToRepeatedField(this, 1, value, opt_index);
};
 ...
 * @return {!proto.boltzrpc.DisableSignersResponse} returns this
 */
proto.boltzrpc.DisableSignersResponse.prototype.clearDisabledSignersList = function() {
  return this.setDisabledSignersList([]);
};
 ...
 * @const
 */
proto.boltzrpc.EnableSignersRequest.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.boltzrpc.EnableSignersRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.boltzrpc.EnableSignersRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.boltzrpc.EnableSignersRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.EnableSignersRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    signersList: (f = jspb.Message.getRepeatedField(msg, 1)) == null ? undefined : f
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.boltzrpc.EnableSignersRequest}
 */
proto.boltzrpc.EnableSignersRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.boltzrpc.EnableSignersRequest;
  return proto.boltzrpc.EnableSignersRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.boltzrpc.EnableSignersRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.boltzrpc.EnableSignersRequest}
 */
proto.boltzrpc.EnableSignersRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.boltzrpc.EnableSignersRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.boltzrpc.EnableSignersRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.boltzrpc.EnableSignersRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.EnableSignersRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getSignersList();
  if (f.length > 0) {
    writer.writePackedEnum(
 ...
 * @return {!Array<!proto.boltzrpc.Signer>}
 */
proto.boltzrpc.EnableSignersRequest.prototype.getSignersList = function() {
  return /** @type {!Array<!proto.boltzrpc.Signer>} */ (jspb.Message.getRepeatedField(this, 1));
};
...
/**
 * @param {!Array<!proto.boltzrpc.Signer>} value
 * @return {!proto.boltzrpc.EnableSignersRequest} returns this
 */
proto.boltzrpc.EnableSignersRequest.prototype.setSignersList = function(value) {
  return jspb.Message.setField(this, 1, value || []);
};
 ...
 * @return {!proto.boltzrpc.EnableSignersRequest} returns this
 */
proto.boltzrpc.EnableSignersRequest.prototype.addSigners = function(value, opt_index) {
  return jspb.Message.addToRepeatedField(this, 1, value, opt_index);
};
 ...
 * @return {!proto.boltzrpc.EnableSignersRequest} returns this
 */
proto.boltzrpc.EnableSignersRequest.prototype.clearSignersList = function() {
  return this.setSignersList([]);
};
 ...
 * @const
 */
proto.boltzrpc.EnableSignersResponse.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.boltzrpc.EnableSignersResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.boltzrpc.EnableSignersResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.boltzrpc.EnableSignersResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.EnableSignersResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    disabledSignersList: (f = jspb.Message.getRepeatedField(msg, 1)) == null ? undefined : f
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.boltzrpc.EnableSignersResponse}
 */
proto.boltzrpc.EnableSignersResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.boltzrpc.EnableSignersResponse;
  return proto.boltzrpc.EnableSignersResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.boltzrpc.EnableSignersResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.boltzrpc.EnableSignersResponse}
 */
proto.boltzrpc.EnableSignersResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.boltzrpc.EnableSignersResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.boltzrpc.EnableSignersResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.boltzrpc.EnableSignersResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.EnableSignersResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getDisabledSignersList();
  if (f.length > 0) {
    writer.writePackedEnum(
 ...
 * @return {!Array<!proto.boltzrpc.Signer>}
 */
proto.boltzrpc.EnableSignersResponse.prototype.getDisabledSignersList = function() {
  return /** @type {!Array<!proto.boltzrpc.Signer>} */ (jspb.Message.getRepeatedField(this, 1));
};
...
/**
 * @param {!Array<!proto.boltzrpc.Signer>} value
 * @return {!proto.boltzrpc.EnableSignersResponse} returns this
 */
proto.boltzrpc.EnableSignersResponse.prototype.setDisabledSignersList = function(value) {
  return jspb.Message.setField(this, 1, value || []);
};
 ...
 * @return {!proto.boltzrpc.EnableSignersResponse} returns this
 */
proto.boltzrpc.EnableSignersResponse.prototype.addDisabledSigners = function(value, opt_index) {
  return jspb.Message.addToRepeatedField(this, 1, value, opt_index);
};
 ...
 * @return {!proto.boltzrpc.EnableSignersResponse} returns this
 */
proto.boltzrpc.EnableSignersResponse.prototype.clearDisabledSignersList = function() {
  return this.setDisabledSignersList([]);
};
 ...
 * @return {!Object}
 */
proto.boltzrpc.GetDisabledSignersRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.boltzrpc.GetDisabledSignersRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.boltzrpc.GetDisabledSignersRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.GetDisabledSignersRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.boltzrpc.GetDisabledSignersRequest}
 */
proto.boltzrpc.GetDisabledSignersRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.boltzrpc.GetDisabledSignersRequest;
  return proto.boltzrpc.GetDisabledSignersRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.boltzrpc.GetDisabledSignersRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.boltzrpc.GetDisabledSignersRequest}
 */
proto.boltzrpc.GetDisabledSignersRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.boltzrpc.GetDisabledSignersRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.boltzrpc.GetDisabledSignersRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.boltzrpc.GetDisabledSignersRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.GetDisabledSignersRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
 ...
 * @const
 */
proto.boltzrpc.GetDisabledSignersResponse.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.boltzrpc.GetDisabledSignersResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.boltzrpc.GetDisabledSignersResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.boltzrpc.GetDisabledSignersResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.GetDisabledSignersResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    disabledSignersList: (f = jspb.Message.getRepeatedField(msg, 1)) == null ? undefined : f
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.boltzrpc.GetDisabledSignersResponse}
 */
proto.boltzrpc.GetDisabledSignersResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.boltzrpc.GetDisabledSignersResponse;
  return proto.boltzrpc.GetDisabledSignersResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.boltzrpc.GetDisabledSignersResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.boltzrpc.GetDisabledSignersResponse}
 */
proto.boltzrpc.GetDisabledSignersResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.boltzrpc.GetDisabledSignersResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.boltzrpc.GetDisabledSignersResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.boltzrpc.GetDisabledSignersResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.GetDisabledSignersResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getDisabledSignersList();
  if (f.length > 0) {
    writer.writePackedEnum(
 ...
 * @return {!Array<!proto.boltzrpc.Signer>}
 */
proto.boltzrpc.GetDisabledSignersResponse.prototype.getDisabledSignersList = function() {
  return /** @type {!Array<!proto.boltzrpc.Signer>} */ (jspb.Message.getRepeatedField(this, 1));
};
...
/**
 * @param {!Array<!proto.boltzrpc.Signer>} value
 * @return {!proto.boltzrpc.GetDisabledSignersResponse} returns this
 */
proto.boltzrpc.GetDisabledSignersResponse.prototype.setDisabledSignersList = function(value) {
  return jspb.Message.setField(this, 1, value || []);
};
 ...
 * @return {!proto.boltzrpc.GetDisabledSignersResponse} returns this
 */
proto.boltzrpc.GetDisabledSignersResponse.prototype.addDisabledSigners = function(value, opt_index) {
  return jspb.Message.addToRepeatedField(this, 1, value, opt_index);
};
 ...
 * @return {!proto.boltzrpc.GetDisabledSignersResponse} returns this
 */
proto.boltzrpc.GetDisabledSignersResponse.prototype.clearDisabledSignersList = function() {
  return this.setDisabledSignersList([]);
};
 ...
 * @return {!Object}
 */
proto.boltzrpc.GetPendingEvmTransactionsRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.boltzrpc.GetPendingEvmTransactionsRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.boltzrpc.GetPendingEvmTransactionsRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.GetPendingEvmTransactionsRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 */
proto.boltzrpc.GetPendingEvmTransactionsRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.boltzrpc.GetPendingEvmTransactionsRequest;
  return proto.boltzrpc.GetPendingEvmTransactionsRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.boltzrpc.GetPendingEvmTransactionsRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.boltzrpc.GetPendingEvmTransactionsRequest}
 */
proto.boltzrpc.GetPendingEvmTransactionsRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.boltzrpc.GetPendingEvmTransactionsRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.boltzrpc.GetPendingEvmTransactionsRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.boltzrpc.GetPendingEvmTransactionsRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.GetPendingEvmTransactionsRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
 ...
 * @const
 */
proto.boltzrpc.GetPendingEvmTransactionsResponse.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.boltzrpc.GetPendingEvmTransactionsResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.boltzrpc.GetPendingEvmTransactionsResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.boltzrpc.GetPendingEvmTransactionsResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.GetPendingEvmTransactionsResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    transactionsList: jspb.Message.toObjectList(msg.getTransactionsList(),
    proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.boltzrpc.GetPendingEvmTransactionsResponse}
 */
proto.boltzrpc.GetPendingEvmTransactionsResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.boltzrpc.GetPendingEvmTransactionsResponse;
  return proto.boltzrpc.GetPendingEvmTransactionsResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.boltzrpc.GetPendingEvmTransactionsResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.boltzrpc.GetPendingEvmTransactionsResponse}
 */
proto.boltzrpc.GetPendingEvmTransactionsResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction;
      reader.readMessage(value,proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction.deserializeBinaryFromReader);
 ...
 * @return {!Uint8Array}
 */
proto.boltzrpc.GetPendingEvmTransactionsResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.boltzrpc.GetPendingEvmTransactionsResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.boltzrpc.GetPendingEvmTransactionsResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.GetPendingEvmTransactionsResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!Object}
 */
proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction.prototype.toObject = function(opt_includeInstance) {
  return proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction.toObject = function(includeInstance, msg) {
  var f, obj = {
    symbol: jspb.Message.getFieldWithDefault(msg, 1, ""),
    ...
    amountSent: jspb.Message.getFieldWithDefault(msg, 6, ""),
    amountReceived: jspb.Message.getFieldWithDefault(msg, 7, "")
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction}
 */
proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction;
  return proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction}
 */
proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getSymbol();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction.prototype.getSymbol = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction} returns this
 */
proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction.prototype.setSymbol = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {!(string|Uint8Array)}
 */
proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction.prototype.getHash = function() {
  return /** @type {!(string|Uint8Array)} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {string}
 */
proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction.prototype.getHash_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
      this.getHash()));
};
 ...
 * @return {!Uint8Array}
 */
proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction.prototype.getHash_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getHash()));
};
 ...
 * @return {!proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction} returns this
 */
proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction.prototype.setHash = function(value) {
  return jspb.Message.setProto3BytesField(this, 2, value);
};
 ...
 * @return {!(string|Uint8Array)}
 */
proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction.prototype.getHex = function() {
 ...
 * @return {string}
 */
proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction.prototype.getHex_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
      this.getHex()));
};
 ...
 * @return {!Uint8Array}
 */
proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction.prototype.getHex_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getHex()));
};
 ...
 * @return {!proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction} returns this
 */
proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction.prototype.setHex = function(value) {
 ...
 * @return {string}
 */
proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction.prototype.getLabel = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 4, ""));
};
 ...
 * @return {!proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction} returns this
 */
proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction.prototype.setLabel = function(value) {
  return jspb.Message.setField(this, 4, value);
};
 ...
 * @return {!proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction} returns this
 */
proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction.prototype.clearLabel = function() {
  return jspb.Message.setField(this, 4, undefined);
};
 ...
 * @return {boolean}
 */
proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction.prototype.hasLabel = function() {
  return jspb.Message.getField(this, 4) != null;
};
 ...
 * @return {number}
 */
proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction.prototype.getNonce = function() {
 ...
 * @return {!proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction} returns this
 */
proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction.prototype.setNonce = function(value) {
  return jspb.Message.setProto3IntField(this, 5, value);
};


/**
 * optional string amount_sent = 6;
 * @return {string}
 */
proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction.prototype.getAmountSent = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 6, ""));
};
 ...
 * @return {!proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction} returns this
 */
proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction.prototype.setAmountSent = function(value) {
  return jspb.Message.setProto3StringField(this, 6, value);
};
 ...
 * @return {string}
 */
proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction.prototype.getAmountReceived = function() {
 ...
 * @return {!proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction} returns this
 */
proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction.prototype.setAmountReceived = function(value) {
  return jspb.Message.setField(this, 7, value);
};
 ...
 * @return {!proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction} returns this
 */
proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction.prototype.clearAmountReceived = function() {
  return jspb.Message.setField(this, 7, undefined);
};
 ...
 * @return {boolean}
 */
proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction.prototype.hasAmountReceived = function() {
  return jspb.Message.getField(this, 7) != null;
};
 ...
 * @return {!Array<!proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction>}
 */
proto.boltzrpc.GetPendingEvmTransactionsResponse.prototype.getTransactionsList = function() {
  return /** @type{!Array<!proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction, 1));
};


/**
 * @param {!Array<!proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction>} value
 * @return {!proto.boltzrpc.GetPendingEvmTransactionsResponse} returns this
*/
proto.boltzrpc.GetPendingEvmTransactionsResponse.prototype.setTransactionsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};


/**
 * @param {!proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction=} opt_value
 * @param {number=} opt_index
 * @return {!proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction}
 */
proto.boltzrpc.GetPendingEvmTransactionsResponse.prototype.addTransactions = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.boltzrpc.GetPendingEvmTransactionsResponse.Transaction, opt_index);
};
 ...
 * @return {!proto.boltzrpc.GetPendingEvmTransactionsResponse} returns this
 */
proto.boltzrpc.GetPendingEvmTransactionsResponse.prototype.clearTransactionsList = function() {
 ...
 * @const
 */
proto.boltzrpc.InvoiceClnThresholdRequest.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.boltzrpc.InvoiceClnThresholdRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.boltzrpc.InvoiceClnThresholdRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.boltzrpc.InvoiceClnThresholdRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.InvoiceClnThresholdRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    thresholdsList: jspb.Message.toObjectList(msg.getThresholdsList(),
    proto.boltzrpc.InvoiceClnThresholdRequest.Threshold.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.boltzrpc.InvoiceClnThresholdRequest}
 */
proto.boltzrpc.InvoiceClnThresholdRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.boltzrpc.InvoiceClnThresholdRequest;
  return proto.boltzrpc.InvoiceClnThresholdRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.boltzrpc.InvoiceClnThresholdRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.boltzrpc.InvoiceClnThresholdRequest}
 */
proto.boltzrpc.InvoiceClnThresholdRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new proto.boltzrpc.InvoiceClnThresholdRequest.Threshold;
      reader.readMessage(value,proto.boltzrpc.InvoiceClnThresholdRequest.Threshold.deserializeBinaryFromReader);
 ...
 * @return {!Uint8Array}
 */
proto.boltzrpc.InvoiceClnThresholdRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.boltzrpc.InvoiceClnThresholdRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.boltzrpc.InvoiceClnThresholdRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.InvoiceClnThresholdRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.boltzrpc.InvoiceClnThresholdRequest.Threshold.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!Object}
 */
proto.boltzrpc.InvoiceClnThresholdRequest.Threshold.prototype.toObject = function(opt_includeInstance) {
  return proto.boltzrpc.InvoiceClnThresholdRequest.Threshold.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.boltzrpc.InvoiceClnThresholdRequest.Threshold} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.InvoiceClnThresholdRequest.Threshold.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.boltzrpc.InvoiceClnThresholdRequest.Threshold}
 */
proto.boltzrpc.InvoiceClnThresholdRequest.Threshold.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.boltzrpc.InvoiceClnThresholdRequest.Threshold;
  return proto.boltzrpc.InvoiceClnThresholdRequest.Threshold.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.boltzrpc.InvoiceClnThresholdRequest.Threshold} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.boltzrpc.InvoiceClnThresholdRequest.Threshold}
 */
proto.boltzrpc.InvoiceClnThresholdRequest.Threshold.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = /** @type {!proto.boltzrpc.SwapType} */ (reader.readEnum());
      msg.setType(value);
      break;
    case 2:
      var value = /** @type {number} */ (reader.readUint64());
 ...
 * @return {!Uint8Array}
 */
proto.boltzrpc.InvoiceClnThresholdRequest.Threshold.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.boltzrpc.InvoiceClnThresholdRequest.Threshold.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.boltzrpc.InvoiceClnThresholdRequest.Threshold} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.InvoiceClnThresholdRequest.Threshold.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getType();
  if (f !== 0.0) {
    writer.writeEnum(
...
/**
 * optional SwapType type = 1;
 * @return {!proto.boltzrpc.SwapType}
 */
proto.boltzrpc.InvoiceClnThresholdRequest.Threshold.prototype.getType = function() {
  return /** @type {!proto.boltzrpc.SwapType} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/**
 * @param {!proto.boltzrpc.SwapType} value
 * @return {!proto.boltzrpc.InvoiceClnThresholdRequest.Threshold} returns this
 */
proto.boltzrpc.InvoiceClnThresholdRequest.Threshold.prototype.setType = function(value) {
 ...
 * @return {number}
 */
proto.boltzrpc.InvoiceClnThresholdRequest.Threshold.prototype.getThreshold = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.boltzrpc.InvoiceClnThresholdRequest.Threshold} returns this
 */
proto.boltzrpc.InvoiceClnThresholdRequest.Threshold.prototype.setThreshold = function(value) {
  return jspb.Message.setProto3IntField(this, 2, value);
};
 ...
 * @return {!Array<!proto.boltzrpc.InvoiceClnThresholdRequest.Threshold>}
 */
proto.boltzrpc.InvoiceClnThresholdRequest.prototype.getThresholdsList = function() {
  return /** @type{!Array<!proto.boltzrpc.InvoiceClnThresholdRequest.Threshold>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.boltzrpc.InvoiceClnThresholdRequest.Threshold, 1));
};


/**
 * @param {!Array<!proto.boltzrpc.InvoiceClnThresholdRequest.Threshold>} value
 * @return {!proto.boltzrpc.InvoiceClnThresholdRequest} returns this
*/
proto.boltzrpc.InvoiceClnThresholdRequest.prototype.setThresholdsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};


/**
 * @param {!proto.boltzrpc.InvoiceClnThresholdRequest.Threshold=} opt_value
 * @param {number=} opt_index
 * @return {!proto.boltzrpc.InvoiceClnThresholdRequest.Threshold}
 */
proto.boltzrpc.InvoiceClnThresholdRequest.prototype.addThresholds = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.boltzrpc.InvoiceClnThresholdRequest.Threshold, opt_index);
};
 ...
 * @return {!proto.boltzrpc.InvoiceClnThresholdRequest} returns this
 */
proto.boltzrpc.InvoiceClnThresholdRequest.prototype.clearThresholdsList = function() {
 ...
 * @return {!Object}
 */
proto.boltzrpc.InvoiceClnThresholdResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.boltzrpc.InvoiceClnThresholdResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.boltzrpc.InvoiceClnThresholdResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.InvoiceClnThresholdResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.boltzrpc.InvoiceClnThresholdResponse}
 */
proto.boltzrpc.InvoiceClnThresholdResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.boltzrpc.InvoiceClnThresholdResponse;
  return proto.boltzrpc.InvoiceClnThresholdResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.boltzrpc.InvoiceClnThresholdResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.boltzrpc.InvoiceClnThresholdResponse}
 */
proto.boltzrpc.InvoiceClnThresholdResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.boltzrpc.InvoiceClnThresholdResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.boltzrpc.InvoiceClnThresholdResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.boltzrpc.InvoiceClnThresholdResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.InvoiceClnThresholdResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
 ...
 * @return {!Object}
 */
proto.boltzrpc.SwapCreationResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.boltzrpc.SwapCreationResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.boltzrpc.SwapCreationResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.SwapCreationResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    id: jspb.Message.getFieldWithDefault(msg, 1, ""),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.boltzrpc.SwapCreationResponse}
 */
proto.boltzrpc.SwapCreationResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.boltzrpc.SwapCreationResponse;
  return proto.boltzrpc.SwapCreationResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.boltzrpc.SwapCreationResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.boltzrpc.SwapCreationResponse}
 */
proto.boltzrpc.SwapCreationResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 1:
      ...
      break;
    case 2:
      var value = /** @type {!proto.boltzrpc.Action} */ (reader.readEnum());
      msg.setAction(value);
      break;
    default:
      reader.skipField();
 ...
 * @return {!Uint8Array}
 */
proto.boltzrpc.SwapCreationResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.boltzrpc.SwapCreationResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.boltzrpc.SwapCreationResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.SwapCreationResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getId();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.boltzrpc.SwapCreationResponse.prototype.getId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.boltzrpc.SwapCreationResponse} returns this
 */
proto.boltzrpc.SwapCreationResponse.prototype.setId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {!proto.boltzrpc.Action}
 */
proto.boltzrpc.SwapCreationResponse.prototype.getAction = function() {
  return /** @type {!proto.boltzrpc.Action} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};


/**
 * @param {!proto.boltzrpc.Action} value
 * @return {!proto.boltzrpc.SwapCreationResponse} returns this
 */
proto.boltzrpc.SwapCreationResponse.prototype.setAction = function(value) {
 ...
 * @const
 */
proto.boltzrpc.SwapCreation.oneofGroups_ = [[5,6,7]];

/**
 * @enum {number}
 */
proto.boltzrpc.SwapCreation.SwapCase = {
  SWAP_NOT_SET: 0,
  SUBMARINE: 5,
  REVERSE: 6,
  CHAIN: 7
...
/**
 * @return {proto.boltzrpc.SwapCreation.SwapCase}
 */
proto.boltzrpc.SwapCreation.prototype.getSwapCase = function() {
  return /** @type {proto.boltzrpc.SwapCreation.SwapCase} */(jspb.Message.computeOneofCase(this, proto.boltzrpc.SwapCreation.oneofGroups_[0]));
};
 ...
 * @return {!Object}
 */
proto.boltzrpc.SwapCreation.prototype.toObject = function(opt_includeInstance) {
  return proto.boltzrpc.SwapCreation.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.boltzrpc.SwapCreation} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.SwapCreation.toObject = function(includeInstance, msg) {
  var f, obj = {
    id: jspb.Message.getFieldWithDefault(msg, 1, ""),
    symbolSending: jspb.Message.getFieldWithDefault(msg, 2, ""),
    symbolReceiving: jspb.Message.getFieldWithDefault(msg, 3, ""),
    referral: jspb.Message.getFieldWithDefault(msg, 4, ""),
    submarine: (f = msg.getSubmarine()) && proto.boltzrpc.SwapCreation.Submarine.toObject(includeInstance, f),
    reverse: (f = msg.getReverse()) && proto.boltzrpc.SwapCreation.Reverse.toObject(includeInstance, f),
    chain: (f = msg.getChain()) && proto.boltzrpc.SwapCreation.Chain.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.boltzrpc.SwapCreation}
 */
proto.boltzrpc.SwapCreation.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.boltzrpc.SwapCreation;
  return proto.boltzrpc.SwapCreation.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.boltzrpc.SwapCreation} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.boltzrpc.SwapCreation}
 */
proto.boltzrpc.SwapCreation.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 2:
      var value = /** @type {string} */ (reader.readString());
      msg.setSymbolSending(value);
      break;
    case 3:
      var value = /** @type {string} */ (reader.readString());
      msg.setSymbolReceiving(value);
      break;
    case 4:
      var value = /** @type {string} */ (reader.readString());
      ...
      break;
    case 5:
      var value = new proto.boltzrpc.SwapCreation.Submarine;
      reader.readMessage(value,proto.boltzrpc.SwapCreation.Submarine.deserializeBinaryFromReader);
      msg.setSubmarine(value);
      break;
    case 6:
      var value = new proto.boltzrpc.SwapCreation.Reverse;
      reader.readMessage(value,proto.boltzrpc.SwapCreation.Reverse.deserializeBinaryFromReader);
      msg.setReverse(value);
      break;
    case 7:
      var value = new proto.boltzrpc.SwapCreation.Chain;
      reader.readMessage(value,proto.boltzrpc.SwapCreation.Chain.deserializeBinaryFromReader);
      msg.setChain(value);
      break;
    default:
      reader.skipField();
 ...
 * @return {!Uint8Array}
 */
proto.boltzrpc.SwapCreation.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.boltzrpc.SwapCreation.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.boltzrpc.SwapCreation} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.SwapCreation.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getId();
  if (f.length > 0) {
    writer.writeString(
  ...
  f = message.getSubmarine();
  if (f != null) {
    writer.writeMessage(
      5,
      f,
      proto.boltzrpc.SwapCreation.Submarine.serializeBinaryToWriter
    );
  }
  ...
  if (f != null) {
    writer.writeMessage(
      6,
      f,
      proto.boltzrpc.SwapCreation.Reverse.serializeBinaryToWriter
    );
  }
  f = message.getChain();
  if (f != null) {
    writer.writeMessage(
      7,
      f,
      proto.boltzrpc.SwapCreation.Chain.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!Object}
 */
proto.boltzrpc.SwapCreation.Submarine.prototype.toObject = function(opt_includeInstance) {
  return proto.boltzrpc.SwapCreation.Submarine.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.boltzrpc.SwapCreation.Submarine} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.boltzrpc.SwapCreation.Submarine}
 */
proto.boltzrpc.SwapCreation.Submarine.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.boltzrpc.SwapCreation.Submarine;
  return proto.boltzrpc.SwapCreation.Submarine.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.boltzrpc.SwapCreation.Submarine} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.boltzrpc.SwapCreation.Submarine}
 */
proto.boltzrpc.SwapCreation.Submarine.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.boltzrpc.SwapCreation.Submarine.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.boltzrpc.SwapCreation.Submarine.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.boltzrpc.SwapCreation.Submarine} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.SwapCreation.Submarine.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
...
/**
 * optional uint64 invoice_amount = 1;
 * @return {number}
 */
proto.boltzrpc.SwapCreation.Submarine.prototype.getInvoiceAmount = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
 ...
 * @return {!Object}
 */
proto.boltzrpc.SwapCreation.Reverse.prototype.toObject = function(opt_includeInstance) {
  return proto.boltzrpc.SwapCreation.Reverse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.boltzrpc.SwapCreation.Reverse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.SwapCreation.Reverse.toObject = function(includeInstance, msg) {
  var f, obj = {
    invoiceAmount: jspb.Message.getFieldWithDefault(msg, 1, 0)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.boltzrpc.SwapCreation.Reverse}
 */
proto.boltzrpc.SwapCreation.Reverse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.boltzrpc.SwapCreation.Reverse;
  return proto.boltzrpc.SwapCreation.Reverse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.boltzrpc.SwapCreation.Reverse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.boltzrpc.SwapCreation.Reverse}
 */
proto.boltzrpc.SwapCreation.Reverse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.boltzrpc.SwapCreation.Reverse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.boltzrpc.SwapCreation.Reverse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.boltzrpc.SwapCreation.Reverse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.SwapCreation.Reverse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getInvoiceAmount();
  if (f !== 0) {
    writer.writeUint64(
 ...
 * @return {number}
 */
proto.boltzrpc.SwapCreation.Reverse.prototype.getInvoiceAmount = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.boltzrpc.SwapCreation.Reverse} returns this
 */
proto.boltzrpc.SwapCreation.Reverse.prototype.setInvoiceAmount = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {!Object}
 */
proto.boltzrpc.SwapCreation.Chain.prototype.toObject = function(opt_includeInstance) {
  return proto.boltzrpc.SwapCreation.Chain.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.boltzrpc.SwapCreation.Chain} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.SwapCreation.Chain.toObject = function(includeInstance, msg) {
  var f, obj = {
    userLockAmount: jspb.Message.getFieldWithDefault(msg, 1, 0)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.boltzrpc.SwapCreation.Chain}
 */
proto.boltzrpc.SwapCreation.Chain.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.boltzrpc.SwapCreation.Chain;
  return proto.boltzrpc.SwapCreation.Chain.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.boltzrpc.SwapCreation.Chain} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.boltzrpc.SwapCreation.Chain}
 */
proto.boltzrpc.SwapCreation.Chain.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.boltzrpc.SwapCreation.Chain.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.boltzrpc.SwapCreation.Chain.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.boltzrpc.SwapCreation.Chain} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.SwapCreation.Chain.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getUserLockAmount();
  if (f !== 0) {
    writer.writeUint64(
      1,
      f
...
/**
 * optional uint64 user_lock_amount = 1;
 * @return {number}
 */
proto.boltzrpc.SwapCreation.Chain.prototype.getUserLockAmount = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.boltzrpc.SwapCreation.Chain} returns this
 */
proto.boltzrpc.SwapCreation.Chain.prototype.setUserLockAmount = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.boltzrpc.SwapCreation.prototype.getId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.boltzrpc.SwapCreation} returns this
 */
proto.boltzrpc.SwapCreation.prototype.setId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};


/**
 * optional string symbol_sending = 2;
 * @return {string}
 */
proto.boltzrpc.SwapCreation.prototype.getSymbolSending = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.boltzrpc.SwapCreation} returns this
 */
proto.boltzrpc.SwapCreation.prototype.setSymbolSending = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};


/**
 * optional string symbol_receiving = 3;
 * @return {string}
 */
proto.boltzrpc.SwapCreation.prototype.getSymbolReceiving = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.boltzrpc.SwapCreation} returns this
 */
proto.boltzrpc.SwapCreation.prototype.setSymbolReceiving = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};
 ...
 * @return {string}
 */
proto.boltzrpc.SwapCreation.prototype.getReferral = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 4, ""));
};
 ...
 * @return {!proto.boltzrpc.SwapCreation} returns this
 */
proto.boltzrpc.SwapCreation.prototype.setReferral = function(value) {
  return jspb.Message.setField(this, 4, value);
};
 ...
 * @return {!proto.boltzrpc.SwapCreation} returns this
 */
proto.boltzrpc.SwapCreation.prototype.clearReferral = function() {
  return jspb.Message.setField(this, 4, undefined);
};
 ...
 * @return {boolean}
 */
proto.boltzrpc.SwapCreation.prototype.hasReferral = function() {
  return jspb.Message.getField(this, 4) != null;
};


/**
 * optional Submarine submarine = 5;
 * @return {?proto.boltzrpc.SwapCreation.Submarine}
 */
proto.boltzrpc.SwapCreation.prototype.getSubmarine = function() {
  return /** @type{?proto.boltzrpc.SwapCreation.Submarine} */ (
    jspb.Message.getWrapperField(this, proto.boltzrpc.SwapCreation.Submarine, 5));
};


/**
 * @param {?proto.boltzrpc.SwapCreation.Submarine|undefined} value
 * @return {!proto.boltzrpc.SwapCreation} returns this
*/
proto.boltzrpc.SwapCreation.prototype.setSubmarine = function(value) {
  return jspb.Message.setOneofWrapperField(this, 5, proto.boltzrpc.SwapCreation.oneofGroups_[0], value);
};
 ...
 * @return {!proto.boltzrpc.SwapCreation} returns this
 */
proto.boltzrpc.SwapCreation.prototype.clearSubmarine = function() {
  return this.setSubmarine(undefined);
};
 ...
 * @return {boolean}
 */
proto.boltzrpc.SwapCreation.prototype.hasSubmarine = function() {
  return jspb.Message.getField(this, 5) != null;
};


/**
 * optional Reverse reverse = 6;
 * @return {?proto.boltzrpc.SwapCreation.Reverse}
 */
proto.boltzrpc.SwapCreation.prototype.getReverse = function() {
  return /** @type{?proto.boltzrpc.SwapCreation.Reverse} */ (
    jspb.Message.getWrapperField(this, proto.boltzrpc.SwapCreation.Reverse, 6));
};


/**
 * @param {?proto.boltzrpc.SwapCreation.Reverse|undefined} value
 * @return {!proto.boltzrpc.SwapCreation} returns this
*/
proto.boltzrpc.SwapCreation.prototype.setReverse = function(value) {
  return jspb.Message.setOneofWrapperField(this, 6, proto.boltzrpc.SwapCreation.oneofGroups_[0], value);
};
 ...
 * @return {!proto.boltzrpc.SwapCreation} returns this
 */
proto.boltzrpc.SwapCreation.prototype.clearReverse = function() {
 ...
 * @return {boolean}
 */
proto.boltzrpc.SwapCreation.prototype.hasReverse = function() {
  return jspb.Message.getField(this, 6) != null;
};


/**
 * optional Chain chain = 7;
 * @return {?proto.boltzrpc.SwapCreation.Chain}
 */
proto.boltzrpc.SwapCreation.prototype.getChain = function() {
  return /** @type{?proto.boltzrpc.SwapCreation.Chain} */ (
    jspb.Message.getWrapperField(this, proto.boltzrpc.SwapCreation.Chain, 7));
};


/**
 * @param {?proto.boltzrpc.SwapCreation.Chain|undefined} value
 * @return {!proto.boltzrpc.SwapCreation} returns this
*/
proto.boltzrpc.SwapCreation.prototype.setChain = function(value) {
  return jspb.Message.setOneofWrapperField(this, 7, proto.boltzrpc.SwapCreation.oneofGroups_[0], value);
};
 ...
 * @return {!proto.boltzrpc.SwapCreation} returns this
 */
proto.boltzrpc.SwapCreation.prototype.clearChain = function() {
  return this.setChain(undefined);
};
 ...
 * @return {boolean}
 */
proto.boltzrpc.SwapCreation.prototype.hasChain = function() {
  return jspb.Message.getField(this, 7) != null;
};
 ...
 * @return {!Object}
 */
proto.boltzrpc.TransactionHookResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.boltzrpc.TransactionHookResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.boltzrpc.TransactionHookResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.TransactionHookResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    id: jspb.Message.getFieldWithDefault(msg, 1, ""),
    action: jspb.Message.getFieldWithDefault(msg, 2, 0)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.boltzrpc.TransactionHookResponse}
 */
proto.boltzrpc.TransactionHookResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.boltzrpc.TransactionHookResponse;
  return proto.boltzrpc.TransactionHookResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.boltzrpc.TransactionHookResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.boltzrpc.TransactionHookResponse}
 */
proto.boltzrpc.TransactionHookResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.boltzrpc.TransactionHookResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.boltzrpc.TransactionHookResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.boltzrpc.TransactionHookResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.TransactionHookResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getId();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.boltzrpc.TransactionHookResponse.prototype.getId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.boltzrpc.TransactionHookResponse} returns this
 */
proto.boltzrpc.TransactionHookResponse.prototype.setId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {!proto.boltzrpc.Action}
 */
proto.boltzrpc.TransactionHookResponse.prototype.getAction = function() {
  return /** @type {!proto.boltzrpc.Action} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.boltzrpc.TransactionHookResponse} returns this
 */
proto.boltzrpc.TransactionHookResponse.prototype.setAction = function(value) {
  return jspb.Message.setProto3EnumField(this, 2, value);
};
 ...
 * @return {!Object}
 */
proto.boltzrpc.TransactionHookRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.boltzrpc.TransactionHookRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.boltzrpc.TransactionHookRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.TransactionHookRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    id: jspb.Message.getFieldWithDefault(msg, 1, ""),
    swapType: jspb.Message.getFieldWithDefault(msg, 2, 0),
    symbol: jspb.Message.getFieldWithDefault(msg, 3, ""),
    tx: msg.getTx_asB64(),
    txId: jspb.Message.getFieldWithDefault(msg, 5, ""),
    confirmed: jspb.Message.getBooleanFieldWithDefault(msg, 6, false),
    vout: jspb.Message.getFieldWithDefault(msg, 7, 0)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.boltzrpc.TransactionHookRequest}
 */
proto.boltzrpc.TransactionHookRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.boltzrpc.TransactionHookRequest;
  return proto.boltzrpc.TransactionHookRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.boltzrpc.TransactionHookRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.boltzrpc.TransactionHookRequest}
 */
proto.boltzrpc.TransactionHookRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.boltzrpc.TransactionHookRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.boltzrpc.TransactionHookRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.boltzrpc.TransactionHookRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.TransactionHookRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getId();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.boltzrpc.TransactionHookRequest.prototype.getId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.boltzrpc.TransactionHookRequest} returns this
 */
proto.boltzrpc.TransactionHookRequest.prototype.setId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};


/**
 * optional SwapType swap_type = 2;
 * @return {!proto.boltzrpc.SwapType}
 */
proto.boltzrpc.TransactionHookRequest.prototype.getSwapType = function() {
  return /** @type {!proto.boltzrpc.SwapType} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.boltzrpc.TransactionHookRequest} returns this
 */
proto.boltzrpc.TransactionHookRequest.prototype.setSwapType = function(value) {
  return jspb.Message.setProto3EnumField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.boltzrpc.TransactionHookRequest.prototype.getSymbol = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.boltzrpc.TransactionHookRequest} returns this
 */
proto.boltzrpc.TransactionHookRequest.prototype.setSymbol = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};
 ...
 * @return {!(string|Uint8Array)}
 */
proto.boltzrpc.TransactionHookRequest.prototype.getTx = function() {
  return /** @type {!(string|Uint8Array)} */ (jspb.Message.getFieldWithDefault(this, 4, ""));
};
 ...
 * @return {string}
 */
proto.boltzrpc.TransactionHookRequest.prototype.getTx_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
      this.getTx()));
};
 ...
 * @return {!Uint8Array}
 */
proto.boltzrpc.TransactionHookRequest.prototype.getTx_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getTx()));
};
 ...
 * @return {!proto.boltzrpc.TransactionHookRequest} returns this
 */
proto.boltzrpc.TransactionHookRequest.prototype.setTx = function(value) {
  return jspb.Message.setProto3BytesField(this, 4, value);
};
 ...
 * @return {string}
 */
proto.boltzrpc.TransactionHookRequest.prototype.getTxId = function() {
 ...
 * @return {!proto.boltzrpc.TransactionHookRequest} returns this
 */
proto.boltzrpc.TransactionHookRequest.prototype.setTxId = function(value) {
 ...
 * @return {boolean}
 */
proto.boltzrpc.TransactionHookRequest.prototype.getConfirmed = function() {
 ...
 * @return {!proto.boltzrpc.TransactionHookRequest} returns this
 */
proto.boltzrpc.TransactionHookRequest.prototype.setConfirmed = function(value) {
 ...
 * @return {number}
 */
proto.boltzrpc.TransactionHookRequest.prototype.getVout = function() {
 ...
 * @return {!proto.boltzrpc.TransactionHookRequest} returns this
 */
proto.boltzrpc.TransactionHookRequest.prototype.setVout = function(value) {
  return jspb.Message.setField(this, 7, value);
};
 ...
 * @return {!proto.boltzrpc.TransactionHookRequest} returns this
 */
proto.boltzrpc.TransactionHookRequest.prototype.clearVout = function() {
  return jspb.Message.setField(this, 7, undefined);
};
 ...
 * @return {boolean}
 */
proto.boltzrpc.TransactionHookRequest.prototype.hasVout = function() {
  return jspb.Message.getField(this, 7) != null;
};
 ...
 * @return {!Object}
 */
proto.boltzrpc.InvoiceCreationHookResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.boltzrpc.InvoiceCreationHookResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.boltzrpc.InvoiceCreationHookResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.InvoiceCreationHookResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    id: jspb.Message.getFieldWithDefault(msg, 1, ""),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.boltzrpc.InvoiceCreationHookResponse}
 */
proto.boltzrpc.InvoiceCreationHookResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.boltzrpc.InvoiceCreationHookResponse;
  return proto.boltzrpc.InvoiceCreationHookResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.boltzrpc.InvoiceCreationHookResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.boltzrpc.InvoiceCreationHookResponse}
 */
proto.boltzrpc.InvoiceCreationHookResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.boltzrpc.InvoiceCreationHookResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.boltzrpc.InvoiceCreationHookResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.boltzrpc.InvoiceCreationHookResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.InvoiceCreationHookResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getId();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.boltzrpc.InvoiceCreationHookResponse.prototype.getId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.boltzrpc.InvoiceCreationHookResponse} returns this
 */
proto.boltzrpc.InvoiceCreationHookResponse.prototype.setId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};


/**
 * optional string node_pubkey = 2;
 * @return {string}
 */
proto.boltzrpc.InvoiceCreationHookResponse.prototype.getNodePubkey = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.boltzrpc.InvoiceCreationHookResponse} returns this
 */
proto.boltzrpc.InvoiceCreationHookResponse.prototype.setNodePubkey = function(value) {
  return jspb.Message.setField(this, 2, value);
};
 ...
 * @return {!proto.boltzrpc.InvoiceCreationHookResponse} returns this
 */
proto.boltzrpc.InvoiceCreationHookResponse.prototype.clearNodePubkey = function() {
  return jspb.Message.setField(this, 2, undefined);
};
 ...
 * @return {boolean}
 */
proto.boltzrpc.InvoiceCreationHookResponse.prototype.hasNodePubkey = function() {
  return jspb.Message.getField(this, 2) != null;
};
 ...
 * @return {!Object}
 */
proto.boltzrpc.InvoiceCreationHookRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.boltzrpc.InvoiceCreationHookRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.boltzrpc.InvoiceCreationHookRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.InvoiceCreationHookRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    id: jspb.Message.getFieldWithDefault(msg, 1, ""),
    invoiceAmountSats: jspb.Message.getFieldWithDefault(msg, 2, 0),
    referral: jspb.Message.getFieldWithDefault(msg, 3, "")
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.boltzrpc.InvoiceCreationHookRequest}
 */
proto.boltzrpc.InvoiceCreationHookRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.boltzrpc.InvoiceCreationHookRequest;
  return proto.boltzrpc.InvoiceCreationHookRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.boltzrpc.InvoiceCreationHookRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.boltzrpc.InvoiceCreationHookRequest}
 */
proto.boltzrpc.InvoiceCreationHookRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 2:
      var value = /** @type {number} */ (reader.readUint64());
      msg.setInvoiceAmountSats(value);
      break;
    case 3:
      var value = /** @type {string} */ (reader.readString());
      msg.setReferral(value);
 ...
 * @return {!Uint8Array}
 */
proto.boltzrpc.InvoiceCreationHookRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.boltzrpc.InvoiceCreationHookRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.boltzrpc.InvoiceCreationHookRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.InvoiceCreationHookRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getId();
  if (f.length > 0) {
    writer.writeString(
  ...
  f = message.getInvoiceAmountSats();
  if (f !== 0) {
    writer.writeUint64(
      2,
      f
 ...
 * @return {string}
 */
proto.boltzrpc.InvoiceCreationHookRequest.prototype.getId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.boltzrpc.InvoiceCreationHookRequest} returns this
 */
proto.boltzrpc.InvoiceCreationHookRequest.prototype.setId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};


/**
 * optional uint64 invoice_amount_sats = 2;
 * @return {number}
 */
proto.boltzrpc.InvoiceCreationHookRequest.prototype.getInvoiceAmountSats = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.boltzrpc.InvoiceCreationHookRequest} returns this
 */
proto.boltzrpc.InvoiceCreationHookRequest.prototype.setInvoiceAmountSats = function(value) {
  return jspb.Message.setProto3IntField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.boltzrpc.InvoiceCreationHookRequest.prototype.getReferral = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.boltzrpc.InvoiceCreationHookRequest} returns this
 */
proto.boltzrpc.InvoiceCreationHookRequest.prototype.setReferral = function(value) {
  return jspb.Message.setField(this, 3, value);
};
 ...
 * @return {!proto.boltzrpc.InvoiceCreationHookRequest} returns this
 */
proto.boltzrpc.InvoiceCreationHookRequest.prototype.clearReferral = function() {
  return jspb.Message.setField(this, 3, undefined);
};
 ...
 * @return {boolean}
 */
proto.boltzrpc.InvoiceCreationHookRequest.prototype.hasReferral = function() {
  return jspb.Message.getField(this, 3) != null;
};
 ...
 * @return {!Object}
 */
proto.boltzrpc.InvoicePaymentHookResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.boltzrpc.InvoicePaymentHookResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.boltzrpc.InvoicePaymentHookResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.InvoicePaymentHookResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    id: jspb.Message.getFieldWithDefault(msg, 1, ""),
    nodePubkey: jspb.Message.getFieldWithDefault(msg, 2, ""),
    timePreference: jspb.Message.getFloatingPointFieldWithDefault(msg, 3, 0.0)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.boltzrpc.InvoicePaymentHookResponse}
 */
proto.boltzrpc.InvoicePaymentHookResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.boltzrpc.InvoicePaymentHookResponse;
  return proto.boltzrpc.InvoicePaymentHookResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.boltzrpc.InvoicePaymentHookResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.boltzrpc.InvoicePaymentHookResponse}
 */
proto.boltzrpc.InvoicePaymentHookResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.boltzrpc.InvoicePaymentHookResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.boltzrpc.InvoicePaymentHookResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.boltzrpc.InvoicePaymentHookResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.InvoicePaymentHookResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getId();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.boltzrpc.InvoicePaymentHookResponse.prototype.getId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
 ...
 */
proto.boltzrpc.InvoicePaymentHookResponse.prototype.setId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.boltzrpc.InvoicePaymentHookResponse.prototype.getNodePubkey = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.boltzrpc.InvoicePaymentHookResponse} returns this
 */
proto.boltzrpc.InvoicePaymentHookResponse.prototype.setNodePubkey = function(value) {
  return jspb.Message.setField(this, 2, value);
};
 ...
 * @return {!proto.boltzrpc.InvoicePaymentHookResponse} returns this
 */
proto.boltzrpc.InvoicePaymentHookResponse.prototype.clearNodePubkey = function() {
  return jspb.Message.setField(this, 2, undefined);
};
 ...
 * @return {boolean}
 */
proto.boltzrpc.InvoicePaymentHookResponse.prototype.hasNodePubkey = function() {
  return jspb.Message.getField(this, 2) != null;
};
 ...
 * @return {number}
 */
proto.boltzrpc.InvoicePaymentHookResponse.prototype.getTimePreference = function() {
  return /** @type {number} */ (jspb.Message.getFloatingPointFieldWithDefault(this, 3, 0.0));
};
 ...
 * @return {!proto.boltzrpc.InvoicePaymentHookResponse} returns this
 */
proto.boltzrpc.InvoicePaymentHookResponse.prototype.setTimePreference = function(value) {
  return jspb.Message.setField(this, 3, value);
};
 ...
 * @return {!proto.boltzrpc.InvoicePaymentHookResponse} returns this
 */
proto.boltzrpc.InvoicePaymentHookResponse.prototype.clearTimePreference = function() {
  return jspb.Message.setField(this, 3, undefined);
};
 ...
 * @return {boolean}
 */
proto.boltzrpc.InvoicePaymentHookResponse.prototype.hasTimePreference = function() {
  return jspb.Message.getField(this, 3) != null;
};
 ...
 * @return {!Object}
 */
proto.boltzrpc.InvoicePaymentHookRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.boltzrpc.InvoicePaymentHookRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.boltzrpc.InvoicePaymentHookRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.InvoicePaymentHookRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    id: jspb.Message.getFieldWithDefault(msg, 1, ""),
    invoice: jspb.Message.getFieldWithDefault(msg, 2, ""),
    decoded: (f = msg.getDecoded()) && boltzr_pb.DecodeInvoiceOrOfferResponse.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.boltzrpc.InvoicePaymentHookRequest}
 */
proto.boltzrpc.InvoicePaymentHookRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.boltzrpc.InvoicePaymentHookRequest;
  return proto.boltzrpc.InvoicePaymentHookRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.boltzrpc.InvoicePaymentHookRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.boltzrpc.InvoicePaymentHookRequest}
 */
proto.boltzrpc.InvoicePaymentHookRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 2:
      ...
      break;
    case 3:
      var value = new boltzr_pb.DecodeInvoiceOrOfferResponse;
      reader.readMessage(value,boltzr_pb.DecodeInvoiceOrOfferResponse.deserializeBinaryFromReader);
 ...
 * @return {!Uint8Array}
 */
proto.boltzrpc.InvoicePaymentHookRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.boltzrpc.InvoicePaymentHookRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.boltzrpc.InvoicePaymentHookRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.InvoicePaymentHookRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getId();
  if (f.length > 0) {
    writer.writeString(
  ...
  f = message.getDecoded();
  if (f != null) {
    writer.writeMessage(
      3,
      f,
      boltzr_pb.DecodeInvoiceOrOfferResponse.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {string}
 */
proto.boltzrpc.InvoicePaymentHookRequest.prototype.getId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.boltzrpc.InvoicePaymentHookRequest} returns this
 */
proto.boltzrpc.InvoicePaymentHookRequest.prototype.setId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.boltzrpc.InvoicePaymentHookRequest.prototype.getInvoice = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.boltzrpc.InvoicePaymentHookRequest} returns this
 */
proto.boltzrpc.InvoicePaymentHookRequest.prototype.setInvoice = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};


/**
 * optional boltzr.DecodeInvoiceOrOfferResponse decoded = 3;
 * @return {?proto.boltzr.DecodeInvoiceOrOfferResponse}
 */
proto.boltzrpc.InvoicePaymentHookRequest.prototype.getDecoded = function() {
  return /** @type{?proto.boltzr.DecodeInvoiceOrOfferResponse} */ (
    jspb.Message.getWrapperField(this, boltzr_pb.DecodeInvoiceOrOfferResponse, 3));
};


/**
 * @param {?proto.boltzr.DecodeInvoiceOrOfferResponse|undefined} value
 * @return {!proto.boltzrpc.InvoicePaymentHookRequest} returns this
*/
proto.boltzrpc.InvoicePaymentHookRequest.prototype.setDecoded = function(value) {
 ...
 * @return {!proto.boltzrpc.InvoicePaymentHookRequest} returns this
 */
proto.boltzrpc.InvoicePaymentHookRequest.prototype.clearDecoded = function() {
  return this.setDecoded(undefined);
};
 ...
 * @return {boolean}
 */
proto.boltzrpc.InvoicePaymentHookRequest.prototype.hasDecoded = function() {
  return jspb.Message.getField(this, 3) != null;
};
 ...
 * @return {!Object}
 */
proto.boltzrpc.DevClearSwapUpdateCacheRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.boltzrpc.DevClearSwapUpdateCacheRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.boltzrpc.DevClearSwapUpdateCacheRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.DevClearSwapUpdateCacheRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    id: jspb.Message.getFieldWithDefault(msg, 1, "")
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.boltzrpc.DevClearSwapUpdateCacheRequest}
 */
proto.boltzrpc.DevClearSwapUpdateCacheRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.boltzrpc.DevClearSwapUpdateCacheRequest;
  return proto.boltzrpc.DevClearSwapUpdateCacheRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.boltzrpc.DevClearSwapUpdateCacheRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.boltzrpc.DevClearSwapUpdateCacheRequest}
 */
proto.boltzrpc.DevClearSwapUpdateCacheRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.boltzrpc.DevClearSwapUpdateCacheRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.boltzrpc.DevClearSwapUpdateCacheRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.boltzrpc.DevClearSwapUpdateCacheRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.DevClearSwapUpdateCacheRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = /** @type {string} */ (jspb.Message.getField(message, 1));
  if (f != null) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.boltzrpc.DevClearSwapUpdateCacheRequest.prototype.getId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.boltzrpc.DevClearSwapUpdateCacheRequest} returns this
 */
proto.boltzrpc.DevClearSwapUpdateCacheRequest.prototype.setId = function(value) {
  return jspb.Message.setField(this, 1, value);
};
 ...
 * @return {!proto.boltzrpc.DevClearSwapUpdateCacheRequest} returns this
 */
proto.boltzrpc.DevClearSwapUpdateCacheRequest.prototype.clearId = function() {
  return jspb.Message.setField(this, 1, undefined);
};
 ...
 * @return {boolean}
 */
proto.boltzrpc.DevClearSwapUpdateCacheRequest.prototype.hasId = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {!Object}
 */
proto.boltzrpc.DevClearSwapUpdateCacheResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.boltzrpc.DevClearSwapUpdateCacheResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.boltzrpc.DevClearSwapUpdateCacheResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.DevClearSwapUpdateCacheResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.boltzrpc.DevClearSwapUpdateCacheResponse}
 */
proto.boltzrpc.DevClearSwapUpdateCacheResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.boltzrpc.DevClearSwapUpdateCacheResponse;
  return proto.boltzrpc.DevClearSwapUpdateCacheResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.boltzrpc.DevClearSwapUpdateCacheResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.boltzrpc.DevClearSwapUpdateCacheResponse}
 */
proto.boltzrpc.DevClearSwapUpdateCacheResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.boltzrpc.DevClearSwapUpdateCacheResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.boltzrpc.DevClearSwapUpdateCacheResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.boltzrpc.DevClearSwapUpdateCacheResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.boltzrpc.DevClearSwapUpdateCacheResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
 ...
 * @enum {number}
 */
proto.boltzrpc.Signer = {
  SIGNER_SUBMARINE_REFUND_COOPERATIVE: 0,
  SIGNER_REVERSE_CLAIM_COOPERATIVE: 1,
  SIGNER_CHAIN_REFUND_COOPERATIVE: 2,
  SIGNER_CHAIN_CLAIM_COOPERATIVE: 3,
  SIGNER_DEFERRED_CLAIM_COOPERATIVE: 4,
  SIGNER_EVM_REFUND_COOPERATIVE: 5,
  SIGNER_EVM_COMMITMENT_REFUND_COOPERATIVE: 6,
