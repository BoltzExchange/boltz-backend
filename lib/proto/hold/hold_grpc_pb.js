...
function serialize_hold_OnionMessagesRequest(arg) {
  if (!(arg instanceof hold_pb.OnionMessagesRequest)) {
    throw new Error('Expected argument of type hold.OnionMessagesRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_hold_OnionMessagesRequest(buffer_arg) {
  return hold_pb.OnionMessagesRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
clean: {
  ...
  onionMessages: {
    ...
    requestStream: false,
    responseStream: true,
    requestType: hold_pb.OnionMessagesRequest,
    responseType: hold_pb.OnionMessage,
    requestSerialize: serialize_hold_OnionMessagesRequest,
    requestDeserialize: deserialize_hold_OnionMessagesRequest,
