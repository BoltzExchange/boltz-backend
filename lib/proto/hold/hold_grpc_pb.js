...
function serialize_hold_GetRouteRequest(arg) {
  if (!(arg instanceof hold_pb.GetRouteRequest)) {
    throw new Error('Expected argument of type hold.GetRouteRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_hold_GetRouteRequest(buffer_arg) {
  return hold_pb.GetRouteRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_hold_GetRouteResponse(arg) {
  if (!(arg instanceof hold_pb.GetRouteResponse)) {
    throw new Error('Expected argument of type hold.GetRouteResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_hold_GetRouteResponse(buffer_arg) {
  return hold_pb.GetRouteResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_hold_PayStatusRequest(arg) {
  if (!(arg instanceof hold_pb.PayStatusRequest)) {
    throw new Error('Expected argument of type hold.PayStatusRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_hold_PayStatusRequest(buffer_arg) {
  return hold_pb.PayStatusRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_hold_PayStatusResponse(arg) {
  if (!(arg instanceof hold_pb.PayStatusResponse)) {
    throw new Error('Expected argument of type hold.PayStatusResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_hold_PayStatusResponse(buffer_arg) {
  return hold_pb.PayStatusResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
payStatus: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: hold_pb.PayStatusRequest,
    responseType: hold_pb.PayStatusResponse,
    requestSerialize: serialize_hold_PayStatusRequest,
    requestDeserialize: deserialize_hold_PayStatusRequest,
    responseSerialize: serialize_hold_PayStatusResponse,
    responseDeserialize: deserialize_hold_PayStatusResponse,
  },
...
getRoute: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: hold_pb.GetRouteRequest,
    responseType: hold_pb.GetRouteResponse,
    requestSerialize: serialize_hold_GetRouteRequest,
    requestDeserialize: deserialize_hold_GetRouteRequest,
    responseSerialize: serialize_hold_GetRouteResponse,
    responseDeserialize: deserialize_hold_GetRouteResponse,
  },
};
