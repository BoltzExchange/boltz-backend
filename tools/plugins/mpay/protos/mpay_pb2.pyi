...
class ListPaymentsRequest(_message.Message):
    __slots__ = ("bolt11", "payment_hash", "start_id", "limit")
    ...
    start_id: int
    limit: int
    def __init__(self, bolt11: _Optional[str] = ..., payment_hash: _Optional[str] = ..., start_id: _Optional[int] = ..., limit: _Optional[int] = ...) -> None: ...
